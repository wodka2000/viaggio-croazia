(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function i(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(o){if(o.ep)return;o.ep=!0;const n=i(o);fetch(o.href,n)}})();function He(){const a=document.getElementById("nav-toggle"),e=document.getElementById("nav-links");a==null||a.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),e==null||e.querySelectorAll(".nav-link").forEach(t=>{t.addEventListener("click",()=>{e.classList.remove("open")})});function i(){const t=(window.location.hash||"#dashboard").split("/")[0];document.querySelectorAll(".nav-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("href")===t)})}window.addEventListener("hashchange",i),i()}let ra=null;async function I(){if(ra)return ra;const e="/viaggio-croazia/data/trip.json";let i;try{i=await fetch(e)}catch{throw new Error("Dati del viaggio non disponibili offline. Apri l’app una volta con la rete: da quel momento resta consultabile anche senza connessione.")}if(!i.ok)throw new Error(`Impossibile caricare trip.json (${i.status})`);return ra=await i.json(),ra}function b(a){if(!a)return"";const[,e,i]=a.split("-");return`${i}/${e}`}function Ge(a){return a?new Date(a+"T00:00:00").toLocaleDateString("it-IT",{weekday:"short"}).toUpperCase():""}function Va(a){const e=new Date;e.setHours(0,0,0,0);const i=new Date(a+"T00:00:00");return Math.round((i-e)/(1e3*60*60*24))}function Ze(a){return"★".repeat(a)+"☆".repeat(5-a)}function j(a){return`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(a)}&travelmode=driving`}function Ha(a,e){return`https://www.google.com/maps/dir/?api=1&destination=${a},${e}&travelmode=driving`}const Ga={mattina:8*60,mattino:8*60,colazione:8*60,pranzo:13*60,pomeriggio:15*60,aperitivo:18*60,sera:20*60,serata:20*60,cena:20*60,notte:23*60};function W(a){const e=String(a??"").trim().toLowerCase();if(!e)return 9998;const i=e.match(/(\d{1,2})\s*[:.,h]\s*(\d{2})/)||e.match(/^(\d{1,2})(\d{2})$/)||e.match(/^(\d{1,2})$/);if(i){const t=Number(i[1]),o=i[2]!=null?Number(i[2]):0;if(t<=23&&o<=59)return t*60+o}for(const t in Ga)if(e.includes(t))return Ga[t];return 9998}function Ue(a){return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`}function Za(a){const e=String(a??"").trim();return e?/^https?:\/\//i.test(e)?e:Ue(e):""}const re="viaggio_croazia_ideas_v1",se=[{value:"alloggio",label:"🏨 Alloggio"},{value:"ristorante",label:"🍽️ Ristorante"},{value:"esperienza",label:"🎯 Esperienza"},{value:"spiaggia",label:"🏖️ Spiaggia"},{value:"escursione",label:"🥾 Escursione"},{value:"cantina",label:"🍷 Cantina / Cibo"},{value:"shopping",label:"🛍️ Shopping"},{value:"varia",label:"💡 Varia"}],_a=[{value:"idea",label:"Idea",color:"#6366f1"},{value:"da-verificare",label:"Da verificare",color:"#f59e0b"},{value:"prenotare",label:"Prenotare",color:"#ef4444"},{value:"approvata",label:"Approvata",color:"#10b981"},{value:"scartata",label:"Scartata",color:"#94a3b8"}],le=[{value:"alta",label:"🔴 Alta"},{value:"media",label:"🟡 Media"},{value:"bassa",label:"🟢 Bassa"}],Fe=[{value:"#f59e0b",label:"Giallo"},{value:"#ef4444",label:"Rosso"},{value:"#8b5cf6",label:"Viola"},{value:"#10b981",label:"Verde"},{value:"#f97316",label:"Arancio"}];function Ke(){return"idea_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function Ba(a){return{categoria:"varia",link:"",priorita:"media",stato:"idea",note:a.note??"",location_name:a.location_name??null,...a}}function _(){try{const a=localStorage.getItem(re);return a?JSON.parse(a).map(Ba):[]}catch{return[]}}function ma(a){try{localStorage.setItem(re,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("ideas:updated",{detail:{ideas:a}}))}catch(e){console.warn("[ideas] localStorage non disponibile:",e)}}function ea(a){const e=_(),i=Ba({id:Ke(),text:"",note:"",categoria:"varia",link:"",priorita:"media",stato:"idea",created_at:new Date().toISOString(),day_date:null,location_name:null,coordinates:null,add_to_checklist:!1,add_to_map:!1,marker_color:"#f59e0b",completed:!1,...a});return e.unshift(i),ma(e),i}function Y(a,e){const i=_(),t=i.findIndex(o=>o.id===a);return t===-1?null:(i[t]={...i[t],...e},ma(i),i[t])}function qa(a){ma(_().filter(e=>e.id!==a))}function Je(a){return _().filter(e=>e.day_date===a)}function We(){return _().filter(a=>a.add_to_checklist)}function va(){return _().filter(a=>{var e;return a.add_to_map&&((e=a.coordinates)==null?void 0:e.lat)!=null})}function Ye(){return JSON.stringify(_(),null,2)}function Qe(a){const e=JSON.parse(a);if(!Array.isArray(e))throw new Error("JSON non valido: deve essere un array");const i=_(),t=new Set(i.map(s=>s.id));let o=0;const n=[...i];return e.forEach(s=>{t.has(s.id)||(n.push(Ba(s)),o++)}),ma(n),o}function Ca(a,e){if(!a||!e)return[];const i=e.toLowerCase();return a.filter(t=>i.includes(t.area.toLowerCase()))}function xa(a){return _().filter(e=>e.day_date===a&&e.stato!=="scartata")}function Pa(a){return/sesto/i.test(a.location||"")}function ce(a,e){var n;const i=((n=a.activities)==null?void 0:n.length)||0,t=Pa(a)?0:Ca(e,a.location).length,o=xa(a.date).length;return i+t+o}function h(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const de=a=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`;function ue(a,e,i=[]){var y,L,P;const t=Ca(e,a.location),o=xa(a.date),n=new Set(o.map(g=>String(g.text??"").toLowerCase())),s=((y=a.tips)==null?void 0:y.do)||[],r=((L=a.tips)==null?void 0:L.eat)||[],l=Pa(a),c=(P=a.activities)!=null&&P.length?`<div class="sugg-section">
       ...
       </div>`:"";let m="";if(l){const g=o.map(k=>i.find(S=>S.id===k.hike_id)).filter(k=>k&&Array.isArray(k.tips)&&k.tips.length);g.length&&(m=`<div class="sugg-section">
        ...
        <div class="sugg-eat-list">
          ${g.map(k=>`
            <div class="sugg-eat">
              ...
              <ul class="sugg-tips">${k.tips.map(S=>`<li>${h(S)}</li>`).join("")}</ul>
            </div>`).join("")}
        </div>
      </div>`)}let d="";if(l){const g=o.map(k=>i.find(S=>S.id===k.hike_id)).filter(k=>k&&k.eat);g.length&&(d=`<div class="sugg-section">
  ...
  `:""}async function oi(){var k,S,Oa;const a=document.getElementById("page-content");let e;try{e=await I()}catch(f){a.innerHTML=si(f.message);return}const{meta:i,days:t,hotels:o}=e,n=Va(i.start_date),s=Va(i.end_date),r=new Date().toISOString().slice(0,10),l=t.find(f=>f.date===r),c=t.find(f=>f.date>r),u=l||c,m=l?"Programma di oggi":c?"Prossima tappa":"Ultima tappa",d=[],p=new Set;for(const f of t)p.has(f.location)||(p.add(f.location),d.push({location:f.location,day:f.day,date:f.date}));const y=o.filter(f=>f.status==="confermata"),L=y.length,P=y.reduce((f,w)=>f+w.nights,0),g=u?ce(u,e.dining):0;a.innerHTML=`
  ...
  `,(k=document.getElementById("route-stops"))==null||k.addEventListener("click",f=>{const w=f.target.closest(".route-stop");if(!w)return;const U=t.find(na=>na.date===w.dataset.date);if(!U)return;const Ra=document.getElementById("today-card");Ra&&(Ra.innerHTML=ka(U,e,u,m)),document.querySelectorAll("#route-stops .route-stop").forEach(na=>na.classList.toggle("route-stop--attiva",na===w))}),(S=document.getElementById("today-card"))==null||S.addEventListener("click",f=>{if(!f.target.closest("#preview-reset"))return;const w=document.getElementById("today-card");w&&(w.innerHTML=ka(u,e,u,m)),document.querySelectorAll("#route-stops .route-stop").forEach(U=>U.classList.toggle("route-stop--attiva",!!u&&U.dataset.date===u.date))}),(Oa=document.getElementById("suggestions-card"))==null||Oa.addEventListener("click",()=>{u&&ni(u,e.dining,e.hikes)})}function ka(a,e,i,t){if(!a)return`<div class="section-title">${t}</div>
    ...
    <div style="margin-bottom:0.75rem;">
      <strong>${F(a.title)}</strong>
      <div style="font-size:0.82rem; color:var(--color-text-muted); margin-top:0.2rem;">
        📍 ${F(a.location)} · ${b(a.date)}
      </div>
    </div>
    <div class="activity-list">
      ${s.slice(0,5).map(r=>`
        <div class="activity-item">
          <span class="activity-time">${F(r.time)}</span>
          <span>${F(r.text)}</span>
        </div>
      `).join("")}
  ...
  `}function si(a){return`
    <div class="error-state">
      <div class="error-icon">⚠️</div>
      <h2>Errore caricamento dati</h2>
      <p>${a}</p>
    </div>
  `}const ge="viaggio_croazia_bookings_v1";function li(){return"book_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function me(a){return{id:a.id||li(),date:a.date??null,time:(a.time??"").trim(),place:(a.place??"").trim(),address:(a.address??"").trim(),maps_url:(a.maps_url??"").trim(),note:(a.note??"").trim(),created_at:a.created_at||new Date().toISOString()}}function ve(a){if(a.maps_url)return Za(a.maps_url);const e=[a.place,a.address].filter(Boolean).join(", ");return e?Za(e):""}function ba(){try{const a=localStorage.getItem(ge);return a?JSON.parse(a).map(me):[]}catch{return[]}}function be(a){try{localStorage.setItem(ge,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("bookings:updated",{detail:{bookings:a}}))}catch(e){console.warn("[bookings] localStorage non disponibile:",e)}}function ci(a){const e=ba(),i=me(a);return e.unshift(i),be(e),i}function di(a){be(ba().filter(e=>e.id!==a))}function ui(a){return ba().filter(e=>e.date===a).sort((e,i)=>W(e.time)-W(i.time))}const fe="viaggio_croazia_attachments_v1",pi="viaggio_croazia_files",C="attachments";function Ma(){try{const a=localStorage.getItem(fe);return a?JSON.parse(a):{}}catch{return{}}}function H(a){return Ma()[a]||null}function he(a){try{localStorage.setItem(fe,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("attachments:updated",{detail:{meta:a}}))}catch(e){console.warn("[attachments] localStorage non disponibile:",e)}}function ja(){return new Promise((a,e)=>{if(!("indexedDB"in window))return e(new Error("IndexedDB non disponibile"));const i=indexedDB.open(pi,1);i.onupgradeneeded=()=>{i.result.objectStoreNames.contains(C)||i.result.createObjectStore(C)},i.onsuccess=()=>a(i.result),i.onerror=()=>e(i.error)})}function gi(a,e){return ja().then(i=>new Promise((t,o)=>{const n=i.transaction(C,"readwrite");n.objectStore(C).put(e,a),n.oncomplete=()=>{i.close(),t()},n.onerror=()=>{i.close(),o(n.error)}}))}function mi(a){return ja().then(e=>new Promise((i,t)=>{const n=e.transaction(C,"readonly").objectStore(C).get(a);n.onsuccess=()=>{e.close(),i(n.result||null)},n.onerror=()=>{e.close(),t(n.error)}}))}function vi(a){return ja().then(e=>new Promise((i,t)=>{const o=e.transaction(C,"readwrite");o.objectStore(C).delete(a),o.oncomplete=()=>{e.close(),i()},o.onerror=()=>{e.close(),t(o.error)}}))}async function ca(a,e){await gi(a,e);const i=Ma();if(i[a]={name:e.name||"allegato",type:e.type||"",size:e.size||0,added_at:new Date().toISOString()},he(i),!H(a))throw new Error("Metadati non salvati: spazio del browser esaurito o localStorage non disponibile.");return i[a]}async function bi(a){const e=await mi(a);return e?URL.createObjectURL(e):null}async function da(a){try{await vi(a)}catch{}const e=Ma();delete e[a],he(e)}async function Da(a){const e=H(a),t=/^(image\/|application\/pdf)/.test((e==null?void 0:e.type)||"")?window.open("","_blank"):null;t&&(t.opener=null);try{const o=await bi(a);if(!o){t==null||t.close(),alert("File non trovato su questo dispositivo.");return}t?t.location=o:fi(o,e==null?void 0:e.name),setTimeout(()=>URL.revokeObjectURL(o),6e4)}catch(o){console.error("[attachments]",o),t==null||t.close(),alert("Impossibile aprire il file.")}}function fi(a,e){const i=document.createElement("a");i.href=a,i.download=e||"allegato",document.body.appendChild(i),i.click(),i.remove()}function ye(a){if(!a)return"📎";const e=(a.type||"").toLowerCase(),i=(a.name||"").toLowerCase();return e.startsWith("image/")||/\.(png|jpe?g|gif|webp|heic)$/.test(i)?"🖼️":e==="application/pdf"||i.endsWith(".pdf")?"📄":e==="message/rfc822"||i.endsWith(".eml")?"✉️":"📎"}const ke="viaggio_croazia_program_v1";function hi(){return"act_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function x(){try{const a=localStorage.getItem(ke);return a?JSON.parse(a):{}}catch{return{}}}function G(a){try{localStorage.setItem(ke,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("program:updated",{detail:{data:a}}))}catch(e){console.warn("[program] localStorage non disponibile:",e)}}function ia(a,e){a[e]||(a[e]={edits:{},hidden:{},added:[]});const i=a[e];return i.edits=i.edits||{},i.hidden=i.hidden||{},i.added=i.added||[],i}function yi(a,e=[]){const i=x()[a]||{},t=i.edits||{},o=i.hidden||{},n=i.added||[],s=[];return e.forEach((r,l)=>{if(o[l])return;const c=t[l]||{};s.push({key:"base:"+l,base:!0,index:l,time:c.time??r.time??"",text:c.text??r.text??"",maps:r.maps??null})}),n.forEach(r=>{s.push({key:"add:"+r.id,base:!1,id:r.id,time:r.time||"",text:r.text||"",maps:r.maps||null})}),s.sort((r,l)=>W(r.time)-W(l.time)),s}function ki(a){const e=x()[a];return e?!!(e.added&&e.added.length||e.hidden&&Object.keys(e.hidden).length||e.edits&&Object.keys(e.edits).length):!1}function $i(a,e,i){const t=x(),o=ia(t,a);o.edits[e]={...o.edits[e]||{},...i},G(t)}function zi(a,e){const i=x(),t=ia(i,a);t.hidden[e]=!0,delete t.edits[e],G(i)}function _i(a,{time:e="",text:i="",maps:t=""}={}){const o=x(),n=ia(o,a),s={id:hi(),time:e.trim(),text:i.trim(),maps:(t||"").trim()};return n.added.push(s),G(o),s}function Li(a,e,i){const t=x(),o=ia(t,a),n=o.added.findIndex(s=>s.id===e);n!==-1&&(o.added[n]={...o.added[n],...i},G(t))}function Ei(a,e){const i=x(),t=ia(i,a);t.added=t.added.filter(o=>o.id!==e),G(i)}function Si(a){const e=x();e[a]&&(delete e[a],G(e))}const J=new Set;let $e={};async function Ii(a){var u,m;const e=document.getElementById("page-content");let i;try{i=await I()}catch(d){e.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${d.message}</p></div>`;return}const{days:t,hotels:o,meta:n}=i,s=i.ferries||[],r=Object.fromEntries(o.map(d=>[d.id,d]));$e=Object.fromEntries(t.map(d=>[d.date,d])),e.innerHTML=`
  ...
  `}function qi(a){if(!a)return"";const e=a.do||[],i=a.eat||[];return!e.length&&!i.length?"":`
    <div class="day-tips">
  ...
  `).join("")}function _e(a,e){const i=yi(a.date,a.activities);return e?`
    ...
    <div class="program-controls">
      ...
      ${ki(a.date)?'<span class="program-modified">modificato</span>':""}
    </div>
  `}function Ci(a){const e=a.base?`data-index="${a.index}"`:`data-id="${$(a.id)}"`;return`
  ...
  `}function xi(a){const e=ui(a);return e.length?e.map(i=>{const t=ve(i);return`
    ...
    `}).join(""):""}function N(a){const e=document.querySelector(`.activities[data-date="${a}"]`),i=$e[a];e&&i&&(e.innerHTML=_e(i,J.has(a)))}function Pi(a){const e=document.querySelector(".timeline");e&&(e.addEventListener("click",i=>{var r,l;const t=i.target.closest(".day-add-idea-btn");if(t){const c=t.dataset.date,u=document.getElementById(`quick-form-${c}`);if(!u)return;const m=u.classList.contains("hidden");document.querySelectorAll(".day-quick-form").forEach(d=>d.classList.add("hidden")),m&&(u.classList.remove("hidden"),(r=u.querySelector(".quick-idea-text"))==null||r.focus())}const o=i.target.closest(".quick-cancel");o&&((l=o.closest(".day-quick-form"))==null||l.classList.add("hidden"));const n=i.target.closest(".day-idea-del");if(n){const c=n.dataset.id;confirm("Eliminare questa idea?")&&qa(c)}const s=i.target.closest("[data-ferry]");s&&Da(s.dataset.ferry)}),e.addEventListener("submit",i=>{var c,u,m,d;const t=i.target.closest(".day-quick-form");if(!t)return;i.preventDefault();const o=(c=t.querySelector(".quick-idea-text"))==null?void 0:c.value.trim();if(!o){(u=t.querySelector(".quick-idea-text"))==null||u.focus();return}const n=t.dataset.date,s=a.find(p=>p.date===n),r=(m=t.querySelector(".quick-map"))==null?void 0:m.checked,l=(d=t.querySelector(".quick-checklist"))==null?void 0:d.checked;ea({text:o,day_date:n,location_name:(s==null?void 0:s.location)??null,coordinates:r&&(s!=null&&s.coordinates)?s.coordinates:null,add_to_checklist:!!l,add_to_map:!!(r&&(s!=null&&s.coordinates))}),t.querySelector(".quick-idea-text").value="",t.querySelector(".quick-map").checked=!1,t.querySelector(".quick-checklist").checked=!1,t.classList.add("hidden")}))}function Mi(){const a=document.querySelector(".timeline");a&&(a.addEventListener("click",e=>{var r,l,c,u,m;const i=e.target.closest(".program-edit-toggle");if(i){J.add(i.dataset.date),N(i.dataset.date);return}const t=e.target.closest(".program-edit-done");if(t){J.delete(t.dataset.date),N(t.dataset.date);return}const o=e.target.closest(".program-reset");if(o){const d=o.dataset.date;confirm("Ripristinare il programma di questo giorno come nell’itinerario originale? Le modifiche fatte a questo giorno andranno perse.")&&(Si(d),J.delete(d),N(d));return}const n=e.target.closest(".prog-del");if(n){const d=n.closest(".program-edit-row"),p=(r=n.closest(".activities"))==null?void 0:r.dataset.date;if(!d||!p)return;d.dataset.base==="true"?zi(p,Number(d.dataset.index)):Ei(p,d.dataset.id),N(p);return}const s=e.target.closest(".prog-add-btn");if(s){const d=s.dataset.date,p=s.closest(".program-add-row"),y=((l=p.querySelector(".prog-add-time"))==null?void 0:l.value.trim())||"",L=((c=p.querySelector(".prog-add-text"))==null?void 0:c.value.trim())||"";if(!L){(u=p.querySelector(".prog-add-text"))==null||u.focus();return}_i(d,{time:y,text:L}),N(d),(m=document.querySelector(`.activities[data-date="${d}"] .prog-add-text`))==null||m.focus();return}}),a.addEventListener("keydown",e=>{var i,t;e.key==="Enter"&&e.target.classList.contains("prog-add-text")&&(e.preventDefault(),(t=(i=e.target.closest(".program-add-row"))==null?void 0:i.querySelector(".prog-add-btn"))==null||t.click())}),a.addEventListener("change",e=>{var l,c,u;const i=e.target,t=(l=i.classList)==null?void 0:l.contains("prog-time"),o=(c=i.classList)==null?void 0:c.contains("prog-text");if(!t&&!o)return;const n=i.closest(".program-edit-row"),s=(u=i.closest(".activities"))==null?void 0:u.dataset.date;if(!n||!s)return;const r={[t?"time":"text"]:i.value.trim()};n.dataset.base==="true"?$i(s,Number(n.dataset.index),r):Li(s,n.dataset.id,r)}))}function $(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}async function ji(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(r){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${r.message}</p></div>`;return}const{hotels:i}=e,t={},o=[];for(const r of i){const l=r.location_group||r.location;t[l]||(t[l]=[],o.push(l)),t[l].push(r)}const n=i.filter(r=>r.status==="confermata"),s=n.reduce((r,l)=>r+l.nights,0);a.innerHTML=`
    <div class="page-header">
      <h1>🏨 Hotel &amp; Alloggi</h1>
  ...
  `}const Ta="viaggio_croazia_checklist_v1",Le="viaggio_croazia_custom_items_v1";function Ti(){try{const a=localStorage.getItem(Ta);return a?JSON.parse(a):{}}catch{return{}}}function $a(a){try{localStorage.setItem(Ta,JSON.stringify(a))}catch(e){console.warn("[storage] Impossibile salvare checklist:",e)}}function Ni(){try{localStorage.removeItem(Ta)}catch{}}function Oi(){return"ci_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function Z(){try{const a=localStorage.getItem(Le);return a?JSON.parse(a):[]}catch{return[]}}function ta(a){try{localStorage.setItem(Le,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("customitems:updated"))}catch(e){console.warn("[storage] Impossibile salvare custom items:",e)}}function Ri(a,e="Varie"){const i=Z(),t={id:Oi(),text:a.trim(),category:e,checked:!1,created_at:new Date().toISOString()};return i.unshift(t),ta(i),t}function Vi(a,e){ta(Z().map(i=>i.id===a?{...i,checked:e}:i))}function Hi(a,e){const i=e.trim();i&&ta(Z().map(t=>t.id===a?{...t,text:i}:t))}function Gi(a){ta(Z().filter(e=>e.id!==a))}function Zi(){ta([])}async function Ui(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(s){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${s.message}</p></div>`;return}const{categories:i}=e.checklist,t=Ti();a.innerHTML=`
    <div class="page-header">
  ...
  `,K(i,t),Wi(i,t),Ka(),Ea();const o=()=>{const s=document.getElementById("checklist-ideas-section");s&&(s.innerHTML=Fa(),Ka())},n=()=>{const s=document.getElementById("custom-items-section");s&&(s.innerHTML=La(),Ea())};window.addEventListener("ideas:updated",o),window.addEventListener("customitems:updated",n),window.__currentPageCleanup=()=>{window.removeEventListener("ideas:updated",o),window.removeEventListener("customitems:updated",n)}}function Fa(){const a=We();if(a.length===0)return"";const e=a.filter(o=>o.completed).length,i=a.length,t=i?e/i*100:0;return`
  ...
  `}function Ea(){var e,i,t;const a=document.getElementById("custom-items-header");a==null||a.addEventListener("click",o=>{var n,s;o.target.closest(".custom-add-form")||o.target.closest("button")||((n=document.getElementById("custom-items-list"))==null||n.classList.toggle("hidden"),(s=document.getElementById("custom-chev"))==null||s.classList.toggle("open"))}),(e=document.getElementById("custom-items-list"))==null||e.addEventListener("change",o=>{const n=o.target;n.classList.contains("custom-item-cb")&&Vi(n.dataset.cid,n.checked)}),(i=document.getElementById("custom-items-list"))==null||i.addEventListener("click",o=>{const n=o.target.closest(".custom-item-del");if(n){Gi(n.dataset.cid);return}const s=o.target.closest(".custom-item-edit");if(s){Fi(s.dataset.cid);return}if(o.target.closest("#custom-add-btn")){Ja();return}o.target.closest("#clear-custom-btn")&&confirm("Eliminare tutte le voci personalizzate?")&&Zi()}),(t=document.getElementById("custom-item-text"))==null||t.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),Ja())})}function Ja(){var t;const a=document.getElementById("custom-item-text"),e=((t=document.getElementById("custom-item-cat"))==null?void 0:t.value)??"Varie",i=a==null?void 0:a.value.trim();if(!i){a==null||a.focus();return}Ri(i,e),a&&(a.value="")}function Fi(a){const e=Z().find(d=>d.id===a);if(!e)return;const i=document.querySelector(`.custom-item[data-cid="${a}"]`);if(!i)return;const t=i.querySelector(".checklist-item-text"),o=i.querySelector(".custom-item-edit"),n=i.querySelector(".custom-item-del"),s=i.querySelector(".priority-badge");if(!t)return;const r=document.createElement("input");r.type="text",r.value=e.text,r.className="custom-edit-input";const l=document.createElement("button");l.textContent="✓",l.className="custom-item-save-edit",l.title="Salva";const c=document.createElement("button");c.textContent="✕",c.className="custom-item-cancel-edit",c.title="Annulla",t.replaceWith(r),s&&(s.style.display="none"),o&&o.replaceWith(l),n&&(n.style.display="none"),l.after(c),r.focus(),r.select();function u(){const d=r.value.trim();if(!d){r.focus();return}Hi(a,d)}function m(){const d=document.getElementById("custom-items-section");d&&(d.innerHTML=La(),Ea())}r.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),u()),d.key==="Escape"&&m()}),l.addEventListener("click",u),c.addEventListener("click",m)}function Ki(a,e){const i=a.items.length,t=a.items.filter(o=>e[o.id]).length;return`
    <div class="category-card" data-cat="${a.id}">
      ...
      <div class="category-items" id="items-${a.id}">
        ${a.items.map(o=>Ji(o,e[o.id]||!1)).join("")}
      </div>
    </div>
  `}function Ji(a,e){return`
  ...
  `,sa=await I(),ct(sa);try{await it(Qi)}catch{et(sa);return}tt(sa,a),ut(),Wa();const i=()=>{if(!z)return;D.forEach(o=>o.setMap(null)),D=[],Ee(),Wa();const t=document.querySelector('.map-btn[data-layer="ideas"]');if(t){const o=va().length;t.textContent=`💡 Idee${o>0?` (${o})`:""}`}};window.addEventListener("ideas:updated",i),window.__currentPageCleanup=()=>{window.removeEventListener("ideas:updated",i),at()}}function at(){[X,Q,D,T].flat().forEach(a=>{try{a.setMap(null)}catch{}}),X=[],Q=[],D=[],T=[],z=null}function et(a){const e=document.getElementById("map-outer");if(!e)return;const i=[...new Set(a.days.map(t=>t.location))];e.innerHTML=`
  ...
  `}function it(a){return new Promise((e,i)=>{var n;if((n=window.google)!=null&&n.maps){e();return}const t="__gmapsReady_"+Date.now();window[t]=()=>{delete window[t],e()};const o=document.createElement("script");o.src=`https://maps.googleapis.com/maps/api/js?key=${a}&callback=${t}&loading=async`,o.async=!0,o.onerror=()=>i(new Error("Impossibile caricare Google Maps")),document.head.appendChild(o)})}function tt(a,e){const i=document.getElementById("google-map");i&&(z=new google.maps.Map(i,{center:{lat:44,lng:15.5},zoom:7,mapTypeId:"roadmap",styles:[{featureType:"water",elementType:"geometry",stylers:[{color:"#a2daf5"}]},{featureType:"landscape",stylers:[{color:"#f5f5f0"}]}]}),ot(a),nt(a),rt(a,e),Ee(),dt(a))}function ot(a){X=[];const e=new Map;a.days.filter(i=>i.coordinates).forEach(i=>{const t=`${i.coordinates.lat},${i.coordinates.lng}`;e.has(t)||e.set(t,[]),e.get(t).push(i)}),e.forEach(i=>{const t=i[0],o=i[i.length-1],n=i.length>1?`Giorni ${t.day}–${o.day} — ${t.location}`:`Giorno ${t.day} — ${t.location}`,s=new google.maps.Marker({position:t.coordinates,map:z,title:t.location,label:{text:String(t.day),color:"#fff",fontWeight:"bold",fontSize:"11px"},icon:{path:google.maps.SymbolPath.CIRCLE,scale:16,fillColor:"#1e40af",fillOpacity:1,strokeColor:"#ffffff",strokeWeight:2},zIndex:10}),r=i.map(c=>`<div style="margin-top:5px;font-size:12px;border-top:1px solid #e2e8f0;padding-top:4px;">
        ...
        <div style="font-family:system-ui,sans-serif;max-width:240px;">
          ...
          ${r}
        </div>`});s.addListener("click",()=>l.open(z,s)),X.push(s)})}function nt(a){Q=[],a.hotels.filter(e=>e.recommended).forEach(e=>{const i=new google.maps.Marker({position:e.coordinates,map:z,title:e.name,icon:{path:google.maps.SymbolPath.BACKWARD_CLOSED_ARROW,scale:7,fillColor:"#059669",fillOpacity:1,strokeColor:"#ffffff",strokeWeight:1.5},zIndex:5}),t=new google.maps.InfoWindow({content:`
        <div style="font-family:system-ui,sans-serif;max-width:240px;">
        ...
        </div>`});e.addListener("click",()=>i.open(z,e)),D.push(e)})}function rt(a,e){T.forEach(o=>o.setMap(null)),T=[];const i=[];if(a.days.filter(o=>o.coordinates).forEach(o=>{const n=i[i.length-1];(!n||n.lat!==o.coordinates.lat||n.lng!==o.coordinates.lng)&&i.push(o.coordinates)}),i.length<2)return;const t=new google.maps.DirectionsService;(async()=>{for(let o=0;o<i.length-1;o++){if(e!==ga||!z)return;await lt(t,i[o],i[o+1],e),await Se(120)}})()}const Se=a=>new Promise(e=>setTimeout(e,a));function st(a,e,i){return new Promise(t=>{a.route({origin:e,destination:i,travelMode:google.maps.TravelMode.DRIVING},(o,n)=>t({result:o,status:n}))})}async function lt(a,e,i,t,o=4){let n=300;for(let s=0;s<o;s++){const{result:r,status:l}=await st(a,e,i);if(t!==ga||!z)return;if(l==="OK"&&r){T.push(new google.maps.DirectionsRenderer({map:z,directions:r,suppressMarkers:!0,suppressInfoWindows:!0,preserveViewport:!0,polylineOptions:{strokeColor:"#2563eb",strokeOpacity:.9,strokeWeight:5}})),Sa();return}if(l!==google.maps.DirectionsStatus.OVER_QUERY_LIMIT)break;if(await Se(n),n*=2,t!==ga||!z)return}T.push(new google.maps.Polyline({path:[e,i],map:z,geodesic:!0,strokeOpacity:0,icons:[{icon:{path:"M 0,-1 0,1",strokeColor:"#f59e0b",strokeOpacity:.9,scale:3},offset:"0",repeat:"14px"}]})),Sa()}function Sa(){const a=pa==="all"||pa==="route";T.forEach(e=>e.setMap(a?z:null))}function ct(a){const e=document.getElementById("route-nav");if(!e)return;const i=a.hotels.filter(t=>t.recommended);i.length&&(e.innerHTML=`
  ...
  `)}function dt(a){const e=new google.maps.LatLngBounds;a.days.filter(i=>i.coordinates).forEach(i=>e.extend(i.coordinates)),a.hotels.filter(i=>i.recommended).forEach(i=>e.extend(i.coordinates)),z.fitBounds(e,60)}function ut(){var i;const a=va().length,e=document.querySelector('.map-btn[data-layer="ideas"]');e&&a>0&&(e.textContent=`💡 Idee (${a})`),(i=document.getElementById("map-controls"))==null||i.addEventListener("click",t=>{const o=t.target.closest(".map-btn");if(!o)return;document.querySelectorAll(".map-btn").forEach(s=>s.classList.remove("active")),o.classList.add("active");const n=o.dataset.layer;pa=n,X.forEach(s=>s.setVisible(n==="all"||n==="route")),Q.forEach(s=>s.setVisible(n==="all"||n==="hotels")),D.forEach(s=>s.setVisible(n==="all"||n==="ideas")),Sa()})}function Wa(){const a=document.getElementById("map-legend");if(!a)return;const e=va().length;a.innerHTML=`
  ...
  `}let O=null,R="tutte",oa=[],A=!1;async function pt(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(t){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${t.message}</p></div>`;return}oa=e.days,O=null,R="tutte",a.innerHTML=`
    <div class="page-header">
      <h1>💡 Idee Rapide</h1>
  ...
  `,ha(),Be(),we(),bt();const i=()=>{q(),V()};window.addEventListener("ideas:updated",i),window.__currentPageCleanup=()=>window.removeEventListener("ideas:updated",i)}function fa(a){var s,r;const e=!!a,i=oa.map(l=>`<option value="${l.date}" ${(a==null?void 0:a.day_date)===l.date?"selected":""}>
      ...
      <div class="idea-card-main">
        <div class="idea-card-header-row">
          ...
          <div class="idea-card-badges-inline">
            ...
            ${t?`<span class="idea-pri-dot" title="${t.label}" style="background:${ft(a.priorita)}"></span>`:""}
          </div>
        </div>
  ...
  `}function vt(a){var o,n,s;const e=_().find(r=>r.id===a);if(!e)return;(o=document.getElementById("day-link-modal"))==null||o.remove();const i=oa.map(r=>`<option value="${r.date}" ${e.day_date===r.date?"selected":""}>
  ...
  `,document.body.appendChild(t),(n=document.getElementById("day-link-confirm"))==null||n.addEventListener("click",()=>{var l;const r=((l=document.getElementById("day-link-select"))==null?void 0:l.value)||null;Y(a,{day_date:r}),t.remove(),q()}),(s=document.getElementById("day-link-cancel"))==null||s.addEventListener("click",()=>t.remove()),t.addEventListener("click",r=>{r.target===t&&t.remove()})}function Be(){const a=document.getElementById("ideas-list");a&&(a.addEventListener("change",e=>{e.target.dataset.action==="stato"&&(Y(e.target.dataset.id,{stato:e.target.value}),q(),V())}),a.addEventListener("click",e=>{var n;const i=e.target.closest("[data-action]");if(!i)return;const t=i.dataset.id,o=i.dataset.action;if(o==="delete"){if(!confirm("Eliminare questa idea?"))return;qa(t),q(),V()}if(o==="edit"){O=t;const s=_().find(r=>r.id===t);if(!s)return;A=!0,document.getElementById("ideas-form-wrap").innerHTML=fa(s),ha(),(n=document.getElementById("ideas-form-wrap"))==null||n.scrollIntoView({behavior:"smooth",block:"start"})}if(o==="checklist"){const s=_().find(r=>r.id===t);if(!s)return;Y(t,{add_to_checklist:!s.add_to_checklist}),q()}o==="day-link"&&vt(t)}))}function q(){const a=document.getElementById("ideas-list");a&&(a.innerHTML=Ae(),Be())}function bt(){var a,e;(a=document.getElementById("export-btn"))==null||a.addEventListener("click",()=>{const i=Ye(),t=new Blob([i],{type:"application/json"}),o=URL.createObjectURL(t),n=document.createElement("a");n.href=o,n.download=`idee_viaggio_${new Date().toISOString().slice(0,10)}.json`,n.click(),URL.revokeObjectURL(o)}),(e=document.getElementById("import-file"))==null||e.addEventListener("change",async i=>{var o;const t=(o=i.target.files)==null?void 0:o[0];if(t){try{const n=await t.text(),s=Qe(n);alert(`Importazione completata: ${s} nuove idee aggiunte.`),q(),V()}catch(n){alert("Errore importazione: "+n.message)}i.target.value=""}})}function ft(a){return a==="alta"?"#ef4444":a==="media"?"#f59e0b":"#22c55e"}function B(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ia(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const wa="day-picker-modal",Ya="__nessuno__";function qe({nome:a,giorni:e=[],giaScelti:i=[],consentiNessuno:t=!1,onConferma:o}){var u,m,d;(u=document.getElementById(wa))==null||u.remove();const n=new Set(i);if(!e.filter(p=>!n.has(p.date)).length&&!t){ht(a);return}const r=[t?`<option value="${Ya}">Senza giorno — tienila solo tra le Idee</option>`:"",...e.map(p=>{const y=n.has(p.date),L=p.location?` · ${Ia(p.location)}`:"";return`<option value="${p.date}" ${y?"disabled":""}>
  ...
  `:""}function Xa(a){const e=zt[a.impegno]||{label:a.impegno,icon:"🕐",cls:""},i=_t[a.nota_tipo]||{label:a.nota_tipo,cls:""},t=Lt[a.tipo]||null,o=$t[a.id]||a.nome,n=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(o)}`,s=yt[a.id];return`
  ...
  `}function ae(){document.querySelectorAll(".natura-add-idea-btn").forEach(a=>{a.addEventListener("click",()=>{const e=a.dataset.nome,i=a.dataset.area,t=parseFloat(a.dataset.lat),o=parseFloat(a.dataset.lng),n=s=>{ea({text:e,location_name:i,categoria:"escursione",stato:"da-verificare",day_date:s,add_to_map:!0,coordinates:{lat:t,lng:o},marker_color:"#10b981"}),St(a,s)};if(!aa.length){n(null);return}qe({nome:e,giorni:aa,giaScelti:_().filter(s=>s.text===e&&s.day_date).map(s=>s.day_date),consentiNessuno:!0,onConferma:n})})})}function St(a,e){const i=e?aa.find(t=>t.date===e):null;a.textContent=i?`✅ Aggiunta al Gg. ${i.day}`:"✅ Aggiunta alle Idee",a.disabled=!0,setTimeout(()=>{a.textContent="📌 Aggiungi a un giorno",a.disabled=!1},2200)}function Aa(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const ee={high:{label:"Da non dimenticare",cls:"logi-prio-high"},medium:{label:"Importante",cls:"logi-prio-medium"},low:{label:"Promemoria",cls:"logi-prio-low"}},la="guida-viaggio";async function It(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(n){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${n.message}</p></div>`;return}const i=e.logistics||[],t=e.bookings||[],o=e.days||[];a.innerHTML=`
    <div class="page-header">
    ...
    ${i.length===0?'<p style="color:var(--color-text-muted);">Nessuna nota logistica.</p>':`<div class="logi-list">${i.map(jt).join("")}</div>`}
  `,xt(t),wt(e.guide),Mt(e.ferries)}function Ce(a){const e=H(la),i='<input type="file" id="guide-file" accept="application/pdf,.pdf,.epub" hidden />',t=a!=null&&a.url?`
  ...
  `:"",o=e?`
    <div class="guide-card">
      <div class="guide-card-main">
        ...
        <span class="guide-size">${At(e.size)} · su questo dispositivo, anche offline</span>
      </div>
  ...
  `;return`
    ...
    ${i}
  `}function wt(a){const e=document.getElementById("guide-section");if(!e)return;e.addEventListener("click",o=>{var n;if(o.target.closest("#guide-add")){(n=document.getElementById("guide-file"))==null||n.click();return}if(o.target.closest("#guide-open")){Pe(la);return}o.target.closest("#guide-del")&&confirm("Rimuovere la guida da questo dispositivo?")&&da(la)}),e.addEventListener("change",o=>{var r;const n=o.target.closest("#guide-file");if(!((r=n==null?void 0:n.files)!=null&&r.length))return;const s=n.files[0];ca(la,s).catch(l=>{console.error("[guida]",l),alert("Impossibile salvare la guida su questo dispositivo: il file è grande e lo spazio del browser potrebbe non bastare.")}),n.value=""});const i=()=>{e.innerHTML=Ce(a)};window.addEventListener("attachments:updated",i);const t=window.__currentPageCleanup;window.__currentPageCleanup=()=>{t==null||t(),window.removeEventListener("attachments:updated",i)}}function At(a){if(a==null)return"";if(a===0)return"file vuoto (0 byte)";const e=a/(1024*1024);return e>=1?`${e.toFixed(1)} MB`:`${Math.round(a/1024)} kB`}function Bt(a,e){const i=a.map(t=>`<option value="${t.date}">${b(t.date)} · ${v(t.location||t.title||"")}</option>`).join("");return`
  ...
  `}function xe(a){const e=[...a.map(i=>({...i,_fixed:!0})),...ba().map(i=>({...i,_fixed:!1}))].sort((i,t)=>ie(i).localeCompare(ie(t)));return e.length===0?'<p class="booking-empty">Nessuna prenotazione ancora. Aggiungi la prima qui sotto.</p>':`<div class="booking-list">${e.map(qt).join("")}</div>`}function qt(a){const e=ve(a),i=[a.date?b(a.date):"",a.time].filter(Boolean).join(" · ");return`
  ...
  `}function Ct(a){const e=H(a),i=`<input type="file" class="booking-attach-input" data-id="${v(a)}"
    ...
    ${i}
  `}function ie(a){const e=a.date||"9999-12-31",i=String(W(a.time)).padStart(5,"0");return`${e} ${i}`}function xt(a){var n,s;const e=document.querySelector(".booking-section");if(!e)return;const i=e.querySelector("#booking-form"),t=e.querySelector("#bookings-list");(n=e.querySelector("#booking-add-toggle"))==null||n.addEventListener("click",()=>{var r;i.classList.toggle("hidden"),i.classList.contains("hidden")||(r=i.querySelector(".booking-place"))==null||r.focus()}),(s=e.querySelector("#booking-cancel"))==null||s.addEventListener("click",()=>{i.classList.add("hidden")}),t==null||t.addEventListener("click",r=>{var d;const l=r.target.closest(".booking-card-del");if(l){confirm("Eliminare questa prenotazione?")&&da(l.dataset.id).finally(()=>di(l.dataset.id));return}const c=r.target.closest(".booking-attach-add, .booking-attach");if(c&&r.target.closest(".booking-attach-add")){(d=c.parentElement.querySelector(".booking-attach-input"))==null||d.click();return}const u=r.target.closest(".booking-attach-open");if(u){Pe(u.dataset.id);return}const m=r.target.closest(".booking-attach-del");if(m){confirm("Rimuovere questo allegato?")&&da(m.dataset.id);return}}),t==null||t.addEventListener("change",r=>{var u;const l=r.target.closest(".booking-attach-input");if(!l||!((u=l.files)!=null&&u.length))return;const c=l.dataset.id;ca(c,l.files[0]).catch(m=>{console.error("[attachments]",m),alert("Impossibile salvare l’allegato su questo dispositivo.")}),l.value=""}),i==null||i.addEventListener("submit",r=>{var p,y;r.preventDefault();const l=i.querySelector(".booking-place").value.trim();if(!l){i.querySelector(".booking-place").focus();return}const c=i.querySelector(".booking-loc").value.trim(),u=/^https?:\/\//i.test(c),m=ci({place:l,date:i.querySelector(".booking-date").value||null,time:i.querySelector(".booking-time").value.trim(),address:u?"":c,maps_url:u?c:"",note:i.querySelector(".booking-note").value.trim()}),d=(y=(p=i.querySelector(".booking-file"))==null?void 0:p.files)==null?void 0:y[0];d&&ca(m.id,d).catch(L=>{console.error("[attachments]",L),alert("Prenotazione salvata, ma non è stato possibile allegare il file su questo dispositivo.")}),i.reset(),i.classList.add("hidden")});const o=()=>{t&&(t.innerHTML=xe(a))};window.addEventListener("bookings:updated",o),window.addEventListener("attachments:updated",o),window.__currentPageCleanup=()=>{window.removeEventListener("bookings:updated",o),window.removeEventListener("attachments:updated",o)}}const Pe=Da;function Me(a){return!a||!a.length?"":`
  ...
  `}function Pt(a){const e=H(a.id),i=`
  ...
  `}function Mt(a){const e=document.getElementById("ferry-box");if(!e)return;e.addEventListener("click",o=>{var r;const n=o.target.closest("[data-act]");if(!n)return;const s=n.dataset.id;n.dataset.act==="add"?(r=e.querySelector(`.ferry-file[data-id="${CSS.escape(s)}"]`))==null||r.click():n.dataset.act==="open"?Da(s):n.dataset.act==="del"&&confirm("Rimuovere il biglietto da questo dispositivo?")&&da(s)}),e.addEventListener("change",o=>{var s;const n=o.target.closest(".ferry-file");(s=n==null?void 0:n.files)!=null&&s.length&&(ca(n.dataset.id,n.files[0]).catch(r=>{console.error("[biglietti]",r),alert("Impossibile salvare il biglietto su questo dispositivo: "+((r==null?void 0:r.message)||""))}),n.value="")});const i=()=>{e.innerHTML=Me(a)};window.addEventListener("attachments:updated",i);const t=window.__currentPageCleanup;window.__currentPageCleanup=()=>{t==null||t(),window.removeEventListener("attachments:updated",i)}}function jt(a){const e=ee[a.priority]||ee.low;return`
  ...
  `}function oe(){document.querySelectorAll(".attivita-card .attivita-head").forEach(a=>{a.addEventListener("click",()=>{const i=a.closest(".attivita-card").classList.toggle("open");a.setAttribute("aria-expanded",i?"true":"false")})})}let E=[],Na=[],ya="tutte";const je=a=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`;async function Tt(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(t){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${t.message}</p></div>`;return}E=e.hikes||[],Na=e.days.filter(t=>t.location.toLowerCase().includes("sesto")),ya="tutte",a.innerHTML=`
    <div class="page-header">
  ...
  `,Te(),Rt();const i=()=>Re();window.addEventListener("ideas:updated",i),window.__currentPageCleanup=()=>window.removeEventListener("ideas:updated",i)}function De(){return[{key:"tutte",label:`Tutte (${E.length})`},{key:"family",label:`👶 Adatte ai bimbi (${E.filter(e=>e.family).length})`},{key:"facili",label:`🟢 Facili (${E.filter(e=>/facile/i.test(e.difficulty)).length})`},{key:"auto",label:`🚗 In auto (${E.filter(e=>e.car).length})`},{key:"rifugi",label:`🏔️ Rifugi (${E.filter(e=>/rifugio/i.test(e.type)).length})`}].map(e=>`
    <button class="hike-filter-btn ${ya===e.key?"active":""}" data-f="${e.key}">${e.label}</button>
  `).join("")}function Nt(){switch(ya){case"family":return E.filter(a=>a.family);case"facili":return E.filter(a=>/facile/i.test(a.difficulty));case"auto":return E.filter(a=>a.car);case"rifugi":return E.filter(a=>/rifugio/i.test(a.type));default:return E}}function Te(){var a;(a=document.getElementById("hike-filters"))==null||a.querySelectorAll(".hike-filter-btn").forEach(e=>{e.addEventListener("click",()=>{ya=e.dataset.f,document.getElementById("hike-filters").innerHTML=De(),Te(),Re()})})}function Ne(a){return _().filter(e=>e.hike_id===a&&e.day_date).map(e=>({id:e.id,day:Na.find(i=>i.date===e.day_date)})).filter(e=>e.day)}function Ot(a){return/impegnativ/i.test(a)?"diff-hard":/media/i.test(a)?"diff-med":"diff-easy"}function Oe(){const a=Nt();return a.length?a.map(e=>{const i=Ne(e.id);return`
    ...
    `}).join(""):'<div class="ideas-empty">Nessuna meta per questo filtro.</div>'}function Re(){const a=document.getElementById("hike-grid");a&&(a.innerHTML=Oe())}function Rt(){const a=document.getElementById("hike-grid");a&&a.addEventListener("click",e=>{const i=e.target.closest(".hike-assigned-chip");if(i){qa(i.dataset.idea);return}const t=e.target.closest('[data-action="add"]');t&&Vt(t.dataset.id)})}function Vt(a){const e=E.find(i=>i.id===a);e&&qe({nome:e.name,giorni:Na,giaScelti:Ne(a).map(i=>i.day.date),onConferma:i=>{ea({text:e.name,note:`${e.type} · ${e.difficulty} · ${e.duration} — ${e.description}`,categoria:"escursione",stato:"idea",day_date:i,location_name:e.start,link:je(e.name),coordinates:e.coordinates||null,add_to_map:!!e.coordinates,marker_color:"#10b981",hike_id:e.id})}})}const ne={"#dashboard":oi,"#itinerary":Ii,"#attivita":Dt,"#passeggiate":Tt,"#hotels":ji,"#checklist":Ui,"#map":Xi,"#ideas":pt,"#natura":Et,"#logistics":It};async function Ve(){typeof window.__currentPageCleanup=="function"&&(window.__currentPageCleanup(),window.__currentPageCleanup=null);const[a,e]=(window.location.hash||"#dashboard").split("/"),i=ne[a]??ne["#dashboard"],t=document.getElementById("page-content");t.innerHTML=`
    <div class="loading">
