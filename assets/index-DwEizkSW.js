(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(o){if(o.ep)return;o.ep=!0;const n=t(o);fetch(o.href,n)}})();function Ze(){const a=document.getElementById("nav-toggle"),e=document.getElementById("nav-links");a==null||a.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),e==null||e.querySelectorAll(".nav-link").forEach(i=>{i.addEventListener("click",()=>{e.classList.remove("open")})});function t(){const i=(window.location.hash||"#dashboard").split("/")[0];document.querySelectorAll(".nav-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("href")===i)})}window.addEventListener("hashchange",t),t()}let ca=null;async function I(){if(ca)return ca;const e="/viaggio-croazia/data/trip.json";let t;try{t=await fetch(e)}catch{throw new Error("Dati del viaggio non disponibili offline. Apri l’app una volta con la rete: da quel momento resta consultabile anche senza connessione.")}if(!t.ok)throw new Error(`Impossibile caricare trip.json (${t.status})`);return ca=await t.json(),ca}function f(a){if(!a)return"";const[,e,t]=a.split("-");return`${t}/${e}`}function Fe(a){return a?new Date(a+"T00:00:00").toLocaleDateString("it-IT",{weekday:"short"}).toUpperCase():""}function Ha(a){const e=new Date;e.setHours(0,0,0,0);const t=new Date(a+"T00:00:00");return Math.round((t-e)/(1e3*60*60*24))}function Ue(a){return"★".repeat(a)+"☆".repeat(5-a)}function j(a){return`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(a)}&travelmode=driving`}function Ga(a,e){return`https://www.google.com/maps/dir/?api=1&destination=${a},${e}&travelmode=driving`}const Za={mattina:8*60,mattino:8*60,colazione:8*60,pranzo:13*60,pomeriggio:15*60,aperitivo:18*60,sera:20*60,serata:20*60,cena:20*60,notte:23*60};function X(a){const e=String(a??"").trim().toLowerCase();if(!e)return 9998;const t=e.match(/(\d{1,2})\s*[:.,h]\s*(\d{2})/)||e.match(/^(\d{1,2})(\d{2})$/)||e.match(/^(\d{1,2})$/);if(t){const i=Number(t[1]),o=t[2]!=null?Number(t[2]):0;if(i<=23&&o<=59)return i*60+o}for(const i in Za)if(e.includes(i))return Za[i];return 9998}function Ke(a){return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`}function Fa(a){const e=String(a??"").trim();return e?/^https?:\/\//i.test(e)?e:Ke(e):""}const se="viaggio_croazia_ideas_v1",fa=[{value:"alloggio",label:"🏨 Alloggio"},{value:"ristorante",label:"🍽️ Ristorante"},{value:"bar",label:"🍹 Bar"},{value:"esperienza",label:"🎯 Esperienza"},{value:"spiaggia",label:"🏖️ Spiaggia"},{value:"escursione",label:"🥾 Escursione"},{value:"cantina",label:"🍷 Cantina / Cibo"},{value:"shopping",label:"🛍️ Shopping"},{value:"varia",label:"💡 Varia"}],aa=[{value:"idea",label:"Idea",color:"#6366f1"},{value:"da-verificare",label:"Da verificare",color:"#f59e0b"},{value:"prenotare",label:"Prenotare",color:"#ef4444"},{value:"approvata",label:"Approvata",color:"#10b981"},{value:"fatto",label:"Fatto",color:"#0ea5e9"},{value:"scartata",label:"Scartata",color:"#94a3b8"}],Y=3,le=[{value:"alta",label:"🔴 Alta"},{value:"media",label:"🟡 Media"},{value:"bassa",label:"🟢 Bassa"}],Je=[{value:"#f59e0b",label:"Giallo"},{value:"#ef4444",label:"Rosso"},{value:"#8b5cf6",label:"Viola"},{value:"#10b981",label:"Verde"},{value:"#f97316",label:"Arancio"}];function We(){return"idea_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function xa(a){return{categoria:"varia",link:"",priorita:"media",stato:"idea",rating:0,note:a.note??"",location_name:a.location_name??null,...a}}function z(){try{const a=localStorage.getItem(se);return a?JSON.parse(a).map(xa):[]}catch{return[]}}function ha(a){try{localStorage.setItem(se,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("ideas:updated",{detail:{ideas:a}}))}catch(e){console.warn("[ideas] localStorage non disponibile:",e)}}function oa(a){const e=z(),t=xa({id:We(),text:"",note:"",categoria:"varia",link:"",priorita:"media",stato:"idea",rating:0,created_at:new Date().toISOString(),day_date:null,location_name:null,coordinates:null,add_to_checklist:!1,add_to_map:!1,marker_color:"#f59e0b",completed:!1,...a});return t.stato==="fatto"&&(t.completed=!0),e.unshift(t),ha(e),t}function T(a,e){const t=z(),i=t.findIndex(n=>n.id===a);if(i===-1)return null;const o={...t[i],...e};return"stato"in e&&!("completed"in e)?o.completed=e.stato==="fatto":"completed"in e&&!("stato"in e)&&(e.completed?o.stato="fatto":o.stato==="fatto"&&(o.stato="idea")),t[i]=o,ha(t),o}function ce(a){ha(z().filter(e=>e.id!==a))}function Ye(a){return z().filter(e=>e.day_date===a)}function Qe(){return z().filter(a=>a.add_to_checklist)}function ya(){return z().filter(a=>{var e;return a.add_to_map&&((e=a.coordinates)==null?void 0:e.lat)!=null})}function Xe(){return JSON.stringify(z(),null,2)}function at(a){const e=JSON.parse(a);if(!Array.isArray(e))throw new Error("JSON non valido: deve essere un array");const t=z(),i=new Set(t.map(s=>s.id));let o=0;const n=[...t];return e.forEach(s=>{i.has(s.id)||(n.push(xa(s)),o++)}),ha(n),o}function Pa(a,e,t){if(!a||!e)return[];const i=e.toLowerCase(),o=a.filter(s=>i.includes(s.area.toLowerCase())),n=o.filter(s=>Array.isArray(s.dates)&&s.dates.includes(t));return n.length?n:o.filter(s=>!Array.isArray(s.dates)||s.dates.length===0)}function Ma(a){return z().filter(e=>e.day_date===a&&e.stato!=="scartata")}function ja(a){return/sesto/i.test(a.location||"")}function de(a,e){var n;const t=((n=a.activities)==null?void 0:n.length)||0,i=ja(a)?0:Pa(e,a.location,a.date).length,o=Ma(a.date).length;return t+i+o}function y(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const ue=a=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`;function pe(a,e,t=[]){var v,_,P;const i=Pa(e,a.location,a.date),o=Ma(a.date),n=new Set(o.map(g=>String(g.text??"").toLowerCase())),s=((v=a.tips)==null?void 0:v.do)||[],r=((_=a.tips)==null?void 0:_.eat)||[],l=ja(a),c=(P=a.activities)!=null&&P.length?`<div class="sugg-section">
         <div class="sugg-section-title">🎯 Programma del giorno</div>
         <div class="sugg-activities">
           ${a.activities.map(g=>`
             <div class="sugg-activity">
               <span class="sugg-activity-time">${y(g.time)}</span>
               <span>${y(g.text)}</span>
             </div>`).join("")}
         </div>
       </div>`:"",u=!l&&s.length?`<div class="sugg-section">
         <div class="sugg-section-title">✨ Cose da fare in zona</div>
         <ul class="sugg-tips">${s.map(g=>`<li>${y(g)}</li>`).join("")}</ul>
       </div>`:"";let m="";if(l){const g=o.map(k=>t.find(E=>E.id===k.hike_id)).filter(k=>k&&Array.isArray(k.tips)&&k.tips.length);g.length&&(m=`<div class="sugg-section">
        <div class="sugg-section-title">✨ Consigli — in base alle attività scelte</div>
        <div class="sugg-eat-list">
          ${g.map(k=>`
            <div class="sugg-eat">
              <span class="sugg-eat-act">${y(k.name)}</span>
              <ul class="sugg-tips">${k.tips.map(E=>`<li>${y(E)}</li>`).join("")}</ul>
            </div>`).join("")}
        </div>
      </div>`)}let d="";if(l){const g=o.map(k=>t.find(E=>E.id===k.hike_id)).filter(k=>k&&k.eat);g.length&&(d=`<div class="sugg-section">
        <div class="sugg-section-title">🍽️ Dove mangiare — in base alle attività scelte</div>
        <div class="sugg-eat-list">
          ${g.map(k=>`
            <div class="sugg-eat">
              <span class="sugg-eat-act">${y(k.name)}</span>
              <span class="sugg-eat-tip">${y(k.eat)}</span>
            </div>`).join("")}
        </div>
      </div>`)}else(i.length||r.length)&&(d=`<div class="sugg-section">
         <div class="sugg-section-title">🍽️ Dove mangiare in zona</div>
         ${r.length?`<ul class="sugg-tips">${r.map(g=>`<li>${y(g)}</li>`).join("")}</ul>`:""}
         <div class="sugg-dining">
           ${i.map(g=>`
             <div class="sugg-dining-item">
               <a class="sugg-dining-link" target="_blank" rel="noopener" href="${ue(g.name+" "+g.town)}">
                 <div class="sugg-dining-head">
                   <span class="sugg-dining-name">${y(g.name)}</span>
                   ${g.type?`<span class="sugg-dining-type">${y(g.type)}</span>`:""}
                 </div>
                 <div class="sugg-dining-town">📍 ${y(g.town)}</div>
                 <div class="sugg-dining-spec">${y(g.specialty)}</div>
               </a>
               ${n.has(g.name.toLowerCase())?'<button type="button" class="sugg-dining-add" disabled>✅ Aggiunto</button>':`<button type="button" class="sugg-dining-add"
                      data-date="${y(a.date)}"
                      data-name="${y(g.name)}"
                      data-town="${y(g.town)}"
    ...
    <div class="sugg-section">
      ...
      ${o.length?`<div class="sugg-ideas">${o.map(g=>`
            <div class="sugg-idea">
              <span class="sugg-idea-text">${y(g.text)}</span>
              ${g.note?`<span class="sugg-idea-note">${y(g.note)}</span>`:""}
              ${g.location_name?`<span class="sugg-idea-chip">📍 ${y(g.location_name)}</span>`:""}
              ${g.link?`<a href="${y(g.link)}" target="_blank" rel="noopener" class="sugg-idea-chip">🔗 Link</a>`:""}
    ...
    </div>`;return c+u+m+d+p}function ge(a){!a||a.dataset.diningBound==="1"||(a.dataset.diningBound="1",a.addEventListener("click",e=>{const t=e.target.closest(".sugg-dining-add");if(!t||t.disabled)return;e.preventDefault();const{date:i,name:o,town:n}=t.dataset;!i||!o||(oa({text:o,note:n?`Ristorante · ${n}`:"Ristorante",categoria:"ristorante",stato:"idea",day_date:i,location_name:n||null,link:ue(`${o} ${n||""}`.trim())}),t.textContent="✅ Aggiunto",t.disabled=!0)}))}function et(a){return String(a??"").replace(/\s*\(.*?\)\s*/g,"").trim()}function tt(a,e){if(!a)return[];const t=[],i=new Set,o=(r,l,c)=>{if(!l||!c)return;const u=l.toLowerCase();i.has(u)||(i.add(u),t.push({icon:r,label:l,url:c}))},n=(e.ferries||[]).find(r=>r.day===a.day);if(n){const r=et(n.from);r&&o("⛴️",`Porto di ${r}`,j(`Porto di ${r}`))}const s=(e.hotels||[]).find(r=>r.id===a.hotel_ref);if(s){const r=s.coordinates?Ga(s.coordinates.lat,s.coordinates.lng):j([s.name,s.address].filter(Boolean).join(" "));o("🏨",s.name,r)}return Ma(a.date).forEach(r=>{var l;((l=r.coordinates)==null?void 0:l.lat)!=null?o("💡",r.text,Ga(r.coordinates.lat,r.coordinates.lng)):r.location_name&&o("💡",r.text,j(r.location_name))}),ot(e.dining,a).forEach(r=>{o("🍽️",r.name,j(`${r.name} ${r.town}`))}),t}function it(a){return[a.title,...(a.activities||[]).map(e=>e.text)].filter(Boolean).join(" ").toLowerCase()}function ot(a,e){if(!(a!=null&&a.length))return[];const t=it(e);return t?Pa(a,e.location,e.date).filter(i=>{const o=String(i.name??"").toLowerCase().trim();return o?t.includes(o)?!0:o.split(/[–—\-\/]/).map(n=>n.trim()).filter(n=>n.length>=4).some(n=>t.includes(n)):!1}):[]}function Ua(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function nt(a,e,t="🚗 Naviga"){const i=tt(a,e);return i.length?`
    <div class="route-nav">
      <div class="route-nav-title">${t} <span>(partenza: la tua posizione)</span></div>
      <div class="route-nav-list">
        ${i.map(o=>`
          <a class="route-nav-btn" target="_blank" rel="noopener" href="${Ua(o.url)}">
            <span>${o.icon}</span>
            <span>${Ua(o.label)}</span>
          </a>`).join("")}
      </div>
    </div>
  `:""}async function rt(){var k,E,K;const a=document.getElementById("page-content");let e;try{e=await I()}catch(h){a.innerHTML=dt(h.message);return}const{meta:t,days:i,hotels:o}=e,n=Ha(t.start_date),s=Ha(t.end_date),r=new Date().toISOString().slice(0,10),l=i.find(h=>h.date===r),c=i.find(h=>h.date>r),u=l||c,m=l?"Programma di oggi":c?"Prossima tappa":"Ultima tappa",d=[],p=new Set;for(const h of i)p.has(h.location)||(p.add(h.location),d.push({location:h.location,day:h.day,date:h.date}));const v=o.filter(h=>h.status==="confermata"),_=v.length,P=v.reduce((h,A)=>h+A.nights,0),g=u?de(u,e.dining):0;a.innerHTML=`
    <div class="dashboard-hero">
      ...
      <div class="dates">
        ...
        <span class="date-badge">🏔️ ${f(t.end_date)}</span>
        <span class="date-badge">👥 ${t.travelers_detail||t.travelers+" viaggiatori"}</span>
      </div>
    </div>

    ${ct(n,s,l,t.duration_days)}

    <div class="stats-grid">
      <div class="stat-card">
        <div class="stat-icon">📅</div>
        <div class="stat-value">${t.duration_days}</div>
        <div class="stat-label">Giorni (${f(t.start_date)}–${f(t.end_date)})</div>
      </div>
      <div class="stat-card">
        <div class="stat-icon">🏨</div>
    ...
    <div class="dashboard-grid">
      <div class="card card-body">
        ...
        <div class="route-stops" id="route-stops">
          ${d.map(h=>`
            <button type="button" class="route-stop route-stop--link ${u&&h.date===u.date?"route-stop--attiva":""}"
               data-date="${h.date}"
               title="Vedi l'anteprima di ${h.location} qui accanto">
              <span class="stop-day">Gg. ${h.day}</span>
  ...
  `,(k=document.getElementById("route-stops"))==null||k.addEventListener("click",h=>{const A=h.target.closest(".route-stop");if(!A)return;const J=i.find(la=>la.date===A.dataset.date);if(!J)return;const Va=document.getElementById("today-card");Va&&(Va.innerHTML=La(J,e,u,m)),document.querySelectorAll("#route-stops .route-stop").forEach(la=>la.classList.toggle("route-stop--attiva",la===A))}),(E=document.getElementById("today-card"))==null||E.addEventListener("click",h=>{if(!h.target.closest("#preview-reset"))return;const A=document.getElementById("today-card");A&&(A.innerHTML=La(u,e,u,m)),document.querySelectorAll("#route-stops .route-stop").forEach(J=>J.classList.toggle("route-stop--attiva",!!u&&J.dataset.date===u.date))}),(K=document.getElementById("suggestions-card"))==null||K.addEventListener("click",()=>{u&&st(u,e.dining,e.hikes)})}function La(a,e,t,i){if(!a)return`<div class="section-title">${i}</div>
      <p style="color:var(--color-text-muted);font-size:0.9rem;">Nessuna tappa disponibile.</p>`;const o=!!t&&a.date===t.date,n=o?i:`Anteprima — Gg. ${a.day}`,s=a.activities||[];return`
    <div class="section-title">
      ${n}
      ${o?"":`<button type="button" class="preview-reset" id="preview-reset"
         title="Torna alla tappa corrente">↩ ${i}</button>`}
    </div>
    <div style="margin-bottom:0.75rem;">
      <strong>${O(a.title)}</strong>
      <div style="font-size:0.82rem; color:var(--color-text-muted); margin-top:0.2rem;">
        📍 ${O(a.location)} · ${f(a.date)}
      </div>
    </div>
    <div class="activity-list">
      ${s.slice(0,5).map(r=>`
        <div class="activity-item">
          <span class="activity-time">${O(r.time)}</span>
          <span>${O(r.text)}</span>
        </div>
      `).join("")}
      ${s.length>5?`<div style="font-size:0.8rem;color:var(--color-text-muted);">+${s.length-5} altre attività → <a href="#itinerary/${a.date}" style="color:var(--color-primary);">Vedi itinerario</a></div>`:""}
      ${s.length===0?'<div style="font-size:0.85rem;color:var(--color-text-muted);">Nessuna attività in programma.</div>':""}
    </div>
    ${nt(a,e)}
  `}function st(a,e,t){var s,r,l;(s=document.getElementById("suggestions-modal"))==null||s.remove();const i=pe(a,e,t),o=document.createElement("div");o.id="suggestions-modal",o.className="day-link-modal-overlay",o.innerHTML=`
    <div class="day-link-modal suggestions-modal">
      ...
      <div class="sugg-header">
        ...
        <div class="sugg-subtitle">📍 ${O(a.location)} · ${f(a.date)}</div>
      </div>
      <div class="sugg-body">${i}</div>
      <a href="#attivita" class="sugg-all-link" id="sugg-all-link">📋 Vedi i suggerimenti di tutte le tappe →</a>
    </div>
  `,document.body.appendChild(o),ge(o.querySelector(".sugg-body"));const n=()=>o.remove();(r=document.getElementById("sugg-close"))==null||r.addEventListener("click",n),(l=document.getElementById("sugg-all-link"))==null||l.addEventListener("click",n),o.addEventListener("click",c=>{c.target===o&&n()})}function O(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function lt(a){const e=String(a??"").toLowerCase();return e.includes("rientro")?"🏠":e.includes("sesto")?"🏔️":e.includes("collio")?"🍷":e.includes("velebit")?"🐻":e.includes("spalato")?"⛴️":"🌊"}function ct(a,e,t,i){if(a>0)return`
    ...
    `;if(a<=0&&e>=0){const o=e===0?"è l'ultimo giorno!":`ancora ${e} giorni`,n=t?`Giorno ${t.day} di ${i}`:"Viaggio in corso",s=t?`📍 ${O(t.location)} — `:"";return`
      <div class="countdown-card departed">
        <div class="countdown-icon">${lt(t==null?void 0:t.location)}</div>
        <div>
          <div class="countdown-days">${n}</div>
          <div class="countdown-text">${s}${o}</div>
        </div>
      </div>
    `}return`
  ...
  `}const me="viaggio_croazia_bookings_v1";function ut(){return"book_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function ve(a){return{id:a.id||ut(),date:a.date??null,time:(a.time??"").trim(),place:(a.place??"").trim(),address:(a.address??"").trim(),maps_url:(a.maps_url??"").trim(),note:(a.note??"").trim(),created_at:a.created_at||new Date().toISOString()}}function be(a){if(a.maps_url)return Fa(a.maps_url);const e=[a.place,a.address].filter(Boolean).join(", ");return e?Fa(e):""}function ka(){try{const a=localStorage.getItem(me);return a?JSON.parse(a).map(ve):[]}catch{return[]}}function fe(a){try{localStorage.setItem(me,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("bookings:updated",{detail:{bookings:a}}))}catch(e){console.warn("[bookings] localStorage non disponibile:",e)}}function pt(a){const e=ka(),t=ve(a);return e.unshift(t),fe(e),t}function gt(a){fe(ka().filter(e=>e.id!==a))}function mt(a){return ka().filter(e=>e.date===a).sort((e,t)=>X(e.time)-X(t.time))}const he="viaggio_croazia_attachments_v1",vt="viaggio_croazia_files",C="attachments";function Ta(){try{const a=localStorage.getItem(he);return a?JSON.parse(a):{}}catch{return{}}}function Z(a){return Ta()[a]||null}function ye(a){try{localStorage.setItem(he,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("attachments:updated",{detail:{meta:a}}))}catch(e){console.warn("[attachments] localStorage non disponibile:",e)}}function Na(){return new Promise((a,e)=>{if(!("indexedDB"in window))return e(new Error("IndexedDB non disponibile"));const t=indexedDB.open(vt,1);t.onupgradeneeded=()=>{t.result.objectStoreNames.contains(C)||t.result.createObjectStore(C)},t.onsuccess=()=>a(t.result),t.onerror=()=>e(t.error)})}function bt(a,e){return Na().then(t=>new Promise((i,o)=>{const n=t.transaction(C,"readwrite");n.objectStore(C).put(e,a),n.oncomplete=()=>{t.close(),i()},n.onerror=()=>{t.close(),o(n.error)}}))}function ft(a){return Na().then(e=>new Promise((t,i)=>{const n=e.transaction(C,"readonly").objectStore(C).get(a);n.onsuccess=()=>{e.close(),t(n.result||null)},n.onerror=()=>{e.close(),i(n.error)}}))}function ht(a){return Na().then(e=>new Promise((t,i)=>{const o=e.transaction(C,"readwrite");o.objectStore(C).delete(a),o.oncomplete=()=>{e.close(),t()},o.onerror=()=>{e.close(),i(o.error)}}))}async function pa(a,e){await bt(a,e);const t=Ta();if(t[a]={name:e.name||"allegato",type:e.type||"",size:e.size||0,added_at:new Date().toISOString()},ye(t),!Z(a))throw new Error("Metadati non salvati: spazio del browser esaurito o localStorage non disponibile.");return t[a]}async function yt(a){const e=await ft(a);return e?URL.createObjectURL(e):null}async function ga(a){try{await ht(a)}catch{}const e=Ta();delete e[a],ye(e)}async function Ra(a){const e=Z(a),i=/^(image\/|application\/pdf)/.test((e==null?void 0:e.type)||"")?window.open("","_blank"):null;i&&(i.opener=null);try{const o=await yt(a);if(!o){i==null||i.close(),alert("File non trovato su questo dispositivo.");return}i?i.location=o:kt(o,e==null?void 0:e.name),setTimeout(()=>URL.revokeObjectURL(o),6e4)}catch(o){console.error("[attachments]",o),i==null||i.close(),alert("Impossibile aprire il file.")}}function kt(a,e){const t=document.createElement("a");t.href=a,t.download=e||"allegato",document.body.appendChild(t),t.click(),t.remove()}function ke(a){if(!a)return"📎";const e=(a.type||"").toLowerCase(),t=(a.name||"").toLowerCase();return e.startsWith("image/")||/\.(png|jpe?g|gif|webp|heic)$/.test(t)?"🖼️":e==="application/pdf"||t.endsWith(".pdf")?"📄":e==="message/rfc822"||t.endsWith(".eml")?"✉️":"📎"}const $e="viaggio_croazia_program_v1";function $t(){return"act_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function x(){try{const a=localStorage.getItem($e);return a?JSON.parse(a):{}}catch{return{}}}function F(a){try{localStorage.setItem($e,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("program:updated",{detail:{data:a}}))}catch(e){console.warn("[program] localStorage non disponibile:",e)}}function na(a,e){a[e]||(a[e]={edits:{},hidden:{},added:[]});const t=a[e];return t.edits=t.edits||{},t.hidden=t.hidden||{},t.added=t.added||[],t}function zt(a,e=[]){const t=x()[a]||{},i=t.edits||{},o=t.hidden||{},n=t.added||[],s=[];return e.forEach((r,l)=>{if(o[l])return;const c=i[l]||{};s.push({key:"base:"+l,base:!0,index:l,time:c.time??r.time??"",text:c.text??r.text??"",maps:r.maps??null})}),n.forEach(r=>{s.push({key:"add:"+r.id,base:!1,id:r.id,time:r.time||"",text:r.text||"",maps:r.maps||null})}),s.sort((r,l)=>X(r.time)-X(l.time)),s}function _t(a){const e=x()[a];return e?!!(e.added&&e.added.length||e.hidden&&Object.keys(e.hidden).length||e.edits&&Object.keys(e.edits).length):!1}function Lt(a,e,t){const i=x(),o=na(i,a);o.edits[e]={...o.edits[e]||{},...t},F(i)}function St(a,e){const t=x(),i=na(t,a);i.hidden[e]=!0,delete i.edits[e],F(t)}function Et(a,{time:e="",text:t="",maps:i=""}={}){const o=x(),n=na(o,a),s={id:$t(),time:e.trim(),text:t.trim(),maps:(i||"").trim()};return n.added.push(s),F(o),s}function It(a,e,t){const i=x(),o=na(i,a),n=o.added.findIndex(s=>s.id===e);n!==-1&&(o.added[n]={...o.added[n],...t},F(i))}function wt(a,e){const t=x(),i=na(t,a);i.added=i.added.filter(o=>o.id!==e),F(t)}function At(a){const e=x();e[a]&&(delete e[a],F(e))}const Q=new Set;let ze={};async function Bt(a){var u,m;const e=document.getElementById("page-content");let t;try{t=await I()}catch(d){e.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${d.message}</p></div>`;return}const{days:i,hotels:o,meta:n}=t,s=t.ferries||[],r=Object.fromEntries(o.map(d=>[d.id,d]));ze=Object.fromEntries(i.map(d=>[d.date,d])),e.innerHTML=`
    <div class="page-header">
      <h1>📅 Itinerario</h1>
      <p>${n.title} · ${n.duration_days} giorni · ${f(n.start_date)} → ${f(n.end_date)}</p>
    </div>
    ...
    <div class="timeline">
      ${i.map(d=>xt(d,r,s)).join("")}
    </div>
  `,document.querySelectorAll(".timeline-card-header").forEach(d=>{d.addEventListener("click",()=>{const p=d.nextElementSibling,v=d.querySelector(".timeline-toggle");p==null||p.classList.toggle("hidden"),v==null||v.classList.toggle("open")})}),(u=document.getElementById("expand-all"))==null||u.addEventListener("click",()=>{document.querySelectorAll(".timeline-card-body").forEach(d=>d.classList.remove("hidden")),document.querySelectorAll(".timeline-toggle").forEach(d=>d.classList.add("open"))}),(m=document.getElementById("collapse-all"))==null||m.addEventListener("click",()=>{document.querySelectorAll(".timeline-card-body").forEach(d=>d.classList.add("hidden")),document.querySelectorAll(".timeline-toggle").forEach(d=>d.classList.remove("open"))}),a&&qt(a),Tt(i),Nt();const l=()=>{document.querySelectorAll(".day-ideas-section").forEach(d=>{const p=d.dataset.date;p&&(d.innerHTML=_e(p))})},c=()=>{document.querySelectorAll(".activities[data-date]").forEach(d=>{D(d.dataset.date)})};window.addEventListener("ideas:updated",l),window.addEventListener("bookings:updated",c),window.__currentPageCleanup=()=>{window.removeEventListener("ideas:updated",l),window.removeEventListener("bookings:updated",c)}}function qt(a){var i,o;const e=document.querySelector(`.timeline-item[data-date="${a}"]`);if(!e)return;(i=e.querySelector(".timeline-card-body"))==null||i.classList.remove("hidden"),(o=e.querySelector(".timeline-toggle"))==null||o.classList.add("open");const t=e.querySelector(".timeline-card");t==null||t.classList.add("timeline-card--evidenza"),setTimeout(()=>t==null?void 0:t.classList.remove("timeline-card--evidenza"),2e3),e.scrollIntoView({behavior:"smooth",block:"start"})}function Ct(a){const e=`🎫 Traghetto ${$(a.from)} → ${$(a.to)} · 🕐 ${$(a.time)}`;return Z(a.id)?`
      <button class="day-ferry-badge" data-ferry="${$(a.id)}">
  ...
  `}function xt(a,e,t=[]){const i=a.hotel_ref?e[a.hotel_ref]:null,o=t.filter(c=>c.day===a.day||c.date===a.date),n=new Date().toISOString().slice(0,10),s=a.date===n,r=a.date<n,l=a.coordinates?JSON.stringify(a.coordinates):"null";return`
    <div class="timeline-item" data-date="${a.date}">
          ...
          <div class="timeline-card-body hidden">
            ...
            ${i?`
              <div class="hotel-ref-badge">
                🏨 ${i.name} · Check-in ${f(i.checkin)} / Check-out ${f(i.checkout)}
              </div>
            `:""}
              ...
              <form class="day-quick-form hidden" id="quick-form-${a.date}" data-date="${a.date}">
                ...
                <div class="quick-form-selects">
                  <select class="quick-idea-cat ideas-select" title="Categoria">
                    ${fa.map(c=>`<option value="${c.value}" ${c.value==="varia"?"selected":""}>${c.label}</option>`).join("")}
                  </select>
                  <select class="quick-idea-stato ideas-select" title="Stato">
                    ${aa.map(c=>`<option value="${c.value}" ${c.value==="idea"?"selected":""}>${c.label}</option>`).join("")}
                  </select>
                </div>
  ...
  `}function Pt(a){if(!a)return"";const e=a.do||[],t=a.eat||[];return!e.length&&!t.length?"":`
    <div class="day-tips">
  ...
  `}function _e(a){const e=Ye(a);return e.length===0?"":e.map(t=>{const i=fa.find(s=>s.value===t.categoria),o=aa.find(s=>s.value===t.stato),n=Math.min(Y,Math.max(0,Number(t.rating)||0));return`
    <div class="day-idea-pill ${t.completed?"day-idea-pill--done":""}" data-id="${t.id}">
      <span class="idea-tiny-badge" title="${$((i==null?void 0:i.label)??"")}">${i?i.label.split(" ")[0]:"💡"}</span>
      <a class="day-idea-text" href="#ideas/${t.id}" title="Apri nella pagina Idee">${$(t.text)}</a>
      ${o&&t.stato!=="idea"?`
        <span class="day-idea-stato"
          style="background:${o.color}20;color:${o.color};border-color:${o.color}40;">${o.label}</span>`:""}
      ${n?`<span class="day-idea-stars" title="${n} su ${Y}">${"★".repeat(n)}</span>`:""}
      ${t.add_to_checklist?'<span class="idea-tiny-badge">📋</span>':""}
      ${t.add_to_map?'<span class="idea-tiny-badge">🗺️</span>':""}
      <button class="day-idea-unlink" data-id="${t.id}"
        title="Togli dal giorno (l'idea resta in Idee)">×</button>
    </div>
    `}).join("")}function Le(a,e){const t=zt(a.date,a.activities);return e?`
    ...
    ${t.map(i=>`
      <div class="activity-item with-dot">
        ...
        <span>
          ${$(i.text)}
          ${i.maps?`<a class="activity-maps" href="${$(i.maps)}" target="_blank" rel="noopener">🗺️ Maps</a>`:""}
        </span>
      </div>
    `).join("")}
    ${jt(a.date)}
    <div class="program-controls">
      ...
      ${_t(a.date)?'<span class="program-modified">modificato</span>':""}
    </div>
  `}function Mt(a){const e=a.base?`data-index="${a.index}"`:`data-id="${$(a.id)}"`;return`
    <div class="program-edit-row" data-base="${a.base}" ${e}>
      <input type="text" class="prog-time" value="${$(a.time)}" placeholder="Ora" />
      <input type="text" class="prog-text" value="${$(a.text)}" placeholder="Attività" />
      <button type="button" class="prog-del" title="Elimina">🗑️</button>
    </div>
  `}function jt(a){const e=mt(a);return e.length?e.map(t=>{const i=be(t);return`
      <div class="activity-item with-dot activity-booking">
        <span class="activity-time">${t.time?$(t.time):"🍽️"}</span>
        <span>
          🍽️ ${$(t.place)}<span class="activity-booking-tag">prenotazione</span>
          ${i?`<a class="activity-maps" href="${$(i)}" target="_blank" rel="noopener">🗺️ Maps</a>`:""}
        </span>
      </div>
    `}).join(""):""}function D(a){const e=document.querySelector(`.activities[data-date="${a}"]`),t=ze[a];e&&t&&(e.innerHTML=Le(t,Q.has(a)))}function Tt(a){const e=document.querySelector(".timeline");e&&(e.addEventListener("click",t=>{var r,l;const i=t.target.closest(".day-add-idea-btn");if(i){const c=i.dataset.date,u=document.getElementById(`quick-form-${c}`);if(!u)return;const m=u.classList.contains("hidden");document.querySelectorAll(".day-quick-form").forEach(d=>d.classList.add("hidden")),m&&(u.classList.remove("hidden"),(r=u.querySelector(".quick-idea-text"))==null||r.focus())}const o=t.target.closest(".quick-cancel");o&&((l=o.closest(".day-quick-form"))==null||l.classList.add("hidden"));const n=t.target.closest(".day-idea-unlink");n&&T(n.dataset.id,{day_date:null});const s=t.target.closest("[data-ferry]");s&&Ra(s.dataset.ferry)}),e.addEventListener("submit",t=>{var c,u,m,d,p,v;const i=t.target.closest(".day-quick-form");if(!i)return;t.preventDefault();const o=(c=i.querySelector(".quick-idea-text"))==null?void 0:c.value.trim();if(!o){(u=i.querySelector(".quick-idea-text"))==null||u.focus();return}const n=i.dataset.date,s=a.find(_=>_.date===n),r=(m=i.querySelector(".quick-map"))==null?void 0:m.checked,l=(d=i.querySelector(".quick-checklist"))==null?void 0:d.checked;oa({text:o,categoria:((p=i.querySelector(".quick-idea-cat"))==null?void 0:p.value)??"varia",stato:((v=i.querySelector(".quick-idea-stato"))==null?void 0:v.value)??"idea",day_date:n,location_name:(s==null?void 0:s.location)??null,coordinates:r&&(s!=null&&s.coordinates)?s.coordinates:null,add_to_checklist:!!l,add_to_map:!!(r&&(s!=null&&s.coordinates))}),i.querySelector(".quick-idea-text").value="",i.querySelector(".quick-idea-cat").value="varia",i.querySelector(".quick-idea-stato").value="idea",i.querySelector(".quick-map").checked=!1,i.querySelector(".quick-checklist").checked=!1,i.classList.add("hidden")}))}function Nt(){const a=document.querySelector(".timeline");a&&(a.addEventListener("click",e=>{var r,l,c,u,m;const t=e.target.closest(".program-edit-toggle");if(t){Q.add(t.dataset.date),D(t.dataset.date);return}const i=e.target.closest(".program-edit-done");if(i){Q.delete(i.dataset.date),D(i.dataset.date);return}const o=e.target.closest(".program-reset");if(o){const d=o.dataset.date;confirm("Ripristinare il programma di questo giorno come nell’itinerario originale? Le modifiche fatte a questo giorno andranno perse.")&&(At(d),Q.delete(d),D(d));return}const n=e.target.closest(".prog-del");if(n){const d=n.closest(".program-edit-row"),p=(r=n.closest(".activities"))==null?void 0:r.dataset.date;if(!d||!p)return;d.dataset.base==="true"?St(p,Number(d.dataset.index)):wt(p,d.dataset.id),D(p);return}const s=e.target.closest(".prog-add-btn");if(s){const d=s.dataset.date,p=s.closest(".program-add-row"),v=((l=p.querySelector(".prog-add-time"))==null?void 0:l.value.trim())||"",_=((c=p.querySelector(".prog-add-text"))==null?void 0:c.value.trim())||"";if(!_){(u=p.querySelector(".prog-add-text"))==null||u.focus();return}Et(d,{time:v,text:_}),D(d),(m=document.querySelector(`.activities[data-date="${d}"] .prog-add-text`))==null||m.focus();return}}),a.addEventListener("keydown",e=>{var t,i;e.key==="Enter"&&e.target.classList.contains("prog-add-text")&&(e.preventDefault(),(i=(t=e.target.closest(".program-add-row"))==null?void 0:t.querySelector(".prog-add-btn"))==null||i.click())}),a.addEventListener("change",e=>{var l,c,u;const t=e.target,i=(l=t.classList)==null?void 0:l.contains("prog-time"),o=(c=t.classList)==null?void 0:c.contains("prog-text");if(!i&&!o)return;const n=t.closest(".program-edit-row"),s=(u=t.closest(".activities"))==null?void 0:u.dataset.date;if(!n||!s)return;const r={[i?"time":"text"]:t.value.trim()};n.dataset.base==="true"?Lt(s,Number(n.dataset.index),r):It(s,n.dataset.id,r)}))}function $(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}async function Rt(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(r){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${r.message}</p></div>`;return}const{hotels:t}=e,i={},o=[];for(const r of t){const l=r.location_group||r.location;i[l]||(i[l]=[],o.push(l)),i[l].push(r)}const n=t.filter(r=>r.status==="confermata"),s=n.reduce((r,l)=>r+l.nights,0);a.innerHTML=`
    <div class="page-header">
      <h1>🏨 Hotel &amp; Alloggi</h1>
    ...
    <div class="hotels-summary">
      ...
      <div class="summary-item">
        <div class="summary-value">${t.filter(r=>r.status==="da_confermare").length}</div>
    ...
    ${o.map(r=>{var l,c;return`
      <div class="hotels-location-group">
        <div class="hotels-group-header">
          ...
          <span class="hotels-group-nights">${(l=i[r][0])!=null&&l.nights?i[r][0].nights+" nott"+(i[r][0].nights===1?"e":"i"):""} · ${(c=i[r][0])!=null&&c.checkin?f(i[r][0].checkin)+" → "+f(i[r][0].checkout):""}</span>
        </div>
    ...
    `}).join("")}
  `}function Dt(a){const e=a.nights,i=a.status==="confermata"||a.booking_ref&&a.booking_ref.length>0?'<span class="hotel-status-badge badge-prenotato">✅ Confermata</span>':a.status==="da_confermare"?'<span class="hotel-status-badge badge-confermare">⚠️ Da confermare</span>':'<span class="hotel-status-badge badge-da-prenotare">📋 Da prenotare</span>',o=a.recommended?'<span class="hotel-recommended-badge">⭐ Consigliato</span>':'<span class="hotel-alt-badge">Alternativa</span>';return`
      ...
      <div class="hotel-card-body">
        ...
        <div class="hotel-meta">
          <div class="hotel-rating" title="${a.rating} stelle">
            ${a.rating>0?Ue(a.rating):'<span style="color:var(--color-text-muted);font-size:0.78rem;">Categoria n.d.</span>'}
          </div>
  ...
  `}const Da="viaggio_croazia_checklist_v1",Se="viaggio_croazia_custom_items_v1";function Ot(){try{const a=localStorage.getItem(Da);return a?JSON.parse(a):{}}catch{return{}}}function Sa(a){try{localStorage.setItem(Da,JSON.stringify(a))}catch(e){console.warn("[storage] Impossibile salvare checklist:",e)}}function Vt(){try{localStorage.removeItem(Da)}catch{}}function Ht(){return"ci_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function U(){try{const a=localStorage.getItem(Se);return a?JSON.parse(a):[]}catch{return[]}}function ra(a){try{localStorage.setItem(Se,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("customitems:updated"))}catch(e){console.warn("[storage] Impossibile salvare custom items:",e)}}function Gt(a,e="Varie"){const t=U(),i={id:Ht(),text:a.trim(),category:e,checked:!1,created_at:new Date().toISOString()};return t.unshift(i),ra(t),i}function Zt(a,e){ra(U().map(t=>t.id===a?{...t,checked:e}:t))}function Ft(a,e){const t=e.trim();t&&ra(U().map(i=>i.id===a?{...i,text:t}:i))}function Ut(a){ra(U().filter(e=>e.id!==a))}function Kt(){ra([])}async function Jt(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(s){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${s.message}</p></div>`;return}const{categories:t}=e.checklist,i=Ot();a.innerHTML=`
    <div class="page-header">
  ...
  `,W(t,i),Xt(t,i),Ja(),wa();const o=()=>{const s=document.getElementById("checklist-ideas-section");s&&(s.innerHTML=Ka(),Ja())},n=()=>{const s=document.getElementById("custom-items-section");s&&(s.innerHTML=Ia(),wa())};window.addEventListener("ideas:updated",o),window.addEventListener("customitems:updated",n),window.__currentPageCleanup=()=>{window.removeEventListener("ideas:updated",o),window.removeEventListener("customitems:updated",n)}}function Ka(){const a=Qe();if(a.length===0)return"";const e=a.filter(o=>o.completed).length,t=a.length,i=t?e/t*100:0;return`
    <div class="category-card" id="ideas-checklist-card">
      <div class="category-header">
        <span class="category-icon">💡</span>
        <span class="category-name">Idee / Da fare</span>
        <span class="category-count" id="ideas-cl-count">${e}/${t}</span>
      ...
      <div class="category-items" id="ideas-cl-items">
        ${a.map(o=>`
          <label class="checklist-item ${o.completed?"checked":""}" data-idea-id="${o.id}">
            ...
            <span class="checklist-item-text">${ma(o.text)}</span>
            ${o.location_name?`<span class="priority-badge" style="background:#eff6ff;color:var(--color-primary)">📍 ${ma(o.location_name)}</span>`:""}
          </label>
        `).join("")}
  ...
  `}function Ja(){var a,e;(a=document.querySelector("#ideas-checklist-card .category-header"))==null||a.addEventListener("click",t=>{var i,o;t.target.tagName!=="INPUT"&&((i=document.getElementById("ideas-cl-items"))==null||i.classList.toggle("hidden"),(o=document.getElementById("ideas-cl-chev"))==null||o.classList.toggle("open"))}),(e=document.getElementById("ideas-cl-items"))==null||e.addEventListener("change",t=>{const i=t.target;if(i.type!=="checkbox")return;const o=i.dataset.ideaId;o&&T(o,{completed:i.checked})})}function Ia(){const a=U(),e=a.filter(t=>t.checked).length;return`
    <div class="category-card custom-items-card" id="custom-items-card">
      ...
      <div class="category-items" id="custom-items-list">
        ${a.length===0?'<div class="custom-items-empty">Nessuna voce personalizzata. Aggiungine una qui sotto.</div>':a.map(t=>`
              <div class="checklist-item custom-item" data-cid="${t.id}">
                ...
                <span class="checklist-item-text ${t.checked?"line-through":""}">${ma(t.text)}</span>
                ${t.category!=="Varie"?`<span class="priority-badge" style="background:#f1f5f9;color:#64748b;">${ma(t.category)}</span>`:""}
  ...
  `}function wa(){var e,t,i;const a=document.getElementById("custom-items-header");a==null||a.addEventListener("click",o=>{var n,s;o.target.closest(".custom-add-form")||o.target.closest("button")||((n=document.getElementById("custom-items-list"))==null||n.classList.toggle("hidden"),(s=document.getElementById("custom-chev"))==null||s.classList.toggle("open"))}),(e=document.getElementById("custom-items-list"))==null||e.addEventListener("change",o=>{const n=o.target;n.classList.contains("custom-item-cb")&&Zt(n.dataset.cid,n.checked)}),(t=document.getElementById("custom-items-list"))==null||t.addEventListener("click",o=>{const n=o.target.closest(".custom-item-del");if(n){Ut(n.dataset.cid);return}const s=o.target.closest(".custom-item-edit");if(s){Wt(s.dataset.cid);return}if(o.target.closest("#custom-add-btn")){Wa();return}o.target.closest("#clear-custom-btn")&&confirm("Eliminare tutte le voci personalizzate?")&&Kt()}),(i=document.getElementById("custom-item-text"))==null||i.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),Wa())})}function Wa(){var i;const a=document.getElementById("custom-item-text"),e=((i=document.getElementById("custom-item-cat"))==null?void 0:i.value)??"Varie",t=a==null?void 0:a.value.trim();if(!t){a==null||a.focus();return}Gt(t,e),a&&(a.value="")}function Wt(a){const e=U().find(d=>d.id===a);if(!e)return;const t=document.querySelector(`.custom-item[data-cid="${a}"]`);if(!t)return;const i=t.querySelector(".checklist-item-text"),o=t.querySelector(".custom-item-edit"),n=t.querySelector(".custom-item-del"),s=t.querySelector(".priority-badge");if(!i)return;const r=document.createElement("input");r.type="text",r.value=e.text,r.className="custom-edit-input";const l=document.createElement("button");l.textContent="✓",l.className="custom-item-save-edit",l.title="Salva";const c=document.createElement("button");c.textContent="✕",c.className="custom-item-cancel-edit",c.title="Annulla",i.replaceWith(r),s&&(s.style.display="none"),o&&o.replaceWith(l),n&&(n.style.display="none"),l.after(c),r.focus(),r.select();function u(){const d=r.value.trim();if(!d){r.focus();return}Ft(a,d)}function m(){const d=document.getElementById("custom-items-section");d&&(d.innerHTML=Ia(),wa())}r.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),u()),d.key==="Escape"&&m()}),l.addEventListener("click",u),c.addEventListener("click",m)}function Yt(a,e){const t=a.items.length,i=a.items.filter(o=>e[o.id]).length;return`
    <div class="category-card" data-cat="${a.id}">
      <div class="category-header">
        <span class="category-icon">${a.icon}</span>
        <span class="category-name">${a.name}</span>
        <span class="category-count" id="count-${a.id}">${i}/${t}</span>
        <div class="category-progress">
      ...
      <div class="category-items" id="items-${a.id}">
        ${a.items.map(o=>Qt(o,e[o.id]||!1)).join("")}
      </div>
    </div>
  ...
  `}function Xt(a,e){var t,i,o,n;(t=document.getElementById("checklist-categories"))==null||t.addEventListener("change",s=>{var c;const r=s.target;if(r.type!=="checkbox")return;const l=r.dataset.id;e[l]=r.checked,(c=r.closest(".checklist-item"))==null||c.classList.toggle("checked",r.checked),Sa(e),ai(a,e,l),W(a,e)}),document.querySelectorAll(".category-header").forEach(s=>{s.addEventListener("click",r=>{var c,u,m;if(r.target.tagName==="INPUT")return;const l=(c=s.closest(".category-card"))==null?void 0:c.dataset.cat;l&&((u=document.getElementById(`items-${l}`))==null||u.classList.toggle("hidden"),(m=document.getElementById(`chev-${l}`))==null||m.classList.toggle("open"))})}),(i=document.getElementById("check-all"))==null||i.addEventListener("click",()=>{a.forEach(s=>s.items.forEach(r=>{e[r.id]=!0})),Sa(e),Ea(a,e),W(a,e)}),(o=document.getElementById("uncheck-all"))==null||o.addEventListener("click",()=>{a.forEach(s=>s.items.forEach(r=>{e[r.id]=!1})),Sa(e),Ea(a,e),W(a,e)}),(n=document.getElementById("reset-btn"))==null||n.addEventListener("click",()=>{confirm("Vuoi resettare l'intera checklist?")&&(Vt(),a.forEach(s=>s.items.forEach(r=>{e[r.id]=!1})),Ea(a,e),W(a,e))})}function ai(a,e,t){const i=a.find(c=>c.items.some(u=>u.id===t));if(!i)return;const o=i.items.length,n=i.items.filter(c=>e[c.id]).length,s=o?n/o*100:0,r=document.getElementById(`count-${i.id}`),l=document.getElementById(`prog-${i.id}`);r&&(r.textContent=`${n}/${o}`),l&&(l.style.width=`${s}%`)}function W(a,e){const t=a.reduce((r,l)=>r+l.items.length,0),i=a.reduce((r,l)=>r+l.items.filter(c=>e[c.id]).length,0),o=t?i/t*100:0,n=document.getElementById("global-fill"),s=document.getElementById("global-text");n&&(n.style.width=`${o}%`),s&&(s.textContent=`${i} / ${t}`)}function Ea(a,e){a.forEach(t=>{const i=t.items.length,o=t.items.filter(l=>e[l.id]).length,n=i?o/i*100:0,s=document.getElementById(`count-${t.id}`),r=document.getElementById(`prog-${t.id}`);s&&(s.textContent=`${o}/${i}`),r&&(r.style.width=`${n}%`),t.items.forEach(l=>{const c=document.querySelector(`.checklist-item[data-id="${l.id}"]`),u=c==null?void 0:c.querySelector('input[type="checkbox"]');!c||!u||(u.checked=e[l.id]||!1,c.classList.toggle("checked",u.checked))})})}function ma(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const ei="AIzaSyALcv3GTbsSIz1M6sIVyOUImjLvn1WruVE";let L=null,ea=[],ta=[],N=[],R=[],va="all",da=null,ba=0;async function ti(){const a=++ba;va="all";const e=document.getElementById("page-content");e.innerHTML=`
    <div class="page-header">
  ...
  `,da=await I(),pi(da);try{await ni(ei)}catch{oi(da);return}ri(da,a),mi(),Ya();const t=()=>{if(!L)return;N.forEach(o=>o.setMap(null)),N=[],Ee(),Ya();const i=document.querySelector('.map-btn[data-layer="ideas"]');if(i){const o=ya().length;i.textContent=`💡 Idee${o>0?` (${o})`:""}`}};window.addEventListener("ideas:updated",t),window.__currentPageCleanup=()=>{window.removeEventListener("ideas:updated",t),ii()}}function ii(){[ta,ea,N,R].flat().forEach(a=>{try{a.setMap(null)}catch{}}),ta=[],ea=[],N=[],R=[],L=null}function oi(a){const e=document.getElementById("map-outer");if(!e)return;const t=[...new Set(a.days.map(i=>i.location))];e.innerHTML=`
  ...
  `}function ni(a){return new Promise((e,t)=>{var n;if((n=window.google)!=null&&n.maps){e();return}const i="__gmapsReady_"+Date.now();window[i]=()=>{delete window[i],e()};const o=document.createElement("script");o.src=`https://maps.googleapis.com/maps/api/js?key=${a}&callback=${i}&loading=async`,o.async=!0,o.onerror=()=>t(new Error("Impossibile caricare Google Maps")),document.head.appendChild(o)})}function ri(a,e){const t=document.getElementById("google-map");t&&(L=new google.maps.Map(t,{center:{lat:44,lng:15.5},zoom:7,mapTypeId:"roadmap",styles:[{featureType:"water",elementType:"geometry",stylers:[{color:"#a2daf5"}]},{featureType:"landscape",stylers:[{color:"#f5f5f0"}]}]}),si(a),li(a),ci(a,e),Ee(),gi(a))}function si(a){ta=[];const e=new Map;a.days.filter(t=>t.coordinates).forEach(t=>{const i=`${t.coordinates.lat},${t.coordinates.lng}`;e.has(i)||e.set(i,[]),e.get(i).push(t)}),e.forEach(t=>{const i=t[0],o=t[t.length-1],n=t.length>1?`Giorni ${i.day}–${o.day} — ${i.location}`:`Giorno ${i.day} — ${i.location}`,s=new google.maps.Marker({position:i.coordinates,map:L,title:i.location,label:{text:String(i.day),color:"#fff",fontWeight:"bold",fontSize:"11px"},icon:{path:google.maps.SymbolPath.CIRCLE,scale:16,fillColor:"#1e40af",fillOpacity:1,strokeColor:"#ffffff",strokeWeight:2},zIndex:10}),r=t.map(c=>`<div style="margin-top:5px;font-size:12px;border-top:1px solid #e2e8f0;padding-top:4px;">
        ...
        <div style="font-family:system-ui,sans-serif;max-width:240px;">
          ...
          ${r}
        </div>`});s.addListener("click",()=>l.open(L,s)),ta.push(s)})}function li(a){ea=[],a.hotels.filter(e=>e.recommended).forEach(e=>{const t=new google.maps.Marker({position:e.coordinates,map:L,title:e.name,icon:{path:google.maps.SymbolPath.BACKWARD_CLOSED_ARROW,scale:7,fillColor:"#059669",fillOpacity:1,strokeColor:"#ffffff",strokeWeight:1.5},zIndex:5}),i=new google.maps.InfoWindow({content:`
        <div style="font-family:system-ui,sans-serif;max-width:240px;">
        ...
        </div>`});t.addListener("click",()=>i.open(L,t)),ea.push(t)})}function Ee(){N=[],ya().forEach(a=>{const e=new google.maps.Marker({position:a.coordinates,map:L,title:a.text,icon:{path:google.maps.SymbolPath.CIRCLE,scale:10,fillColor:a.marker_color||"#f59e0b",fillOpacity:.9,strokeColor:"#ffffff",strokeWeight:2},zIndex:15}),t=new google.maps.InfoWindow({content:`
        ...
        </div>`});e.addListener("click",()=>t.open(L,e)),N.push(e)})}function ci(a,e){R.forEach(o=>o.setMap(null)),R=[];const t=[];if(a.days.filter(o=>o.coordinates).forEach(o=>{const n=t[t.length-1];(!n||n.lat!==o.coordinates.lat||n.lng!==o.coordinates.lng)&&t.push(o.coordinates)}),t.length<2)return;const i=new google.maps.DirectionsService;(async()=>{for(let o=0;o<t.length-1;o++){if(e!==ba||!L)return;await ui(i,t[o],t[o+1],e),await Ie(120)}})()}const Ie=a=>new Promise(e=>setTimeout(e,a));function di(a,e,t){return new Promise(i=>{a.route({origin:e,destination:t,travelMode:google.maps.TravelMode.DRIVING},(o,n)=>i({result:o,status:n}))})}async function ui(a,e,t,i,o=4){let n=300;for(let s=0;s<o;s++){const{result:r,status:l}=await di(a,e,t);if(i!==ba||!L)return;if(l==="OK"&&r){R.push(new google.maps.DirectionsRenderer({map:L,directions:r,suppressMarkers:!0,suppressInfoWindows:!0,preserveViewport:!0,polylineOptions:{strokeColor:"#2563eb",strokeOpacity:.9,strokeWeight:5}})),Aa();return}if(l!==google.maps.DirectionsStatus.OVER_QUERY_LIMIT)break;if(await Ie(n),n*=2,i!==ba||!L)return}R.push(new google.maps.Polyline({path:[e,t],map:L,geodesic:!0,strokeOpacity:0,icons:[{icon:{path:"M 0,-1 0,1",strokeColor:"#f59e0b",strokeOpacity:.9,scale:3},offset:"0",repeat:"14px"}]})),Aa()}function Aa(){const a=va==="all"||va==="route";R.forEach(e=>e.setMap(a?L:null))}function pi(a){const e=document.getElementById("route-nav");if(!e)return;const t=a.hotels.filter(i=>i.recommended);t.length&&(e.innerHTML=`
    ...
    <div class="route-nav-list">
      ${t.map((i,o)=>`
        <a class="route-nav-btn" target="_blank" rel="noopener"
           href="${j(i.name+", "+i.address)}">
          <span class="route-nav-num">${o+1}</span>
          <span class="route-nav-name">${i.name}</span>
        </a>
      `).join("")}
    </div>
  `)}function gi(a){const e=new google.maps.LatLngBounds;a.days.filter(t=>t.coordinates).forEach(t=>e.extend(t.coordinates)),a.hotels.filter(t=>t.recommended).forEach(t=>e.extend(t.coordinates)),L.fitBounds(e,60)}function mi(){var t;const a=ya().length,e=document.querySelector('.map-btn[data-layer="ideas"]');e&&a>0&&(e.textContent=`💡 Idee (${a})`),(t=document.getElementById("map-controls"))==null||t.addEventListener("click",i=>{const o=i.target.closest(".map-btn");if(!o)return;document.querySelectorAll(".map-btn").forEach(s=>s.classList.remove("active")),o.classList.add("active");const n=o.dataset.layer;va=n,ta.forEach(s=>s.setVisible(n==="all"||n==="route")),ea.forEach(s=>s.setVisible(n==="all"||n==="hotels")),N.forEach(s=>s.setVisible(n==="all"||n==="ideas")),Aa()})}function Ya(){const a=document.getElementById("map-legend");if(!a)return;const e=ya().length;a.innerHTML=`
  ...
  `}let V=null,H="tutte",sa=[],B=!1;async function vi(a){const e=document.getElementById("page-content");let t;try{t=await I()}catch(o){e.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${o.message}</p></div>`;return}sa=t.days,V=null,H="tutte",e.innerHTML=`
    <div class="page-header">
      <h1>💡 Idee Rapide</h1>
  ...
  `,za(),Ce(),Be(),$i(),a&&yi(a);const i=()=>{w(),G()};window.addEventListener("ideas:updated",i),window.__currentPageCleanup=()=>window.removeEventListener("ideas:updated",i)}function $a(a){var s,r;const e=!!a,t=sa.map(l=>`<option value="${l.date}" ${(a==null?void 0:a.day_date)===l.date?"selected":""}>
      Gg. ${l.day} — ${l.location} · ${f(l.date)}
    </option>`).join(""),i=aa.map(l=>`<option value="${l.value}" ${((a==null?void 0:a.stato)??"idea")===l.value?"selected":""}>${l.label}</option>`).join(""),o=fa.map(l=>`<option value="${l.value}" ${((a==null?void 0:a.categoria)??"varia")===l.value?"selected":""}>${l.label}</option>`).join(""),n=le.map(l=>`<option value="${l.value}" ${((a==null?void 0:a.priorita)??"media")===l.value?"selected":""}>${l.label}</option>`).join("");return`
    <form id="idea-form" class="ideas-form">
      ...
      <div class="idea-rating-row ${(a==null?void 0:a.stato)==="fatto"?"":"hidden"}" id="idea-rating-row">
        <span class="ideas-label">Com'è andata?</span>
        ${we(a==null?void 0:a.rating,"form")}
      </div>
  ...
  `}function we(a,e="static",t=""){const i=Math.min(Y,Math.max(0,Number(a)||0)),o=Array.from({length:Y},(n,s)=>{const r=s+1,l=r<=i;return e==="static"?`<span class="star ${l?"star--on":""}">${l?"★":"☆"}</span>`:`
      <button type="button" class="star-btn ${l?"star--on":""}"
        ${e==="card"?`data-action="rate" data-id="${t}"`:""}
        data-v="${r}" title="${r} su ${Y}">${l?"★":"☆"}</button>`}).join("");return`<span class="idea-stars" data-rating="${i}">${o}</span>`}function bi(a,e){a.dataset.rating=e,a.querySelectorAll(".star-btn").forEach(t=>{const i=Number(t.dataset.v)<=e;t.classList.toggle("star--on",i),t.textContent=i?"★":"☆"})}function za(){var e,t,i;const a=document.getElementById("ideas-form-wrap");a&&((e=document.getElementById("ideas-toggle-advanced"))==null||e.addEventListener("click",()=>{B=!B;const o=document.getElementById("ideas-advanced"),n=document.getElementById("ideas-toggle-advanced");o==null||o.classList.toggle("hidden",!B),n&&(n.textContent=B?"▲ Meno dettagli":"▼ Più dettagli")}),a.addEventListener("change",o=>{var n,s;if(o.target.id==="idea-day"){const r=sa.find(l=>l.date===o.target.value);r!=null&&r.coordinates&&(document.getElementById("idea-lat").value=r.coordinates.lat,document.getElementById("idea-lng").value=r.coordinates.lng,document.getElementById("idea-coords-hint").textContent=`Auto-riempito da "${r.location}"`)}o.target.id==="idea-add-map"&&((n=document.getElementById("idea-color-row"))==null||n.classList.toggle("hidden",!o.target.checked)),o.target.id==="idea-stato"&&((s=document.getElementById("idea-rating-row"))==null||s.classList.toggle("hidden",o.target.value!=="fatto"))}),a.addEventListener("click",o=>{const n=o.target.closest(".star-btn");if(!n)return;const s=n.closest(".idea-stars"),r=Number(n.dataset.v);bi(s,Number(s.dataset.rating)===r?0:r)}),(t=document.getElementById("idea-form"))==null||t.addEventListener("submit",o=>{o.preventDefault(),fi()}),(i=document.getElementById("idea-cancel-btn"))==null||i.addEventListener("click",()=>{V=null,document.getElementById("ideas-form-wrap").innerHTML=$a(null),za()}))}function fi(){var s,r,l,c,u,m,d,p,v,_,P,g,k,E,K;const a=(s=document.getElementById("idea-text"))==null?void 0:s.value.trim();if(!a){(r=document.getElementById("idea-text"))==null||r.focus();return}const e=parseFloat((l=document.getElementById("idea-lat"))==null?void 0:l.value),t=parseFloat((c=document.getElementById("idea-lng"))==null?void 0:c.value),i=!isNaN(e)&&!isNaN(t)?{lat:e,lng:t}:null,o=(u=document.getElementById("idea-add-map"))==null?void 0:u.checked,n={text:a,note:((m=document.getElementById("idea-note"))==null?void 0:m.value.trim())??"",categoria:((d=document.getElementById("idea-categoria"))==null?void 0:d.value)??"varia",stato:((p=document.getElementById("idea-stato"))==null?void 0:p.value)??"idea",rating:Number((v=document.querySelector("#idea-rating-row .idea-stars"))==null?void 0:v.dataset.rating)||0,priorita:((_=document.getElementById("idea-priorita"))==null?void 0:_.value)??"media",day_date:((P=document.getElementById("idea-day"))==null?void 0:P.value)||null,location_name:((g=document.getElementById("idea-location"))==null?void 0:g.value.trim())||null,link:((k=document.getElementById("idea-link"))==null?void 0:k.value.trim())||"",coordinates:i,add_to_checklist:((E=document.getElementById("idea-add-checklist"))==null?void 0:E.checked)??!1,add_to_map:o&&i!==null,marker_color:((K=document.querySelector('input[name="idea-color"]:checked'))==null?void 0:K.value)??"#f59e0b"};V?(T(V,n),V=null):oa(n),B=!1,document.getElementById("ideas-form-wrap").innerHTML=$a(null),za(),w(),G()}function Ae(){const a=z();return[{key:"tutte",label:`Tutte (${a.length})`},{key:"idea",label:`Idea (${a.filter(t=>t.stato==="idea").length})`},{key:"da-verificare",label:`Da verificare (${a.filter(t=>t.stato==="da-verificare").length})`},{key:"prenotare",label:`Prenotare (${a.filter(t=>t.stato==="prenotare").length})`},{key:"approvata",label:`Approvate (${a.filter(t=>t.stato==="approvata").length})`},{key:"fatto",label:`✅ Fatte (${a.filter(t=>t.stato==="fatto").length})`},{key:"scartata",label:`Scartate (${a.filter(t=>t.stato==="scartata").length})`}].map(t=>`
    <button class="idea-filter-btn ${H===t.key?"active":""}" data-f="${t.key}">
      ${t.label}
    </button>
  `).join("")}function Be(){var a;(a=document.getElementById("ideas-filters-row"))==null||a.querySelectorAll(".idea-filter-btn").forEach(e=>{e.addEventListener("click",()=>{H=e.dataset.f,G(),w()})})}function G(){const a=document.getElementById("ideas-filters-row");a&&(a.innerHTML=Ae(),Be())}function qe(){let a=z();return H!=="tutte"&&(a=a.filter(e=>e.stato===H)),a.length===0?`<div class="ideas-empty">${H==="tutte"?"Nessuna idea salvata. Aggiungine una qui sopra.":"Nessuna idea per questo filtro."}</div>`:a.map(hi).join("")}function hi(a){const e=aa.find(n=>n.value===a.stato),t=fa.find(n=>n.value===a.categoria),i=le.find(n=>n.value===a.priorita),o=a.day_date?sa.find(n=>n.date===a.day_date):null;return`
    <div class="idea-card ${a.stato==="scartata"?"idea-card--scartata":""} ${a.stato==="fatto"?"idea-card--fatta":""}" data-id="${a.id}">
      <div class="idea-card-main">
        <div class="idea-card-header-row">
          <span class="idea-card-text">${q(a.text)}</span>
          <div class="idea-card-badges-inline">
            ...
            ${i?`<span class="idea-pri-dot" title="${i.label}" style="background:${zi(a.priorita)}"></span>`:""}
          </div>
        </div>

        <!-- Cose fatte: si votano da qui, senza aprire la modifica -->
        ${a.stato==="fatto"?we(a.rating,"card",a.id):""}

        ${a.note?`<div class="idea-card-note">${q(a.note)}</div>`:""}

        <div class="idea-card-meta">
          ${o?`<a href="#itinerary/${o.date}" class="idea-meta-chip idea-meta-link" title="Vai al giorno nell'itinerario">📅 Gg. ${o.day} — ${o.location}</a>`:""}
          ${a.location_name?`<span class="idea-meta-chip">📍 ${q(a.location_name)}</span>`:""}
          ...
          ${a.link?`<a href="${q(a.link)}" target="_blank" rel="noopener" class="idea-meta-chip idea-meta-link">🔗 Link</a>`:""}
        </div>
      </div>
      ...
      <div class="idea-card-actions">
        ...
        <select class="idea-stato-select" data-action="stato" data-id="${a.id}" title="Cambia stato">
          ${aa.map(n=>`<option value="${n.value}" ${a.stato===n.value?"selected":""}>${n.label}</option>`).join("")}
        </select>
  ...
  `}function yi(a){const e=document.querySelector(`.idea-card[data-id="${a}"]`);e&&(e.classList.add("idea-card--evidenza"),setTimeout(()=>e.classList.remove("idea-card--evidenza"),2e3),e.scrollIntoView({behavior:"smooth",block:"center"}))}function ki(a){var o,n,s;const e=z().find(r=>r.id===a);if(!e)return;(o=document.getElementById("day-link-modal"))==null||o.remove();const t=sa.map(r=>`<option value="${r.date}" ${e.day_date===r.date?"selected":""}>
  ...
  `,document.body.appendChild(i),(n=document.getElementById("day-link-confirm"))==null||n.addEventListener("click",()=>{var l;const r=((l=document.getElementById("day-link-select"))==null?void 0:l.value)||null;T(a,{day_date:r}),i.remove(),w()}),(s=document.getElementById("day-link-cancel"))==null||s.addEventListener("click",()=>i.remove()),i.addEventListener("click",r=>{r.target===i&&i.remove()})}function Ce(){const a=document.getElementById("ideas-list");a&&(a.addEventListener("change",e=>{e.target.dataset.action==="stato"&&(T(e.target.dataset.id,{stato:e.target.value}),w(),G())}),a.addEventListener("click",e=>{var n;const t=e.target.closest("[data-action]");if(!t)return;const i=t.dataset.id,o=t.dataset.action;if(o==="delete"){if(!confirm("Eliminare questa idea?"))return;ce(i),w(),G()}if(o==="edit"){V=i;const s=z().find(r=>r.id===i);if(!s)return;B=!0,document.getElementById("ideas-form-wrap").innerHTML=$a(s),za(),(n=document.getElementById("ideas-form-wrap"))==null||n.scrollIntoView({behavior:"smooth",block:"start"})}if(o==="checklist"){const s=z().find(r=>r.id===i);if(!s)return;T(i,{add_to_checklist:!s.add_to_checklist}),w()}if(o==="day-link"&&ki(i),o==="rate"){const s=z().find(l=>l.id===i);if(!s)return;const r=Number(t.dataset.v);T(i,{rating:s.rating===r?0:r}),w()}}))}function w(){const a=document.getElementById("ideas-list");a&&(a.innerHTML=qe(),Ce())}function $i(){var a,e;(a=document.getElementById("export-btn"))==null||a.addEventListener("click",()=>{const t=Xe(),i=new Blob([t],{type:"application/json"}),o=URL.createObjectURL(i),n=document.createElement("a");n.href=o,n.download=`idee_viaggio_${new Date().toISOString().slice(0,10)}.json`,n.click(),URL.revokeObjectURL(o)}),(e=document.getElementById("import-file"))==null||e.addEventListener("change",async t=>{var o;const i=(o=t.target.files)==null?void 0:o[0];if(i){try{const n=await i.text(),s=at(n);alert(`Importazione completata: ${s} nuove idee aggiunte.`),w(),G()}catch(n){alert("Errore importazione: "+n.message)}t.target.value=""}})}function zi(a){return a==="alta"?"#ef4444":a==="media"?"#f59e0b":"#22c55e"}function q(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ba(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const qa="day-picker-modal",Qa="__nessuno__";function xe({nome:a,giorni:e=[],giaScelti:t=[],consentiNessuno:i=!1,onConferma:o}){var u,m,d;(u=document.getElementById(qa))==null||u.remove();const n=new Set(t);if(!e.filter(p=>!n.has(p.date)).length&&!i){_i(a);return}const r=[i?`<option value="${Qa}">Senza giorno — tienila solo tra le Idee</option>`:"",...e.map(p=>{const v=n.has(p.date),_=p.location?` · ${Ba(p.location)}`:"";return`<option value="${p.date}" ${v?"disabled":""}>
        Gg. ${p.day} — ${f(p.date)}${_}${v?" (già aggiunta)":""}
      </option>`})].join(""),l=document.createElement("div");l.id=qa,l.className="day-link-modal-overlay",l.innerHTML=`
    <div class="day-link-modal">
      <div class="day-link-modal-title">📌 Aggiungi al giorno</div>
      <p style="font-size:0.85rem;color:var(--color-text-muted);margin-bottom:0.75rem;">
        “${Ba(a)}” comparirà nelle attività suggerite del giorno scelto.
      </p>
      <select id="day-picker-select" class="ideas-select">${r}</select>
      <div style="display:flex;gap:0.5rem;margin-top:1rem;">
  ...
  `,document.body.appendChild(l);const c=()=>l.remove();(m=document.getElementById("day-picker-cancel"))==null||m.addEventListener("click",c),l.addEventListener("click",p=>{p.target===l&&c()}),(d=document.getElementById("day-picker-confirm"))==null||d.addEventListener("click",()=>{var v;const p=(v=document.getElementById("day-picker-select"))==null?void 0:v.value;p&&(c(),o==null||o(p===Qa?null:p))})}function _i(a){var i;const e=document.createElement("div");e.id=qa,e.className="day-link-modal-overlay",e.innerHTML=`
    <div class="day-link-modal">
  ...
  `,document.body.appendChild(e);const t=()=>e.remove();(i=document.getElementById("day-picker-cancel"))==null||i.addEventListener("click",t),e.addEventListener("click",o=>{o.target===e&&t()})}let ia=[];const M=[{id:"zlatni-rat",nome:"Zlatni Rat",area:"Brač",tipo:"natura",categoria:"spiaggia",categoriaLabel:"🏖️ Spiaggia",descrizione:"La spiaggia più fotografata della Croazia: un lungo promontorio di ciottoli bianchi che cambia forma con le correnti, circondato da acque turchesi e pinete. A ~40 min da Postira.",bambini:!0,bambini_nota:"Ottimo — acque basse, spiaggia servita, pini per l'ombra",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:43.256,lng:16.6372}},{id:"vidova-gora",nome:"Vidova Gora",area:"Brač",tipo:"natura",categoria:"panorama",categoriaLabel:"⛰️ Panorama",descrizione:"Il punto più alto di tutte le isole dalmate (778 m). Vista a 360° su Zlatni Rat, Hvar e il mare aperto. Si raggiunge in auto su strada asfaltata, ~45 min da Postira.",bambini:!0,bambini_nota:"In auto facilissimo; il sentiero a piedi è impegnativo",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:43.3621,lng:16.6588}},{id:"lovrecina-bay",nome:"Baia di Lovrečina",area:"Brač",tipo:"natura",categoria:"spiaggia",categoriaLabel:"🏖️ Spiaggia sabbiosa",descrizione:"Una delle pochissime spiagge davvero sabbiose di Brač, con acqua turchese e bassa e i resti di una chiesa medievale tra gli ulivi alle spalle dell'arenile. Il parcheggio limitato la tiene meno affollata di altre. A ~10 min d'auto da Postira (4 km).",bambini:!0,bambini_nota:"La migliore della zona per il piccolo di 2 anni: fondo sabbioso e acqua che degrada dolcemente, senza scarpette. Poca ombra: portare ombrellone e arrivare presto per il parcheggio.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:43.3693,lng:16.666}},{id:"supetar-spiaggia",nome:"Spiaggia di Supetar (Banj)",area:"Brač",tipo:"natura",categoria:"spiaggia",categoriaLabel:"🏖️ Spiaggia attrezzata",descrizione:"Lunga spiaggia di ghiaia su una baia poco profonda, a 5 min a piedi dal centro di Supetar. Pensata per le famiglie: scivolo d'acqua, parco acquatico gonfiabile e bar con terrazza sul mare. A ~15 min d'auto da Postira.",bambini:!0,bambini_nota:"Acqua bassa per lunghi tratti, ideale per il bimbo di 2 anni; scivolo e gonfiabili tengono occupati gli 8 e 6 anni. Molti lettini a noleggio, ma resta spazio per il telo.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:43.3866,lng:16.5469}},{id:"skrip-museo-brac",nome:"Škrip e il Museo dell'isola di Brač",area:"Brač",tipo:"cultura",categoria:"borgo",categoriaLabel:"🏘️ Borgo antico",descrizione:"Il più antico insediamento dell'isola, di origine illirica: case in pietra con tetti in lastre, un castello cinquecentesco in rovina e vista sulla terraferma. Il museo, in una casa-torre fortificata, conserva un rilievo romano di Ercole, attrezzi agricoli e all'esterno mura dell'età del ferro. A ~10 min d'auto da Postira.",bambini:!0,bambini_nota:"Visita breve: il castello in rovina e la statua di Ercole piacciono ai più grandi, il museo si gira in mezz'ora. Vicoli sconnessi: meglio marsupio o zaino che passeggino.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:43.3557,lng:16.612}},{id:"pucisca",nome:"Pučišća",area:"Brač",tipo:"cultura",categoria:"borgo",categoriaLabel:"🏘️ Borgo di pietra",descrizione:"Cittadina di cavatori in fondo a un'insenatura a Y, con due torri medievali e una scuola di scalpellini ancora attiva: la pietra bianca di Brač si estrae qui. Il porto è pulito abbastanza da farci il bagno, e a 20 min a piedi verso nord-ovest ci sono scogli attrezzabili. A ~20 min d'auto da Postira.",bambini:!0,bambini_nota:"Lungomare pianeggiante adatto anche al passeggino; il bagno in porto e gli scalpellini al lavoro incuriosiscono i bambini. Spiagge rocciose: servono scarpette da scoglio.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:43.3479,lng:16.7321}},{id:"bol-monastero-domenicano",nome:"Bol — Monastero domenicano e baie del centro",area:"Brač",tipo:"cultura",categoria:"museo",categoriaLabel:"⛪ Monastero e baie",descrizione:"Su un promontorio a est del centro di Bol: chiesa del XII secolo, chiostro e museo con una Madonna col Bambino attribuita al Tintoretto. Ai lati del monastero si aprono baie di ghiaia più tranquille dello Zlatni Rat, con ristorante e gelati. A ~35 min d'auto da Postira.",bambini:!0,bambini_nota:"Baie con acqua bassa, buone per tutti e tre, ma il fondale ha massi scivolosi: scarpette obbligatorie. Poca ombra fino a metà pomeriggio. Il museo interessa solo i più grandi, 20 minuti.",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:43.2607,lng:16.6667}},{id:"povlja",nome:"Povlja",area:"Brač",tipo:"natura",categoria:"borgo",categoriaLabel:"⚓ Porticciolo panoramico",descrizione:"Uno dei paesi-baia più belli del nord dell'isola: poche case attorno a un porticciolo, con la strada in discesa che regala una gran vista su porto, mare e monti della costa. A est del porto un promontorio roccioso con spiaggia di ciottoloni dall'aspetto lunare. A ~40 min d'auto da Postira.",bambini:!1,bambini_nota:"Il porticciolo va bene per tutti, ma la spiaggia del promontorio è di ciottoloni grossi e taglienti, senza ombra: scomoda col bimbo di 2 anni. Da valutare solo restando sul lungomare.",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:43.3338,lng:16.836}},{id:"milna",nome:"Milna",area:"Brač",tipo:"cultura",categoria:"borgo",categoriaLabel:"⛵ Porto da cartolina",descrizione:"Principale centro della costa occidentale, raccolto attorno a una baia profonda. Il borgo vecchio sale dal mare con vicoli stretti e case in pietra attorno alla parrocchiale settecentesca e alla loggia ottocentesca. A ~40 min d'auto da Postira, attraversando l'isola.",bambini:!0,bambini_nota:"Meta rilassata da fine giornata: lungomare piatto con caffè e barche da guardare, adatto al passeggino. Il borgo vecchio è in salita e non ha attrazioni pensate per i bambini.",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:43.3266,lng:16.4497}},{id:"eremo-blaca",nome:"Eremo di Blaca (Pustinja Blaca)",area:"Brač",tipo:"cultura",categoria:"museo",categoriaLabel:"🏔️ Eremo nella gola",descrizione:"Fondato nel 1588 da monaci in fuga dai turchi e abitato fino agli anni Trenta, incastonato in una gola sul fianco occidentale della Vidova Gora: il colpo d'occhio è il motivo per andarci. Dentro, celle spartane e le collezioni dell'ultimo eremita, l'astronomo Niko Miličević. Da Postira ~30 min d'auto al bivio, poi sterrato e 40 min di sentiero a piedi (in discesa all'andata).",bambini:!1,bambini_nota:"Sconsigliato con questa comitiva: sentiero sassoso ed esposto al sole, impraticabile col passeggino e faticoso in risalita anche per il bimbo di 6 anni. Fattibile solo col piccolo nello zaino, molta acqua e scarpe chiuse.",impegno:"giornata-piena",nota_tipo:"solo-se-c-e-tempo",coords:{lat:43.2931,lng:16.5294}},{id:"supetar-cimitero-petrinovic",nome:"Cimitero di Supetar e mausoleo Petrinović",area:"Brač",tipo:"cultura",categoria:"parco",categoriaLabel:"🗿 Parco di sculture",descrizione:"Su una penisola di cipressi appena oltre la spiaggia di Supetar: più parco di sculture che camposanto, con le tombe firmate da Ivan Rendić. Il pezzo forte è il mausoleo Petrinović di Toma Rosandić, cupola neobizantina con angelo inginocchiato. A ~15 min d'auto da Postira, si abbina alla spiaggia.",bambini:!1,bambini_nota:"Non è una meta per bambini, ma è all'ombra dei cipressi e si visita in 15-20 minuti: l'angelo del mausoleo colpisce anche i più grandi. Da incastrare mentre si è già a Supetar.",impegno:"sosta-breve",nota_tipo:"solo-se-c-e-tempo",coords:{lat:43.3878,lng:16.5474}},{id:"big-blue-bol",nome:"Windsurf, kayak e SUP a Bol",area:"Brač",tipo:"natura",categoria:"attivita",categoriaLabel:"🏄 Sport acquatici",descrizione:"Grazie ai venti costanti del canale di Hvar, Bol è uno dei due poli del windsurf croato: lungo la passeggiata che porta a Zlatni Rat si allineano i centri che noleggiano attrezzatura e danno lezioni. Il più completo ha tavole, kayak, stand-up paddle, beach volley e noleggio bici. A ~35-40 min d'auto da Postira.",bambini:!0,bambini_nota:"Kayak e SUP sono gestibili coi genitori a bordo per il 6 e l'8 anni; il windsurf ha senso solo per il maggiore. Col piccolo di 2 meglio restare su beach volley e spiaggia: prevedere che un adulto stia a terra.",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:43.26,lng:16.642}},{id:"cinema-estivo-supetar",nome:"Cinema all'aperto di Supetar (Ljetno Kino)",area:"Brač",tipo:"cultura",categoria:"attivita",categoriaLabel:"🎬 Cinema all'aperto",descrizione:"Dietro il lungomare di Supetar funziona ogni sera un cinema all'aperto con proiezioni alle 21.30, tra film d'autore, titoli hollywoodiani e animazione. Aperto da inizio luglio a fine agosto, quindi attivo durante il soggiorno (~15 min d'auto). Ce n'è un gemello a Bol, affacciato sul porto.",bambini:!0,bambini_nota:"Conviene solo nelle sere con un film d'animazione in cartellone: verificare il programma in giornata. Alle 21.30 si finisce tardi — realistico per l'8 e il 6 anni, difficile per il piccolo. Portare una felpa.",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:43.3834,lng:16.5537}},{id:"diving-supetar",nome:"Immersioni a Supetar",area:"Brač",tipo:"natura",categoria:"attivita",categoriaLabel:"🤿 Diving",descrizione:"Le acque trasparenti attorno a Supetar si prestano bene alle immersioni. Il diving club locale noleggia attrezzatura, organizza corsi per principianti e porta i subacquei formati verso punti come l'Orecchio del Drago (Zmajevo uho), una grotta sottomarina. Aperto da maggio a settembre, a ~15 min da Postira.",bambini:!1,bambini_nota:"Non è un'attività per i bambini: i limiti di età li escludono tutti e tre, e la grotta è riservata a subacquei esperti. Semmai è un ritaglio di mezza giornata per un adulto, mentre l'altro sta in spiaggia coi bimbi.",impegno:"mezza-giornata",nota_tipo:"solo-se-c-e-tempo",coords:{lat:43.3868,lng:16.5452}},{id:"zara-centro",nome:"Zara — Centro Storico e Organo del Mare",area:"Area di Zara",tipo:"cultura",categoria:"citta",categoriaLabel:"🏛️ Città storica",descrizione:"La penisola antica di Zara: Foro Romano, Cattedrale di Sant'Anastasia, San Donato e i due gioielli sul lungomare — l'Organo del Mare (Morske Orgulje) e il Saluto al Sole. A ~20 min da Petrčane.",bambini:!0,bambini_nota:"Piace ai bambini — l'organo suona con le onde e il Saluto al Sole si illumina al tramonto",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:44.117,lng:15.22}},{id:"nin",nome:"Nin (Nona)",area:"Area di Zara",tipo:"cultura",categoria:"citta",categoriaLabel:"⛪ Borgo storico",descrizione:"Piccola città-isola con la chiesa più piccola del mondo (Santa Croce), saline storiche e una laguna con spiagge sabbiose e fanghi curativi. A ~20 min da Petrčane.",bambini:!0,bambini_nota:"Adatto — spiaggia sabbiosa bassa (rara in Croazia) e visita del borgo breve",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:44.2431,lng:15.184}},{id:"vransko-lake",nome:"Vransko Lake",area:"Area di Zara",tipo:"natura",categoria:"lago",categoriaLabel:"🦢 Lago / Ornitologia",descrizione:"Il lago più grande della Croazia, riserva ornitologica con oltre 250 specie di uccelli. Pista ciclabile panoramica e ambiente tranquillo. A ~40 min da Petrčane.",bambini:!0,bambini_nota:"Adatto — pista ciclabile e percorsi piani ideali con i bambini",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:43.8856,lng:15.5475}},{id:"paklenica",nome:"Paklenica National Park",area:"Area di Zara",tipo:"natura",categoria:"parco",categoriaLabel:"🏔️ Canyon / Trekking",descrizione:"Canyon spettacolari ai piedi delle Alpi Dinare, con sentieri per tutti i livelli e la grotta Manita Peć. Ingresso di Starigrad a ~45 min da Petrčane.",bambini:!1,bambini_nota:"Sentieri brevi facili esistono, ma le gole principali sono impegnative con bambini piccoli",impegno:"giornata-piena",nota_tipo:"solo-se-c-e-tempo",coords:{lat:44.3219,lng:15.4722}},{id:"museo-illusioni-zara",nome:"Museo delle Illusioni (Muzej iluzija), Zara",area:"Area di Zara",tipo:"cultura",categoria:"museo",categoriaLabel:"🎭 Museo interattivo",descrizione:"Ologrammi, illusioni ottiche e stanze truccate (pavimenti inclinati, arredi fuori scala) nel centro di Zara, con un negozio pieno di rompicapo. È un museo che si tocca e si prova, non che si guarda soltanto. A ~20 min d'auto da Petrčane.",bambini:!0,bambini_nota:"Il posto più adatto ai bambini in tutta Zara: l'8 e il 6 anni si divertono con le stanze deformate, il piccolo di 2 gira in braccio senza problemi. Breve e al chiuso: ottimo rifugio nelle ore calde.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:44.1141,lng:15.2297}},{id:"parco-naturale-telascica",nome:"Parco naturale di Telašćica (Dugi Otok)",area:"Area di Zara",tipo:"natura",categoria:"parco",categoriaLabel:"🏞️ Parco naturale",descrizione:"Baia lunga ~7 km sull'Isola Lunga, chiusa da colline dolci e da falesie a picco sul mare aperto, con il lago salato Jezero Mir, più caldo e salato del mare. È la meraviglia naturale più celebrata dell'arcipelago di Zara: ci si arriva in giornata con i battelli-escursione da Zara, o in catamarano fino a Sali (~1 h) più 3 km.",bambini:!0,bambini_nota:"Dal parcheggio alla baia ~20 min a piedi, fattibili per il 6 anni; per il 2 anni serve zaino. Il lago salato è tiepido e poco profondo, perfetto per i bambini. C'è un bar-ristorante.",impegno:"giornata-piena",nota_tipo:"molto-consigliato",coords:{lat:43.8867,lng:15.1657}},{id:"spiaggia-borik-puntamika",nome:"Spiaggia di Borik / Puntamika, Zara",area:"Area di Zara",tipo:"natura",categoria:"spiaggia",categoriaLabel:"🏖️ Spiaggia",descrizione:"Il quartiere balneare di Zara, 4 km a nord-ovest del centro: lunga spiaggia di ghiaia, pinete, hotel e marina. Sulla punta di Puntamika un bar con grande terrazza affacciata sulle isole e sul tramonto. È la spiaggia attrezzata più vicina alla base: ~15 min d'auto da Petrčane.",bambini:!0,bambini_nota:"Dietro il bar sulla punta ci sono parco giochi e chiosco di gelati: combinazione ideale con tre bambini. Fondale di ghiaia, meglio le scarpette; c'è ombra tra i pini per il piccolo.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:44.1338,lng:15.21}},{id:"spiaggia-saharun-dugi-otok",nome:"Spiaggia di Sakarun, Dugi Otok",area:"Area di Zara",tipo:"natura",categoria:"spiaggia",categoriaLabel:"🏖️ Spiaggia",descrizione:"Mezzo chilometro di ciottoli finissimi con bordo sabbioso e fondale basso, alla fine di una strada nella pineta verso la punta nord di Dugi Otok. La guida la dà come una delle spiagge più belle di questo tratto d'Adriatico. Si raggiunge in giornata via mare da Zara (catamarano per Božava ~1h15) o con un'escursione in barca.",bambini:!0,bambini_nota:"Acqua bassissima e fondo sabbioso: la spiaggia da sguazzare ideale per il 2 anni, e i più grandi nuotano in sicurezza. Ultimo tratto a piedi nel bosco (~500 m). Pizzeria e griglia sul retro, ma care per cinque.",impegno:"giornata-piena",nota_tipo:"opzionale",coords:{lat:44.1336,lng:14.8714}},{id:"mercato-zara",nome:"Mercato di Zara (Pijaca)",area:"Area di Zara",tipo:"cultura",categoria:"attivita",categoriaLabel:"🍑 Mercato",descrizione:"Uno dei mercati quotidiani più vivaci dell'Adriatico, in una lunga piazza addossata alle mura di Zara: frutta e verdura dalla campagna, pesce fresco nella sala accanto, chioschi di pane, formaggi e salumi. Solo la mattina; ottimo per riempire la borsa frigo prima della spiaggia. A ~20 min da Petrčane.",bambini:!0,bambini_nota:"Sosta breve e colorata: frutta da assaggiare subito e banchi del pesce che divertono i più grandi. Col passeggino si passa, ma la mattina è affollato: meglio presto.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:44.1157,lng:15.228}},{id:"barkajol-zara",nome:"Barkajol — il traghetto a remi di Zara",area:"Area di Zara",tipo:"cultura",categoria:"attivita",categoriaLabel:"🚣 Traversata a remi",descrizione:"La barchetta a remi che da secoli traghetta i passeggeri tra la Liburnska obala, nel centro storico, e la riva di fronte. La guida la definisce il mezzo di trasporto pubblico più piacevole di Zara: costa pochissimo e dura pochi minuti. Da abbinare a una passeggiata in città, ~20 min d'auto dalla base.",bambini:!0,bambini_nota:"Una vera barca a remi col barcaiolo: per i bambini vale più di molti musei, e dura abbastanza poco da tenere buono anche il 2 anni. Tenerli seduti durante la traversata.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:44.1183,lng:15.2242}},{id:"campanile-santa-anastasia-zara",nome:"Campanile di Sant'Anastasia, Zara",area:"Area di Zara",tipo:"cultura",categoria:"panorama",categoriaLabel:"🔭 Panorama",descrizione:"I 183 gradini del campanile alto 54 m, completato in stile neoromanico a fine Ottocento dall'inglese T.G. Jackson, portano a una vista che abbraccia i tetti della città vecchia e le isole all'orizzonte. Sotto, la cattedrale romanica col fregio di foglie d'acanto sul portale. A ~20 min dalla base.",bambini:!0,bambini_nota:"La salita piace all'8 anni e regge anche il 6; col 2 anni serve portarlo in braccio su una scala stretta, meglio fare i turni. Niente passeggino.",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:44.116,lng:15.2248}},{id:"museo-vetro-antico-zara",nome:"Museo del Vetro Antico, Zara",area:"Area di Zara",tipo:"cultura",categoria:"museo",categoriaLabel:"🏺 Museo",descrizione:"In una villa ottocentesca fusa con un padiglione di vetro e cromo: boccette di profumo romane, oggetti d'uso e una sala di urne cinerarie in vetro trovate negli scavi in città. C'è un filmato di dieci minuti sulla soffiatura del vetro e, d'estate, dimostrazioni dal vivo. A ~20 min d'auto da Petrčane.",bambini:!0,bambini_nota:"Museo piccolo e fresco, con oggetti luccicanti che catturano i bambini per il tempo giusto; il video sulla soffiatura funziona meglio con l'8 e il 6 anni. Non fermarsi più di un'ora.",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:44.1143,lng:15.2295}},{id:"sali-dugi-otok",nome:"Sali (Dugi Otok)",area:"Area di Zara",tipo:"cultura",categoria:"borgo",categoriaLabel:"⚓ Borgo di mare",descrizione:"Il paese più grande di Dugi Otok, porto peschereccio tranquillo coi caffè attorno alla darsena. È la porta d'accesso a Telašćica (3 km) e il punto di partenza delle gite alle Kornati. Catamarano da Zara ~1 h. Nel primo fine settimana di agosto ospita le Saljske užance, con concerti e la 'musica degli asini' suonata coi corni.",bambini:!0,bambini_nota:"Porto raccolto e senza traffico, facile col passeggino sul lungomare; le barche da pesca intrattengono i bambini. Da abbinare a Telašćica per non fare la traversata solo per il paese.",impegno:"giornata-piena",nota_tipo:"opzionale",coords:{lat:43.9382,lng:15.1634}},{id:"isole-kornati",nome:"Parco nazionale delle Incoronate (Kornati)",area:"Area di Zara",tipo:"natura",categoria:"parco",categoriaLabel:"🏝️ Arcipelago",descrizione:"Novanta isole spoglie e quasi lunari, dal bianco pietra all'ocra pallido, raggruppate attorno a Kornat: pascoli bruciati secoli fa, muretti a secco, acque limpidissime e taverne nelle cale. Le agenzie di Zara offrono la gita in giornata (partenza 8-9, rientro 17-18, soste bagno, ingresso al parco e di solito pranzo inclusi).",bambini:!1,bambini_nota:"Circa dieci ore di barca con lunghi trasferimenti e poca ombra: pesante per il 2 anni e noioso a tratti anche per il 6. Solo con mare calmo e se i bambini reggono le uscite in barca; le soste bagno sono il momento buono.",impegno:"giornata-piena",nota_tipo:"solo-se-c-e-tempo",coords:{lat:43.8054,lng:15.3221}},{id:"isola-silba",nome:"Silba — l'isola senza auto",area:"Area di Zara",tipo:"natura",categoria:"borgo",categoriaLabel:"🚫🚗 Isola senza auto",descrizione:"Isola senza automobili (e con le bici bandite tra metà luglio e fine agosto) coperta di querce, con un paese di case ombreggiate da palme e giardini murati, la torre Marinić e un parco di sculture. Sul lato est la spiaggia di Šotorišće, baia ampia e poco profonda dal fondale sabbioso. Catamarano da Zara ~1h30.",bambini:!0,bambini_nota:"Zero traffico: i bambini camminano liberi, e Šotorišće ha acqua bassa e fondo di sabbia, perfetta per il 2 anni, con un bar estivo accanto. Le altre spiagge sono a 50 min a piedi, troppo coi piccoli.",impegno:"giornata-piena",nota_tipo:"solo-se-c-e-tempo",coords:{lat:44.3762,lng:14.6962}},{id:"kraljicina-plaza-nin",nome:"Kraljičina plaža e i fanghi di Nin",area:"Area di Zara",tipo:"natura",categoria:"attivita",categoriaLabel:"🏖️ Spiaggia e fanghi",descrizione:"Uno dei pochi posti in Croazia dove ha senso portare secchiello e paletta: la 'spiaggia della Regina' è di sabbia vera, lunga e poco commercializzata, con vista sul Velebit dall'altra parte dell'acqua. Nel canneto dietro la spiaggia si raccoglie il fango peloide, che i bagnanti si spalmano addosso per i dolori reumatici. A ~20 min da Petrčane.",bambini:!0,bambini_nota:"Sabbia e acqua bassa la rendono la spiaggia migliore della zona per il bimbo di 2 anni. La spalmata di fango è un gioco perfetto per gli 8 e i 6 anni: mettere in conto una doccia lunga e costumi macchiati. Poca ombra: serve ombrellone.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:44.2514,lng:15.1752}},{id:"solana-nin-saline",nome:"Saline di Nin — percorso didattico",area:"Area di Zara",tipo:"cultura",categoria:"attivita",categoriaLabel:"🧂 Visita didattica",descrizione:"Saline sfruttate da almeno duemila anni, dove acqua di mare, sole e bora producono un sale oggi considerato prodotto gourmet. C'è un piccolo museo sulla storia della produzione, un negozio, e soprattutto un percorso didattico che corre sugli argini tra le vasche di evaporazione. A ~20 min da Petrčane.",bambini:!0,bambini_nota:"Il camminamento sugli argini piace molto: vasche, cumuli di sale e uccelli, tutto piano e compatibile col passeggino. Nessuna ombra: andare presto la mattina o nel tardo pomeriggio, con cappelli e acqua. Si abbina alla spiaggia di Nin.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:44.2398,lng:15.1915}},{id:"rafting-zrmanja",nome:"Rafting nel canyon della Zrmanja",area:"Area di Zara",tipo:"natura",categoria:"attivita",categoriaLabel:"🚣 Rafting",descrizione:"La Zrmanja scorre in uno dei canyon carsici più notevoli della Croazia, con pareti che arrivano a 200 m. Le agenzie di Starigrad organizzano discese in gommone e in kayak: le uscite sul tratto superiore partono da Kaštel Žegarski e finiscono a Muškovci. A ~1 h da Petrčane: si può incastrare nel trasferimento verso Otočac.",bambini:!0,bambini_nota:"Il rafting ha quasi sempre un'età minima: realistico solo per l'8 anni, da verificare per il 6, escluso il piccolo. Chiamare prima chiedendo esplicitamente il limite d'età; in alternativa una gita in barca sul tratto basso è adatta a tutti.",impegno:"giornata-piena",nota_tipo:"opzionale",coords:{lat:44.1619,lng:15.8486}},{id:"kuterevo",nome:"Kuterevo Bear Sanctuary",area:"Velebit / Lika",tipo:"natura",categoria:"natura",categoriaLabel:"🐻 Rifugio animali",descrizione:"Rifugio per orsi bruni orfani ai piedi del Velebit, gestito da volontari. Si visitano gli orsi nei recinti naturali con una guida. Esperienza educativa e a basso impatto.",bambini:!0,bambini_nota:"Ottimo per i bambini — orsi visibili da vicino in sicurezza, percorso breve",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:44.8266,lng:15.1389}},{id:"gacka",nome:"Valle della Gacka",area:"Velebit / Lika",tipo:"natura",categoria:"fiume",categoriaLabel:"🌊 Fiume / Valle",descrizione:"Uno dei fiumi carsici più limpidi d'Europa, nella piana attorno a Otočac. Mulini storici, trote, prati verdi e paesaggi tranquilli. A ~20 min dall'alloggio di Kuterevo.",bambini:!0,bambini_nota:"Adatto — passeggiate pianeggianti lungo il fiume e i mulini",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:44.8686,lng:15.2372}},{id:"plitvice-laghi",nome:"Parco Nazionale dei Laghi di Plitvice",area:"Velebit / Lika",tipo:"natura",categoria:"parco",categoriaLabel:"🌊 Parco naturale",descrizione:"Sedici laghi turchesi collegati da cascate, incassati in colline boscose e percorsi da passerelle di legno che corrono sull'acqua. Bus navetta e battello sono compresi nel biglietto e riducono molto i tratti a piedi. A ~50 min d'auto da Otočac: dall'Ingresso 1 in dieci minuti si è al Veliki Slap, la cascata da 78 m.",bambini:!0,bambini_nota:"Pesci e rane nell'acqua limpida piacciono molto a 8 e 6 anni; il piccolo di 2 va tenuto per mano o in zaino perché le passerelle sono senza parapetto. Passeggino sconsigliato.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:44.905,lng:15.6113}},{id:"senj-nehaj",nome:"Senj e la fortezza di Nehaj",area:"Velebit / Lika",tipo:"cultura",categoria:"museo",categoriaLabel:"🏰 Fortezza",descrizione:"Cittadina di vicoli stretti sul mare, dominata dalla fortezza di Nehaj (1558), quartier generale degli Uskoki, i guerrieri-pirati che da qui assalivano le navi veneziane. Dentro, tre piani di armi e costumi; dai camminamenti si vedono Senj e l'isola di Krk. A ~40 min d'auto da Otočac.",bambini:!0,bambini_nota:"Armi, torre e storie di pirati funzionano benissimo con 8 e 6 anni. Salita breve ma in pendenza e scale interne ripide: il bimbo di 2 va portato in braccio o in zaino.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:44.9865,lng:14.9034}},{id:"rastoke-slunj",nome:"Rastoke (Slunj)",area:"Velebit / Lika",tipo:"cultura",categoria:"borgo",categoriaLabel:"🏘️ Borgo dei mulini",descrizione:"Borgo di mulini ad acqua dove lo Slunjčica precipita nella gola della Korana con una serie di cascatelle, tra case in pietra e legno collegate da ponticelli. Il punto panoramico migliore è il giardino del Pod Rastočkim Krovom, con i vecchi macchinari idraulici. A ~1 h d'auto da Otočac: ideale come sosta verso Plitvice.",bambini:!0,bambini_nota:"Giro breve e scenografico, con acqua che scorre ovunque: piace a tutti e tre. Occhio ai bordi non protetti sopra le cascate con il bimbo di 2 anni.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:45.1213,lng:15.5876}},{id:"kuca-velebita-krasno",nome:"Casa del Velebit (Kuća Velebita), Krasno",area:"Velebit / Lika",tipo:"cultura",categoria:"museo",categoriaLabel:"🦌 Museo natura",descrizione:"Centro visite del Parco Nazionale del Velebit Settentrionale, a Krasno: flora, fauna e mestieri della montagna, con un allestimento sulla vita nelle grotte e una sala attività per bambini. Nello stesso paese anche il Museo della Silvicoltura. A ~30 min d'auto da Otočac, sulla strada che sale al Velebit.",bambini:!0,bambini_nota:"La sala interattiva e la grotta ricostruita sono il punto forte per 8 e 6 anni; al coperto e senza rischi, gestibile anche col piccolo di 2.",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:44.8202,lng:15.0709}},{id:"grotte-barac",nome:"Grotte di Barać (Baračeve špilje)",area:"Velebit / Lika",tipo:"natura",categoria:"grotta",categoriaLabel:"🕯️ Grotta",descrizione:"Tre caverne in una valle boscosa presso Rakovica, poco a nord dell'Ingresso 1 di Plitvice. La visita guidata dura una quarantina di minuti su ~200 m e passa per la Sala dei Piedi di Elefante e la Sala delle Anime Perdute. A ~55 min d'auto da Otočac: ottima alternativa fresca a Plitvice.",bambini:!0,bambini_nota:"Durata contenuta e formato guidato adatti a 8 e 6 anni; dentro fa fresco (felpa anche in agosto) e ci sono scale e fondo umido, quindi il bimbo di 2 va tenuto in braccio.",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:44.9838,lng:15.7228}},{id:"zavratnica-jablanac",nome:"Cala Zavratnica e Jablanac",area:"Velebit / Lika",tipo:"natura",categoria:"spiaggia",categoriaLabel:"🏖️ Cala",descrizione:"Insenatura strettissima e a pareti verticali che si incunea nelle pendici del Velebit di fronte all'isola di Rab: un sentiero costeggia tutta la cala e in fondo c'è una piccola spiaggia. Si arriva con 15 min a piedi dal porticciolo di Jablanac. A ~1 h d'auto da Otočac verso la costa.",bambini:!0,bambini_nota:"Bagno in acqua calma e riparata alla fine del sentiero; i 15 min a piedi sono facili ma col bimbo di 2 conviene lo zaino. Serve ombra: è roccioso e senza pini sulla spiaggia.",impegno:"mezza-giornata",nota_tipo:"solo-se-c-e-tempo",coords:{lat:44.6994,lng:14.8968}},{id:"rovinj-centro",nome:"Rovigno — Centro Storico e Sant'Eufemia",area:"Istria",tipo:"cultura",categoria:"citta",categoriaLabel:"⛪ Città storica",descrizione:"Il borgo veneziano arroccato sul mare: viuzze acciottolate, la Grisia degli artisti e la chiesa di Sant'Eufemia con il campanile panoramico. Alla base della tappa.",bambini:!0,bambini_nota:"Bello a piedi — gelaterie sul porto e vista dall'alto del campanile",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:45.0832,lng:13.631}},{id:"lim-fjord",nome:"Lim Fjord (Limski Kanal)",area:"Istria",tipo:"natura",categoria:"natura",categoriaLabel:"🌲 Fiordo / Paesaggio",descrizione:"Canale marino di 10 km incastrato tra boschi e vigneti istriani, famoso per le ostriche. Belvedere accessibile in auto, gita in barca dal basso. A ~20 min da Rovigno.",bambini:!0,bambini_nota:"Il belvedere è accessibile a tutti; la barca è ottima per i bambini",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:45.1419,lng:13.6408}},{id:"brijuni",nome:"Brijuni National Park",area:"Istria",tipo:"natura",categoria:"parco",categoriaLabel:"🦒 Parco / Safari",descrizione:"Arcipelago con safari park (zebre, elefanti), resti romani e spiagge. Accesso in traghetto da Fažana (~30 min da Rovigno + ~15 min di traghetto).",bambini:!0,bambini_nota:"Fantastico per i bambini — safari su trenino, animali esotici, mare pulito",impegno:"giornata-piena",nota_tipo:"molto-consigliato",coords:{lat:44.9167,lng:13.7636}},{id:"aquarium-rovinj",nome:"Acquario di Rovigno",area:"Istria",tipo:"natura",categoria:"natura",categoriaLabel:"🐟 Acquario",descrizione:"Piccolo acquario storico (1891) nel centro di Rovigno. Vasche con pesci, granchi e specie dell'Adriatico. Sosta breve e riparata, perfetta nelle ore calde.",bambini:!0,bambini_nota:"Ottimo con i bambini — visita breve al chiuso, animali marini da vicino",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:45.0855,lng:13.6395}},{id:"dinopark-funtana",nome:"Dinopark Funtana",area:"Istria",tipo:"natura",categoria:"parco",categoriaLabel:"🦕 Parco a tema",descrizione:"Parco a tema sui dinosauri a Funtana, a ~20 min da Rovigno. Dinosauri a grandezza naturale nel bosco, mini-golf, area giochi e trenino.",bambini:!0,bambini_nota:"Pensato per i bambini — percorsi facili e dinosauri a grandezza naturale",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:45.1695,lng:13.6076}},{id:"istralandia",nome:"Aquapark Istralandia",area:"Istria",tipo:"natura",categoria:"parco",categoriaLabel:"🏊 Parco acquatico",descrizione:"Grande parco acquatico a Brtonigla (~45 min da Rovigno): scivoli per tutte le età, piscine, zona baby e aree relax.",bambini:!0,bambini_nota:"Molto adatto — zona baby dedicata e scivoli graduati per età",impegno:"giornata-piena",nota_tipo:"opzionale",coords:{lat:45.3466,lng:13.616}},{id:"pula-arena",nome:"Pola — Arena Romana",area:"Istria",tipo:"cultura",categoria:"citta",categoriaLabel:"🏛️ Sito romano",descrizione:"Uno degli anfiteatri romani meglio conservati al mondo, con i corridoi sotterranei visitabili. Centro di Pola tutto intorno. A ~50 min da Rovigno.",bambini:!0,bambini_nota:"Piace ai bambini — si entra nell'arena e nei sotterranei come i gladiatori",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:44.8732,lng:13.8501}},{id:"porec",nome:"Parenzo — Basilica Eufrasiana",area:"Istria",tipo:"cultura",categoria:"citta",categoriaLabel:"⛪ Sito UNESCO",descrizione:"Basilica Eufrasiana (VI sec.), patrimonio UNESCO con mosaici bizantini dorati, nel cuore di Parenzo. A ~40 min da Rovigno.",bambini:!0,bambini_nota:"Visita breve; il centro pedonale e il lungomare sono comodi con i bambini",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:45.2285,lng:13.5936}},{id:"zlatni-rt-punta-corrente",nome:"Parco forestale Zlatni Rt (Punta Corrente)",area:"Istria",tipo:"natura",categoria:"parco",categoriaLabel:"🌲 Parco costiero",descrizione:"Grande pineta costiera piantata dalla famiglia Hütterott a inizio Novecento, percorsa da sentieri per camminate e bici e affacciata sulle calette ghiaiose di Lone Bay. È il classico pomeriggio rovignese all'ombra, con vista sul centro storico: ~20 min a piedi dal porto o 5 min d'auto dalla base.",bambini:!0,bambini_nota:"Sentieri pianeggianti e ombreggiati, perfetti col passeggino per il piccolo di 2 anni; le insenature ghiaiose sono comode per il bagno dei più grandi, ma servono scarpette da scoglio.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:45.0676,lng:13.632}},{id:"crveni-otok-isola-rossa",nome:"Isola Rossa (Crveni otok) e Santa Caterina",area:"Istria",tipo:"natura",categoria:"spiaggia",categoriaLabel:"🏝️ Isole e bagni",descrizione:"Le due isolette davanti a Rovigno: Santa Caterina, la più vicina, e Sveti Andrija, collegata da un istmo al Crveni otok. Rive ombreggiate da pini e acqua molto pulita — secondo la guida il meglio che offra la costa intorno a Rovigno per fare il bagno. Traghetti dal porto ogni 30–45 min, traversata di pochi minuti.",bambini:!0,bambini_nota:"Il tragitto in barchetta è già un'attrazione; isole piccole e chiuse al traffico, si girano in libertà. Fondali rocciosi: portare scarpette e salvagente per il piccolo.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:45.0591,lng:13.6246}},{id:"jama-baredine",nome:"Grotta di Baredine (Jama Baredine)",area:"Istria",tipo:"natura",categoria:"grotta",categoriaLabel:"🕳️ Grotta carsica",descrizione:"Sistema di cavità calcaree a Nova Vas, nell'entroterra di Parenzo, visitabile con guida in ~40 min attraverso cinque sale piene di stalattiti. Si vedono anche esemplari di proteo, il 'drago' bianco delle grotte carsiche, e si racconta la leggenda medievale dei due innamorati perdutisi nelle gallerie. A ~45 min d'auto da Rovigno.",bambini:!0,bambini_nota:"Ottimo rifugio dal caldo di agosto: dentro fa fresco, portare felpe. Ci sono scale e gradini: il bimbo di 2 anni va tenuto in braccio o in zaino, il passeggino non serve.",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:45.2703,lng:13.6618}},{id:"dvigrad",nome:"Dvigrad (Duecastelli)",area:"Istria",tipo:"cultura",categoria:"borgo",categoriaLabel:"🏰 Città fantasma",descrizione:"Città murata abbandonata nel Seicento per la peste e le incursioni dei pirati, oggi un labirinto di rovine grigie tra campi e boschi, con due torri massicce, la cerchia di merli e il guscio della basilica romanica di Santa Sofia. Si entra liberamente e si cammina tra i vicoli invasi dall'erba. A ~25 min d'auto da Rovigno.",bambini:!0,bambini_nota:"Un vero castello in rovina da esplorare: irresistibile per gli 8 e i 6 anni. Attenzione ai muri instabili e alle pietre sconnesse; col piccolo di 2 anni meglio lo zaino porta-bimbo.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:45.1273,lng:13.8118}},{id:"vrsar",nome:"Orsera (Vrsar)",area:"Istria",tipo:"cultura",categoria:"borgo",categoriaLabel:"⛪ Borgo panoramico",descrizione:"Borgo arroccato all'imbocco del Canale di Leme, un intrico di vicoli ripidi, cortili ombrosi e case di pietra: Casanova ci passò due volte e ne scrisse nelle memorie. Dal campanile di San Martino, in cima al colle, bel panorama sulla costa. A ~25 min d'auto da Rovigno.",bambini:!0,bambini_nota:"Salite e scalini rendono il passeggino scomodo; la vista dal campanile piace ai più grandi, mentre il porto turistico e i gelati salvano la sosta col piccolo.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:45.1512,lng:13.6063}},{id:"svetvincenat",nome:"Sanvincenti (Svetvinčenat)",area:"Istria",tipo:"cultura",categoria:"borgo",categoriaLabel:"🏯 Castello e piazza",descrizione:"Paesino con quella che la guida indica come la più bella piazza dell'Istria: la facciata rinascimentale dell'Assunta da un lato e il castello dei Grimani, con cortile e due torri, dall'altro. Nel castello una mostra multimediale con visori ne racconta la storia, compreso il rogo per stregoneria del 1632. A ~35 min d'auto da Rovigno.",bambini:!0,bambini_nota:"Castello vero con cortile e torri, più i visori VR: colpiscono soprattutto l'8enne. La piazza è pianeggiante e chiusa, comoda per far girare il piccolo; c'è una pizzeria davanti al castello.",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:45.0881,lng:13.8822}},{id:"cape-kamenjak",nome:"Capo Promontore (Rt Kamenjak)",area:"Istria",tipo:"natura",categoria:"spiaggia",categoriaLabel:"🦕 Riserva e calette",descrizione:"La punta più meridionale dell'Istria, riserva protetta di macchia bassa e scogliere con decine di calette appartate raggiungibili a piedi o in bici; si entra da Premantura seguendo 3 km di sterrato. Alla punta le grotte marine di Velika Kolumbarica e, vicino alla spiaggia di Pinižule, alcune impronte di dinosauro da cercare. A ~1 h d'auto da Rovigno.",bambini:!0,bambini_nota:"Le impronte di dinosauro entusiasmano i bimbi; a piedi/bici si entra gratis, in auto si paga al casello. Poca ombra e scogliere alte: scegliere una caletta riparata e andare presto. Il segnaposto punta all'ingresso di Premantura — la punta è 3,5 km più avanti su sterrato.",impegno:"giornata-piena",nota_tipo:"molto-consigliato",coords:{lat:44.7967,lng:13.9108}},{id:"vodnjan",nome:"Dignano (Vodnjan) — murales e mummie",area:"Istria",tipo:"cultura",categoria:"citta",categoriaLabel:"🎨 Murales e mummie",descrizione:"Cittadina di vicoli stretti nota per due cose molto diverse: i grandi murales contemporanei dipinti sulle facciate durante i festival di street art, e le mummie conservate nella chiesa di San Biagio, che ha il campanile più alto dell'Istria. Dietro una tenda rossa dietro l'altare, tre corpi di santi rimasti integri. A ~30 min d'auto da Rovigno.",bambini:!0,bambini_nota:"La caccia ai murales per le vie è un gioco perfetto per 8 e 6 anni. Le mummie possono impressionare: valutare se farle vedere ai più piccoli. Ingresso alla chiesa a pagamento.",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:44.9607,lng:13.8477}},{id:"pazin-castello-foiba",nome:"Pisino (Pazin) — castello e foiba",area:"Istria",tipo:"cultura",categoria:"museo",categoriaLabel:"🏰 Castello e abisso",descrizione:"Il capoluogo dell'Istria interna ha un castello altomedievale che ospita il Museo etnografico istriano, con costumi e la ricostruzione di una cucina col focolare. Il castello strapiomba sulla gola della Foiba, un abisso che ispirò Dante e che Jules Verne usò per il salto del suo Mattia Sandorf; d'estate c'è una zipline di 220 m sopra il baratro. A ~45 min d'auto da Rovigno.",bambini:!0,bambini_nota:"Castello e voragine sono spettacolari per l'8enne; la zipline ha limiti di età e peso, da verificare sul posto. Il sentiero nella gola è ripido e non fattibile col passeggino.",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:45.2402,lng:13.9304}},{id:"motovun",nome:"Montona (Motovun)",area:"Istria",tipo:"cultura",categoria:"panorama",categoriaLabel:"🌄 Borgo sul colle",descrizione:"Il più celebre dei borghi collinari istriani, un grumo di case medievali su un cocuzzolo boscoso sopra la valle del Mirna, tra grano e vigneti. Dalla piazza si accede al camminamento tra le due cinte murarie, con una vista memorabile sulla campagna. A ~50 min d'auto da Rovigno.",bambini:!0,bambini_nota:"Si parcheggia in basso e si sale a piedi ~20 min in salita: pesante col 2enne, meglio lo zaino. La guida avverte che i ristoranti di Motovun sono da gourmet e poco adatti ai bambini; alternativa la pizzeria di Karojba, 7 km a sud, con parco giochi.",impegno:"mezza-giornata",nota_tipo:"opzionale",coords:{lat:45.3367,lng:13.8283}},{id:"bale",nome:"Valle (Bale)",area:"Istria",tipo:"cultura",categoria:"borgo",categoriaLabel:"🏘️ Borgo su colle",descrizione:"Borgo su un poggio con le case disposte in cerchio difensivo, vivace e con popolazione mista croata e italiana, a differenza di tanti paesi dell'interno spopolati. Il pezzo forte è il palazzo Soardo-Bembo, gotico-veneziano del Quattrocento, accanto al quale un arco col leone di San Marco introduce al vicolo circolare del centro. A soli 20 min d'auto da Rovigno.",bambini:!1,bambini_nota:"Visita breve e tranquilla, ma poco da fare per i bambini: il giro dell'anello di vicoli dura mezz'ora e regge finché non si annoiano. Meglio abbinarla a una tappa più movimentata.",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:45.0406,lng:13.7863}},{id:"parco-sculture-dzamonja",nome:"Parco delle sculture Dušan Džamonja",area:"Istria",tipo:"cultura",categoria:"parco",categoriaLabel:"🗿 Sculture all'aperto",descrizione:"Prato-museo poco a nord di Orsera, accanto alla villa dove lo scultore Dušan Džamonja (1928–2009) passava le estati, con una grande esposizione permanente delle sue opere astratte: uova di alluminio lucido e blocchi di acciaio brunito. Ingresso libero e visita rapida, facile da abbinare a Orsera. A ~30 min d'auto da Rovigno.",bambini:!0,bambini_nota:"Prato aperto dove i bambini possono correre e girare intorno alle sculture; gratis e senza code, ma l'interesse dura poco: mezz'ora scarsa.",impegno:"sosta-breve",nota_tipo:"solo-se-c-e-tempo",coords:{lat:45.1598,lng:13.6106}},{id:"sagra-sardine-fazana",nome:"Sagra delle sardine di Fasana",area:"Istria",tipo:"cultura",categoria:"attivita",categoriaLabel:"🎉 Sagra",descrizione:"Fažana è in parte villaggio di vacanza e in parte porto peschereccio attivo, famoso per le sardine. Ad agosto si tiene la Sagra delle Sardine, con interi banchi di pesce grigliati sul lungomare. A ~35 min da Rovigno: si abbina alla giornata alle Brijuni, di cui Fažana è il porto d'imbarco. ⚠️ La guida non dà la data esatta: da confermare con l'ufficio turistico, la finestra 15-17/8 è stretta.",bambini:!0,bambini_nota:"Festa di paese sul lungomare, all'aperto e senza biglietto: si entra e si esce quando si vuole, gestibile anche col bimbo di 2 anni. Molta folla e griglie accese: tenere d'occhio il piccolo.",impegno:"sosta-breve",nota_tipo:"solo-se-c-e-tempo",coords:{lat:44.9268,lng:13.8029}},{id:"trieste-centro",nome:"Trieste — Piazza Unità d'Italia",area:"Collio e Trieste",tipo:"cultura",categoria:"citta",categoriaLabel:"🏛️ Città storica",descrizione:"La piazza affacciata sul mare più grande d'Europa, cuore della Trieste asburgica, tra caffè storici e palazzi liberty. A ~45 min dal Castello di Spessa, o come sosta lungo il viaggio dall'Istria il 17/8.",bambini:!0,bambini_nota:"Spazi ampi e pedonali; gelato e passeggiata sul molo Audace",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:45.6501,lng:13.7677}},{id:"miramare",nome:"Castello di Miramare",area:"Collio e Trieste",tipo:"cultura",categoria:"citta",categoriaLabel:"🏰 Castello / Parco",descrizione:"Il castello bianco di Massimiliano d'Asburgo a picco sul golfo, con un grande parco affacciato sul mare. Quasi sulla strada tra Rovigno e il Collio: ottima sosta per sgranchirsi il 17/8. A ~40 min dal Castello di Spessa.",bambini:!0,bambini_nota:"Ottimo — parco enorme per correre e vista mare; interni brevi",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:45.7025,lng:13.7125}},{id:"grotta-gigante",nome:"Grotta Gigante",area:"Collio e Trieste",tipo:"natura",categoria:"natura",categoriaLabel:"🕳️ Grotta",descrizione:"Enorme caverna del Carso triestino, tra le più grandi visitabili al mondo. Visita guidata con scalinata tra stalattiti e stalagmiti. A ~20 min da Trieste e ~40 min dal Castello di Spessa.",bambini:!0,bambini_nota:"Adatto ai più grandi — tante scale ma spettacolo assicurato; fresco d'estate",impegno:"sosta-breve",nota_tipo:"opzionale",coords:{lat:45.7099,lng:13.7646}},{id:"aquileia",nome:"Aquileia — Basilica e Area Romana",area:"Collio e Trieste",tipo:"cultura",categoria:"citta",categoriaLabel:"🏛️ Sito UNESCO",descrizione:"Antica città romana patrimonio UNESCO: basilica con il grande pavimento a mosaico paleocristiano, foro e scavi. A ~35 min da Capriva del Friuli.",bambini:!0,bambini_nota:"Adatto — mosaici enormi da percorrere su passerelle e aree archeologiche all'aperto",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:45.7696,lng:13.3709}},{id:"dobbiaco",nome:"Lago di Dobbiaco",area:"Sesto / Alta Pusteria",tipo:"natura",categoria:"lago",categoriaLabel:"🏔️ Lago alpino",descrizione:"Lago alpino in fondo alla Val Pusteria, a pochi km da Sesto. Raggiungibile a piedi o in bici sulla pista ciclabile. Acque verdissime, Dolomiti come sfondo.",bambini:!0,bambini_nota:"Perfetto — pista ciclabile pianeggiante, riva accessibile, area pic-nic",impegno:"sosta-breve",nota_tipo:"molto-consigliato",coords:{lat:46.7358,lng:12.2214}},{id:"braies",nome:"Lago di Braies",area:"Sesto / Alta Pusteria",tipo:"natura",categoria:"lago",categoriaLabel:"🏔️ Lago alpino",descrizione:'Il "lago delle fiabe" delle Dolomiti: acque verde-smeraldo, barche a remi e sentiero attorno al lago (3 km). Molto affollato in agosto — meglio la mattina presto. A ~45 min da Sesto.',bambini:!0,bambini_nota:"Adatto — sentiero pianeggiante attorno al lago, barche a noleggio",impegno:"mezza-giornata",nota_tipo:"molto-consigliato",coords:{lat:46.6948,lng:12.0853}}],Li={"zlatni-rat":"Il Corno d'Oro non sta mai fermo: la lingua di ghiaia a forma di dente di squalo cambia forma ogni anno, plasmata dai venti stagionali.","skrip-museo-brac":"Škrip è il posto abitato senza interruzioni più antico di Brač, fondato dagli Illiri. Fuori dal museo c'è un mausoleo romano che secondo la leggenda locale custodisce la moglie o la figlia dell'imperatore Diocleziano.",milna:"Dietro la loggia ottocentesca c'è una vecchia casa cadente chiamata Anglešćina: un mito locale la lega a un crociato inglese.","supetar-cimitero-petrinovic":"Il mausoleo più grandioso fu voluto da Francisco Petrinović, nato a Supetar e diventato magnate navale in Cile. Ironia: l'incarico non andò a Ivan Rendić, lo scultore locale che firmò quasi tutte le altre tombe.","zara-centro":"Alfred Hitchcock passò qui una vacanza nel 1964 e restò talmente colpito da definire il tramonto di Zara il più bello del mondo. Sul lungomare un cartellone lo ricorda ancora.",nin:"La chiesetta bianca della Santa Croce è la chiesa più antica di tutta la Croazia: sull'architrave un'iscrizione cita il conte Godečaj e risale all'anno 800. Nin fu la residenza dei primi re croati.",paklenica:"Risalendo la gola di Velika Paklenica, dopo una ventina di minuti si passa davanti a gallerie sotterranee: le fece scavare l'esercito jugoslavo come rifugio antiatomico per i dirigenti dello Stato.","parco-naturale-telascica":"Il lago di Jezero Mir è separato dal mare solo da una barriera di roccia: la sua acqua salatissima d'estate è di parecchi gradi più calda del mare. Sulla barriera i visitatori costruiscono torri e piramidi di sassi.","barkajol-zara":"Il mezzo pubblico più bello di Zara è una barca a remi: il barkajol traghetta la gente da una sponda all'altra ed è un servizio di linea a tutti gli effetti.","campanile-santa-anastasia-zara":"Il modello non è originale: Jackson lo ricopiò quasi identico dal campanile della cattedrale di Rab.","museo-vetro-antico-zara":"La sala più spettacolare è piena di urne cinerarie romane in vetro: sono saltate fuori scavando le fondamenta di un centro commerciale, dall'altra parte del porto.","sali-dugi-otok":"La tovareća muzika si chiama «musica dell'asino» perché i suonatori strombazzano nei corni fino a produrre un raglio collettivo perfettamente stonato.","isole-kornati":"Queste isole bianche e spoglie erano coperte di foreste: furono bruciate per fare pascolo alle pecore, che poi si mangiarono tutto il resto. I muretti a secco che le recintavano ci sono ancora, le pecore quasi più.","isola-silba":"Il nome viene probabilmente dal latino silva, bosco: l'isola è ancora coperta di querce.",kuterevo:"Il rifugio nato nel 2002 accoglie orsetti orfani o malati che non sopravvivrebbero nel bosco: una volta abituati all'uomo non possono più tornare liberi, e da un recinto-asilo passano a grandi aree sulla collina dietro.","plitvice-laghi":"I sedici laghi non sono stati scavati ma costruiti dall'acqua: il fiume trasporta travertino, calcare che si deposita a valle formando barriere. In migliaia di anni quelle dighe naturali hanno creato la scala di laghi.","senj-nehaj":"Nehaj significa 'non temere'. La fortezza fu tirata su nel 1558 dal comandante uscocco Ivan Lenković, che per avere le pietre fece demolire tutte le chiese e i conventi fuori dalle mura.","rastoke-slunj":"Le case di Rastoke hanno il piano basso in pietra e quello alto in legno, coi ponticelli sui torrenti: si vedono ancora il mulino da farina e quello che serviva a lavare i tappeti.","kuca-velebita-krasno":"Krasno vive di boschi da sempre: nel Museo della Silvicoltura si scopre che prima della guerra i boscaioli abbattevano gli alberi a mano col segone e portavano i tronchi fino al mare a dorso di cavallo.","grotte-barac":"Tra le attrazioni che la guida mostra c'è anche una montagnetta di guano di pipistrello vecchia trecento anni.","rovinj-centro":"Il centro storico era un'isola: il braccio di mare che lo separava dalla terraferma fu riempito a metà Settecento. Guardate i tetti — le case hanno tanti camini sottili perché ogni figlio sposato restava in casa dei genitori col proprio focolare.","lim-fjord":"Lim viene dal latino limes, confine: in epoca romana divideva il territorio di Pola da quello di Parenzo. Poi divenne un covo di pirati, e la leggenda dice che il capitano Morgan si fermò qui e fondò il villaggio di Mrgani.",brijuni:"Tito teneva sull'isola un pappagallo di nome Koki: è ancora lì e continua a ripetere le frasi imparate dal maresciallo. Nel safari park vivono zebre e antilopi, regali dei capi di Stato in visita.","pula-arena":"Nel Cinquecento i veneziani volevano smontare l'anfiteatro pezzo per pezzo e rimontarlo a Venezia. Li fermò il patrizio polese Gabriele Emo, ricordato da una lapide su una delle torri superstiti.",porec:"Il vescovo Eufrasio, che fece i mosaici nel 535, aveva fama di essere vanitosissimo: si fece ritrarre mentre regge il modellino della chiesa e sparse il proprio monogramma su tutta la decorazione.","jama-baredine":"Nelle vasche della grotta vivono alcuni proteo, salamandre bianche e cieche tipiche del carso croato e sloveno, che sembrano vermi pallidi con le zampe. La guida racconta anche la leggenda di Gabriel e Milka, due innamorati del Duecento che si persero qui dentro.",dvigrad:"Gli abitanti non sparirono nel nulla: se ne andarono e nel Seicento fondarono Kanfanar, il paese lì accanto.",svetvincenat:"Secondo la leggenda del paese, la vera colpa della donna bruciata come strega nel 1632 era una storia d'amore con uno dei Grimani.",vodnjan:"I corpi santi arrivarono da Venezia nel 1818: la credenza popolare lega il fatto che non si siano decomposti ai loro poteri di guaritori.",motovun:"Svuotata dopo il 1945, quando quasi tutti gli abitanti italiani partirono, Motovun fu ripopolata come colonia di artisti. Qui nel 1940 era nato il futuro campione automobilistico Mario Andretti.","pazin-castello-foiba":"Jules Verne ci fece cadere il suo Mattia Sandorf senza aver mai visto Pisino: si accontentò delle fotografie che gli spedì il sindaco."},Si={Brač:["Prima del turismo Brač viveva della sua pietra, un misto lattiginoso di marmo e calcare: è finita nel Reichstag di Berlino, nella Casa Bianca a Washington e nel Palazzo di Diocleziano a Spalato.","Brač è un'isola di pecore: la cucina tradizionale gira attorno all'agnello e al montone. Nell'entroterra si vedono enormi cumuli di pietre bianche, accumulati in secoli dai contadini che ripulivano un pezzo di terra per coltivare.","Se sentite dire fjaka, non è una parolaccia: in dialetto dalmata è l'arte di poltrire nel pomeriggio senza fare nulla, ed è considerata una cosa seria.","Ivan Rendić (1849-1932), cresciuto a Supetar, fu il primo grande scultore accademico croato: fece un busto del primo ministro britannico Gladstone e ricevette in cambio una lettera di ringraziamento intestata 10 Downing Street."],"Area di Zara":["Per secoli Zadar si chiamò Zara ed era una città di lingua italiana sotto Venezia. La sua università, fondata dai domenicani nel 1396, si dichiara la più antica della Croazia.","Nella chiesa di San Simeone la regina Elisabetta d'Ungheria volle a tal punto un pezzo del santo che ne staccò un dito e lo nascose in seno: si dice che marcì subito e si riprese solo una volta restituito. Il reliquiario d'argento fu la sua penitenza.","Il piatto da provare almeno una volta è l'ispod peke: carne cotta lentamente sotto un coperchio di metallo ricoperto di braci. Richiede ore, quindi va ordinato in anticipo.","In Dalmazia i bambini chiamano gli uomini adulti barba (zio, dal gergo italiano) e i signori rispettabili sjor, dal signore veneziano. Il resto della Croazia prende in giro i dalmati chiamandoli tovari, asini, per la loro lentezza."],"Velebit / Lika":["Gli Uscocchi di Senj erano profughi della Bosnia ottomana diventati soldati: pagati male dagli Asburgo, si diedero alla pirateria con barche a remi di 15 metri. I veneziani, esasperati, misero in giro la voce che mangiassero il cuore crudo dei nemici.","La bura è un vento gelido da nord-est incanalato tra le montagne: si dice che stia arrivando quando sul Velebit si forma una striscia di nuvola bianca. Nei giorni peggiori ribalta le auto e fa chiudere il ponte per Krk.","Il sentiero Premužić attraversa il Velebit per 57 km: lo tracciò negli anni Trenta Ante Premužić con un'ossessione — pendenze così dolci da camminare quasi in piano anche in mezzo alle rocce.","Nei boschi sopra i laghi di Plitvice vivono orsi, lupi e cinghiali; nei laghi turchesi nuotano pesci e bisce d'acqua, e sulle rive più tranquille a nord si vedono gli aironi."],Istria:["La caccia al tartufo comincia a fine settembre: cani addestrati e padroni spariscono nella nebbia istriana a fiutare il fungo. A Buzet, alla Buzetska Subotina, si festeggia friggendo in piazza una frittata al tartufo gigantesca.","La bevanda istriana da provare almeno una volta è la supa: vino rosso caldo con zucchero, olio d'oliva e pepe, servito in una brocca di terracotta con una fetta di pane tostato da inzuppare.","Il primo vampiro documentato d'Europa era istriano: Jure Grando, del villaggio di Kringa, che nel 1672 usciva ogni notte dalla tomba. La storia fu messa per iscritto dal geografo Valvasor, che andò a intervistare i compaesani.","Sotto Mussolini in Istria il croato fu bandito dalla vita pubblica e i cognomi slavi tradotti in italiano. Oggi i cartelli stradali sono bilingui e Rovigno ha ancora un liceo italiano."]},Ei={"zlatni-rat":"Zlatni rat, Bol","vidova-gora":"Vidova gora, Brač","lovrecina-bay":"Plaža Lovrečina, Postira","supetar-spiaggia":"Plaža Banj, Supetar","skrip-museo-brac":"Muzej otoka Brača, Škrip",pucisca:"Pučišća, Brač","bol-monastero-domenicano":"Dominikanski samostan Bol",povlja:"Povlja, Brač",milna:"Milna, Brač","eremo-blaca":"Pustinja Blaca, Brač","supetar-cimitero-petrinovic":"Mauzolej Petrinović, Supetar","big-blue-bol":"Big Blue Sport, Bol","cinema-estivo-supetar":"Ljetno kino Supetar","diving-supetar":"Fun Dive Club, Supetar","zara-centro":"Morske orgulje, Zadar",nin:"Nin, Hrvatska","vransko-lake":"Park prirode Vransko jezero",paklenica:"Nacionalni park Paklenica, Starigrad","museo-illusioni-zara":"Muzej iluzija Zadar","parco-naturale-telascica":"Park prirode Telašćica","spiaggia-borik-puntamika":"Plaža Borik, Zadar","spiaggia-saharun-dugi-otok":"Plaža Sakarun, Dugi otok","mercato-zara":"Gradska tržnica Zadar","barkajol-zara":"Barkajoli, Liburnska obala, Zadar","campanile-santa-anastasia-zara":"Katedrala svete Stošije, Zadar","museo-vetro-antico-zara":"Muzej antičkog stakla, Zadar","sali-dugi-otok":"Sali, Dugi otok","isole-kornati":"Nacionalni park Kornati","isola-silba":"Silba, Hrvatska","kraljicina-plaza-nin":"Kraljičina plaža, Nin","solana-nin-saline":"Solana Nin","rafting-zrmanja":"Kaštel Žegarski, Zrmanja",kuterevo:"Utočište za mlade medvjede Kuterevo",gacka:"Izvor Gacke, Otočac","plitvice-laghi":"Nacionalni park Plitvička jezera Ulaz 1","senj-nehaj":"Tvrđava Nehaj, Senj","rastoke-slunj":"Rastoke, Slunj","kuca-velebita-krasno":"Kuća Velebita, Krasno","grotte-barac":"Baraćeve špilje, Rakovica","zavratnica-jablanac":"Uvala Zavratnica, Jablanac","rovinj-centro":"Crkva svete Eufemije, Rovinj","lim-fjord":"Limski kanal",brijuni:"Nacionalni park Brijuni, Fažana","aquarium-rovinj":"Akvarij Rovinj","dinopark-funtana":"Dinopark Funtana",istralandia:"Aquapark Istralandia, Brtonigla","pula-arena":"Pulska Arena",porec:"Eufrazijeva bazilika, Poreč","zlatni-rt-punta-corrente":"Park šuma Zlatni rt, Rovinj","crveni-otok-isola-rossa":"Crveni otok, Rovinj","jama-baredine":"Jama Baredine, Nova Vas",dvigrad:"Dvigrad, Kanfanar",vrsar:"Vrsar, Istra",svetvincenat:"Kaštel Grimani, Svetvinčenat","cape-kamenjak":"Park Kamenjak, Premantura",vodnjan:"Crkva svetog Blaža, Vodnjan","pazin-castello-foiba":"Kaštel Pazin",motovun:"Motovun, Istra",bale:"Bale, Istra","parco-sculture-dzamonja":"Park skulptura Dušan Džamonja, Vrsar","sagra-sardine-fazana":"Fažana, Istra","trieste-centro":"Piazza Unità d'Italia, Trieste",miramare:"Castello di Miramare, Trieste","grotta-gigante":"Grotta Gigante, Sgonico",aquileia:"Basilica di Aquileia",dobbiaco:"Lago di Dobbiaco",braies:"Lago di Braies"},Ii={"sosta-breve":{label:"Sosta breve",icon:"⚡",cls:"impegno-breve"},"mezza-giornata":{label:"Mezza giornata",icon:"🕐",cls:"impegno-mezza"},"giornata-piena":{label:"Giornata piena",icon:"📅",cls:"impegno-piena"}},wi={"molto-consigliato":{label:"⭐ Molto consigliato",cls:"nota-top"},opzionale:{label:"✔ Opzionale",cls:"nota-ok"},"solo-se-c-e-tempo":{label:"⏱ Solo se c'è tempo",cls:"nota-ifpos"}},Ai={natura:{label:"🌿 Natura",cls:"tipo-natura"},cultura:{label:"🏛️ Cultura",cls:"tipo-cultura"}};async function Bi(){var n,s;const a=document.getElementById("page-content");try{ia=(await I()).days||[]}catch{ia=[]}const e=[...new Set(M.map(r=>r.area))];let t="tutte",i="tutti";a.innerHTML=`
    ...
    <div class="natura-filters" id="natura-tipo-filters" style="margin-bottom:0.5rem;">
      <button class="natura-filter-btn active" data-tipo="tutti">Tutti (${M.length})</button>
      <button class="natura-filter-btn" data-tipo="natura">🌿 Natura (${M.filter(r=>r.tipo==="natura").length})</button>
      <button class="natura-filter-btn" data-tipo="cultura">🏛️ Cultura (${M.filter(r=>r.tipo==="cultura").length})</button>
    </div>
    ...
    <div class="natura-filters" id="natura-filters">
      ...
      ${e.map(r=>`
        <button class="natura-filter-btn" data-area="${r}">
          ${r} (${M.filter(l=>l.area===r).length})
        </button>
      `).join("")}
    </div>

    <div id="natura-pillole-area">${Xa(t)}</div>

    <div class="natura-grid" id="natura-grid">
      ${M.map(ae).join("")}
    </div>
  `;function o(){const r=document.getElementById("natura-pillole-area");r&&(r.innerHTML=Xa(t));const l=document.getElementById("natura-grid");if(!l)return;const c=M.filter(u=>(t==="tutte"||u.area===t)&&(i==="tutti"||u.tipo===i));l.innerHTML=c.length?c.map(ae).join(""):'<p style="color:var(--color-text-muted);padding:1rem;">Nessun suggerimento per questa combinazione di filtri.</p>',ee()}(n=document.getElementById("natura-tipo-filters"))==null||n.addEventListener("click",r=>{const l=r.target.closest(".natura-filter-btn");l&&(i=l.dataset.tipo,document.querySelectorAll("#natura-tipo-filters .natura-filter-btn").forEach(c=>c.classList.remove("active")),l.classList.add("active"),o())}),(s=document.getElementById("natura-filters"))==null||s.addEventListener("click",r=>{const l=r.target.closest(".natura-filter-btn");l&&(t=l.dataset.area,document.querySelectorAll("#natura-filters .natura-filter-btn").forEach(c=>c.classList.remove("active")),l.classList.add("active"),o())}),ee()}function Xa(a){const e=Si[a];return e!=null&&e.length?`
    <div class="natura-pillole-box">
      <div class="natura-pillole-title">💡 Pillole — ${Ca(a)}</div>
      <ul class="natura-pillole-list">
        ${e.map(t=>`<li>${t}</li>`).join("")}
      </ul>
    </div>
  `:""}function ae(a){const e=Ii[a.impegno]||{label:a.impegno,icon:"🕐",cls:""},t=wi[a.nota_tipo]||{label:a.nota_tipo,cls:""},i=Ai[a.tipo]||null,o=Ei[a.id]||a.nome,n=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(o)}`,s=Li[a.id];return`
    <div class="natura-card ${t.cls}" data-id="${a.id}">
      ...
      <div class="natura-badges">
        ${i?`<span class="natura-badge ${i.cls}">${i.label}</span>`:""}
      ...
      <div class="natura-actions">
        <a href="${j(o)}" target="_blank" rel="noopener" class="btn btn-outline natura-maps-btn">
          🚗 Naviga
        </a>
  ...
  `}function ee(){document.querySelectorAll(".natura-add-idea-btn").forEach(a=>{a.addEventListener("click",()=>{const e=a.dataset.nome,t=a.dataset.area,i=parseFloat(a.dataset.lat),o=parseFloat(a.dataset.lng),n=s=>{oa({text:e,location_name:t,categoria:"escursione",stato:"da-verificare",day_date:s,add_to_map:!0,coordinates:{lat:i,lng:o},marker_color:"#10b981"}),qi(a,s)};if(!ia.length){n(null);return}xe({nome:e,giorni:ia,giaScelti:z().filter(s=>s.text===e&&s.day_date).map(s=>s.day_date),consentiNessuno:!0,onConferma:n})})})}function qi(a,e){const t=e?ia.find(i=>i.date===e):null;a.textContent=t?`✅ Aggiunta al Gg. ${t.day}`:"✅ Aggiunta alle Idee",a.disabled=!0,setTimeout(()=>{a.textContent="📌 Aggiungi a un giorno",a.disabled=!1},2200)}function Ca(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const te={high:{label:"Da non dimenticare",cls:"logi-prio-high"},medium:{label:"Importante",cls:"logi-prio-medium"},low:{label:"Promemoria",cls:"logi-prio-low"}},ua="guida-viaggio";async function Ci(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(n){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${n.message}</p></div>`;return}const t=e.logistics||[],i=e.bookings||[],o=e.days||[];a.innerHTML=`
    <div class="page-header">
    ...
    <div id="ferry-box">${Te(e.ferries)}</div>

    <div id="guide-section">${Pe(e.guide)}</div>

    ${t.length===0?'<p style="color:var(--color-text-muted);">Nessuna nota logistica.</p>':`<div class="logi-list">${t.map(Oi).join("")}</div>`}
  `,Ni(i),xi(e.guide),Di(e.ferries)}function Pe(a){const e=Z(ua),t='<input type="file" id="guide-file" accept="application/pdf,.pdf,.epub" hidden />',i=a!=null&&a.url?`
  ...
  `:"",o=e?`
    <div class="guide-card">
      <div class="guide-card-main">
        <span class="guide-name">${ke(e)} ${b(e.name)}</span>
        <span class="guide-size">${Pi(e.size)} · su questo dispositivo, anche offline</span>
      </div>
  ...
  `:`
    <p class="guide-hint">
      ${i?"Per averla anche <strong>senza rete</strong> — utile in viaggio, senza scaricare 65 MB in roaming — puoi tenerne una copia su questo dispositivo.":"Carica il PDF della guida per aprirlo dalla webapp, anche <strong>offline</strong>. Resta su questo dispositivo: non viene caricato online."}
    </p>
  ...
  `;return`
    ...
    ${t}
  `}function xi(a){const e=document.getElementById("guide-section");if(!e)return;e.addEventListener("click",o=>{var n;if(o.target.closest("#guide-add")){(n=document.getElementById("guide-file"))==null||n.click();return}if(o.target.closest("#guide-open")){je(ua);return}o.target.closest("#guide-del")&&confirm("Rimuovere la guida da questo dispositivo?")&&ga(ua)}),e.addEventListener("change",o=>{var r;const n=o.target.closest("#guide-file");if(!((r=n==null?void 0:n.files)!=null&&r.length))return;const s=n.files[0];pa(ua,s).catch(l=>{console.error("[guida]",l),alert("Impossibile salvare la guida su questo dispositivo: il file è grande e lo spazio del browser potrebbe non bastare.")}),n.value=""});const t=()=>{e.innerHTML=Pe(a)};window.addEventListener("attachments:updated",t);const i=window.__currentPageCleanup;window.__currentPageCleanup=()=>{i==null||i(),window.removeEventListener("attachments:updated",t)}}function Pi(a){if(a==null)return"";if(a===0)return"file vuoto (0 byte)";const e=a/(1024*1024);return e>=1?`${e.toFixed(1)} MB`:`${Math.round(a/1024)} kB`}function Mi(a,e){const t=a.map(i=>`<option value="${i.date}">${f(i.date)} · ${b(i.location||i.title||"")}</option>`).join("");return`
  ...
  `}function Me(a){const e=[...a.map(t=>({...t,_fixed:!0})),...ka().map(t=>({...t,_fixed:!1}))].sort((t,i)=>ie(t).localeCompare(ie(i)));return e.length===0?'<p class="booking-empty">Nessuna prenotazione ancora. Aggiungi la prima qui sotto.</p>':`<div class="booking-list">${e.map(ji).join("")}</div>`}function ji(a){const e=be(a),t=[a.date?f(a.date):"",a.time].filter(Boolean).join(" · ");return`
    <div class="booking-card" data-id="${b(a.id)}">
      <div class="booking-card-main">
        ...
        ${t?`<div class="booking-card-when">📅 ${b(t)}</div>`:""}
  ...
  `}function Ti(a){const e=Z(a),t=`<input type="file" class="booking-attach-input" data-id="${b(a)}"
    ...
    ${t}
  `}function ie(a){const e=a.date||"9999-12-31",t=String(X(a.time)).padStart(5,"0");return`${e} ${t}`}function Ni(a){var n,s;const e=document.querySelector(".booking-section");if(!e)return;const t=e.querySelector("#booking-form"),i=e.querySelector("#bookings-list");(n=e.querySelector("#booking-add-toggle"))==null||n.addEventListener("click",()=>{var r;t.classList.toggle("hidden"),t.classList.contains("hidden")||(r=t.querySelector(".booking-place"))==null||r.focus()}),(s=e.querySelector("#booking-cancel"))==null||s.addEventListener("click",()=>{t.classList.add("hidden")}),i==null||i.addEventListener("click",r=>{var d;const l=r.target.closest(".booking-card-del");if(l){confirm("Eliminare questa prenotazione?")&&ga(l.dataset.id).finally(()=>gt(l.dataset.id));return}const c=r.target.closest(".booking-attach-add, .booking-attach");if(c&&r.target.closest(".booking-attach-add")){(d=c.parentElement.querySelector(".booking-attach-input"))==null||d.click();return}const u=r.target.closest(".booking-attach-open");if(u){je(u.dataset.id);return}const m=r.target.closest(".booking-attach-del");if(m){confirm("Rimuovere questo allegato?")&&ga(m.dataset.id);return}}),i==null||i.addEventListener("change",r=>{var u;const l=r.target.closest(".booking-attach-input");if(!l||!((u=l.files)!=null&&u.length))return;const c=l.dataset.id;pa(c,l.files[0]).catch(m=>{console.error("[attachments]",m),alert("Impossibile salvare l’allegato su questo dispositivo.")}),l.value=""}),t==null||t.addEventListener("submit",r=>{var p,v;r.preventDefault();const l=t.querySelector(".booking-place").value.trim();if(!l){t.querySelector(".booking-place").focus();return}const c=t.querySelector(".booking-loc").value.trim(),u=/^https?:\/\//i.test(c),m=pt({place:l,date:t.querySelector(".booking-date").value||null,time:t.querySelector(".booking-time").value.trim(),address:u?"":c,maps_url:u?c:"",note:t.querySelector(".booking-note").value.trim()}),d=(v=(p=t.querySelector(".booking-file"))==null?void 0:p.files)==null?void 0:v[0];d&&pa(m.id,d).catch(_=>{console.error("[attachments]",_),alert("Prenotazione salvata, ma non è stato possibile allegare il file su questo dispositivo.")}),t.reset(),t.classList.add("hidden")});const o=()=>{i&&(i.innerHTML=Me(a))};window.addEventListener("bookings:updated",o),window.addEventListener("attachments:updated",o),window.__currentPageCleanup=()=>{window.removeEventListener("bookings:updated",o),window.removeEventListener("attachments:updated",o)}}const je=Ra;function Te(a){return!a||!a.length?"":`
  ...
  `}function Ri(a){const e=Z(a.id),t=`
  ...
  `,i=`<input type="file" class="ferry-file" data-id="${b(a.id)}"
  ...
  `}function Di(a){const e=document.getElementById("ferry-box");if(!e)return;e.addEventListener("click",o=>{var r;const n=o.target.closest("[data-act]");if(!n)return;const s=n.dataset.id;n.dataset.act==="add"?(r=e.querySelector(`.ferry-file[data-id="${CSS.escape(s)}"]`))==null||r.click():n.dataset.act==="open"?Ra(s):n.dataset.act==="del"&&confirm("Rimuovere il biglietto da questo dispositivo?")&&ga(s)}),e.addEventListener("change",o=>{var s;const n=o.target.closest(".ferry-file");(s=n==null?void 0:n.files)!=null&&s.length&&(pa(n.dataset.id,n.files[0]).catch(r=>{console.error("[biglietti]",r),alert("Impossibile salvare il biglietto su questo dispositivo: "+((r==null?void 0:r.message)||""))}),n.value="")});const t=()=>{e.innerHTML=Te(a)};window.addEventListener("attachments:updated",t);const i=window.__currentPageCleanup;window.__currentPageCleanup=()=>{i==null||i(),window.removeEventListener("attachments:updated",t)}}function Oi(a){const e=te[a.priority]||te.low;return`
  ...
  `}function b(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}async function Vi(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(l){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${l.message}</p></div>`;return}const{days:t,dining:i}=e,o=e.hikes||[],n=new Date().toISOString().slice(0,10),s=t.find(l=>l.date===n)||t.find(l=>l.date>n)||t[t.length-1];a.innerHTML=`
    <div class="page-header">
    ...
    <div class="attivita-list" id="attivita-list">
      ${t.map(l=>oe(l,i,o,l===s)).join("")}
    </div>
  `,ne(),ge(a.querySelector("#attivita-list"));const r=()=>{const l=new Set([...document.querySelectorAll(".attivita-card.open")].map(c=>c.dataset.date));a.querySelector("#attivita-list").innerHTML=t.map(c=>oe(c,i,o,l.has(c.date))).join(""),ne()};window.addEventListener("ideas:updated",r),window.__currentPageCleanup=()=>window.removeEventListener("ideas:updated",r)}function oe(a,e,t,i){const o=de(a,e);return`
    <div class="attivita-card ${i?"open":""}" data-date="${a.date}">
      <button type="button" class="attivita-head" aria-expanded="${i?"true":"false"}">
  ...
  `}function ne(){document.querySelectorAll(".attivita-card .attivita-head").forEach(a=>{a.addEventListener("click",()=>{const t=a.closest(".attivita-card").classList.toggle("open");a.setAttribute("aria-expanded",t?"true":"false")})})}let S=[],Oa=[],_a="tutte";const Ne=a=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`;async function Hi(){const a=document.getElementById("page-content");let e;try{e=await I()}catch(i){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${i.message}</p></div>`;return}S=e.hikes||[],Oa=e.days.filter(i=>i.location.toLowerCase().includes("sesto")),_a="tutte",a.innerHTML=`
    <div class="page-header">
  ...
  `,De(),Fi();const t=()=>He();window.addEventListener("ideas:updated",t),window.__currentPageCleanup=()=>window.removeEventListener("ideas:updated",t)}function Re(){return[{key:"tutte",label:`Tutte (${S.length})`},{key:"family",label:`👶 Adatte ai bimbi (${S.filter(e=>e.family).length})`},{key:"facili",label:`🟢 Facili (${S.filter(e=>/facile/i.test(e.difficulty)).length})`},{key:"auto",label:`🚗 In auto (${S.filter(e=>e.car).length})`},{key:"rifugi",label:`🏔️ Rifugi (${S.filter(e=>/rifugio/i.test(e.type)).length})`}].map(e=>`
    <button class="hike-filter-btn ${_a===e.key?"active":""}" data-f="${e.key}">${e.label}</button>
  `).join("")}function Gi(){switch(_a){case"family":return S.filter(a=>a.family);case"facili":return S.filter(a=>/facile/i.test(a.difficulty));case"auto":return S.filter(a=>a.car);case"rifugi":return S.filter(a=>/rifugio/i.test(a.type));default:return S}}function De(){var a;(a=document.getElementById("hike-filters"))==null||a.querySelectorAll(".hike-filter-btn").forEach(e=>{e.addEventListener("click",()=>{_a=e.dataset.f,document.getElementById("hike-filters").innerHTML=Re(),De(),He()})})}function Oe(a){return z().filter(e=>e.hike_id===a&&e.day_date).map(e=>({id:e.id,day:Oa.find(t=>t.date===e.day_date)})).filter(e=>e.day)}function Zi(a){return/impegnativ/i.test(a)?"diff-hard":/media/i.test(a)?"diff-med":"diff-easy"}function Ve(){const a=Gi();return a.length?a.map(e=>{const t=Oe(e.id);return`
      <div class="hike-card" data-id="${e.id}">
        <div class="hike-card-top">
          <h3 class="hike-name">${y(e.name)}</h3>
          <div class="hike-badges">
            <span class="hike-type">${y(e.type)}</span>
            <span class="hike-diff ${Zi(e.difficulty)}">${y(e.difficulty)}</span>
        ...
        <div class="hike-meta">
          <span>⏱️ ${y(e.duration)}</span>
          <span>📍 ${y(e.start)}</span>
        </div>
        <p class="hike-desc">${y(e.description)}</p>

        ${t.length?`
          <div class="hike-assigned">
            ${t.map(i=>`
              <span class="hike-assigned-chip" data-idea="${i.id}" title="Rimuovi dal giorno">
                ✓ Gg. ${i.day.day} · ${f(i.day.date)} <span class="hike-assigned-x">✕</span>
              </span>`).join("")}
          </div>`:""}

        <div class="hike-actions">
          <button class="btn btn-primary hike-add-btn" data-action="add" data-id="${e.id}">📌 Aggiungi a un giorno</button>
          <a class="btn btn-outline" target="_blank" rel="noopener" href="${Ne(e.name)}">🗺️ Maps</a>
        </div>
      </div>
    `}).join(""):'<div class="ideas-empty">Nessuna meta per questo filtro.</div>'}function He(){const a=document.getElementById("hike-grid");a&&(a.innerHTML=Ve())}function Fi(){const a=document.getElementById("hike-grid");a&&a.addEventListener("click",e=>{const t=e.target.closest(".hike-assigned-chip");if(t){ce(t.dataset.idea);return}const i=e.target.closest('[data-action="add"]');i&&Ui(i.dataset.id)})}function Ui(a){const e=S.find(t=>t.id===a);e&&xe({nome:e.name,giorni:Oa,giaScelti:Oe(a).map(t=>t.day.date),onConferma:t=>{oa({text:e.name,note:`${e.type} · ${e.difficulty} · ${e.duration} — ${e.description}`,categoria:"escursione",stato:"idea",day_date:t,location_name:e.start,link:Ne(e.name),coordinates:e.coordinates||null,add_to_map:!!e.coordinates,marker_color:"#10b981",hike_id:e.id})}})}const re={"#dashboard":rt,"#itinerary":Bt,"#attivita":Vi,"#passeggiate":Hi,"#hotels":Rt,"#checklist":Jt,"#map":ti,"#ideas":vi,"#natura":Bi,"#logistics":Ci};async function Ge(){typeof window.__currentPageCleanup=="function"&&(window.__currentPageCleanup(),window.__currentPageCleanup=null);const[a,e]=(window.location.hash||"#dashboard").split("/"),t=re[a]??re["#dashboard"],i=document.getElementById("page-content");i.innerHTML=`
    <div class="loading">
      <div class="loading-spinner"></div>
      <p>Caricamento…</p>
    </div>
  `;try{await t(e)}catch(o){console.error("[router]",o),i.innerHTML=`
      <div class="error-state">
        <div class="error-icon">⚠️</div>
        <h2>Errore caricamento pagina</h2>
        <p>${o.message||"Errore sconosciuto"}</p>
      </div>
    `}}Ze();window.addEventListener("hashchange",Ge);Ge();
