(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))t(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&t(s)}).observe(document,{childList:!0,subtree:!0});function i(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function t(o){if(o.ep)return;o.ep=!0;const n=i(o);fetch(o.href,n)}})();function we(){const a=document.getElementById("nav-toggle"),e=document.getElementById("nav-links");a==null||a.addEventListener("click",()=>{e==null||e.classList.toggle("open")}),e==null||e.querySelectorAll(".nav-link").forEach(t=>{t.addEventListener("click",()=>{e.classList.remove("open")})});function i(){const t=(window.location.hash||"#dashboard").split("/")[0];document.querySelectorAll(".nav-link").forEach(o=>{o.classList.toggle("active",o.getAttribute("href")===t)})}window.addEventListener("hashchange",i),i()}let X=null;async function E(){if(X)return X;const e="/viaggio-croazia/data/trip.json";let i;try{i=await fetch(e)}catch{throw new Error("Dati del viaggio non disponibili offline. Apri l’app una volta con la rete: da quel momento resta consultabile anche senza connessione.")}if(!i.ok)throw new Error(`Impossibile caricare trip.json (${i.status})`);return X=await i.json(),X}function f(a){if(!a)return"";const[,e,i]=a.split("-");return`${i}/${e}`}function Be(a){return a?new Date(a+"T00:00:00").toLocaleDateString("it-IT",{weekday:"short"}).toUpperCase():""}function qa(a){const e=new Date;e.setHours(0,0,0,0);const i=new Date(a+"T00:00:00");return Math.round((i-e)/(1e3*60*60*24))}function Ae(a){return"★".repeat(a)+"☆".repeat(5-a)}function x(a){return`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(a)}&travelmode=driving`}function Ca(a,e){return`https://www.google.com/maps/dir/?api=1&destination=${a},${e}&travelmode=driving`}const xa={mattina:8*60,mattino:8*60,colazione:8*60,pranzo:13*60,pomeriggio:15*60,aperitivo:18*60,sera:20*60,serata:20*60,cena:20*60,notte:23*60};function Z(a){const e=String(a??"").trim().toLowerCase();if(!e)return 9998;const i=e.match(/(\d{1,2})\s*[:.,h]\s*(\d{2})/)||e.match(/^(\d{1,2})(\d{2})$/)||e.match(/^(\d{1,2})$/);if(i){const t=Number(i[1]),o=i[2]!=null?Number(i[2]):0;if(t<=23&&o<=59)return t*60+o}for(const t in xa)if(e.includes(t))return xa[t];return 9998}function qe(a){return`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`}function Pa(a){const e=String(a??"").trim();return e?/^https?:\/\//i.test(e)?e:qe(e):""}const Ka="viaggio_croazia_ideas_v1",Ja=[{value:"alloggio",label:"🏨 Alloggio"},{value:"ristorante",label:"🍽️ Ristorante"},{value:"esperienza",label:"🎯 Esperienza"},{value:"spiaggia",label:"🏖️ Spiaggia"},{value:"escursione",label:"🥾 Escursione"},{value:"cantina",label:"🍷 Cantina / Cibo"},{value:"shopping",label:"🛍️ Shopping"},{value:"varia",label:"💡 Varia"}],ba=[{value:"idea",label:"Idea",color:"#6366f1"},{value:"da-verificare",label:"Da verificare",color:"#f59e0b"},{value:"prenotare",label:"Prenotare",color:"#ef4444"},{value:"approvata",label:"Approvata",color:"#10b981"},{value:"scartata",label:"Scartata",color:"#94a3b8"}],Wa=[{value:"alta",label:"🔴 Alta"},{value:"media",label:"🟡 Media"},{value:"bassa",label:"🟢 Bassa"}],Ce=[{value:"#f59e0b",label:"Giallo"},{value:"#ef4444",label:"Rosso"},{value:"#8b5cf6",label:"Viola"},{value:"#10b981",label:"Verde"},{value:"#f97316",label:"Arancio"}];function xe(){return"idea_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function $a(a){return{categoria:"varia",link:"",priorita:"media",stato:"idea",note:a.note??"",location_name:a.location_name??null,...a}}function _(){try{const a=localStorage.getItem(Ka);return a?JSON.parse(a).map($a):[]}catch{return[]}}function sa(a){try{localStorage.setItem(Ka,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("ideas:updated",{detail:{ideas:a}}))}catch(e){console.warn("[ideas] localStorage non disponibile:",e)}}function la(a){const e=_(),i=$a({id:xe(),text:"",note:"",categoria:"varia",link:"",priorita:"media",stato:"idea",created_at:new Date().toISOString(),day_date:null,location_name:null,coordinates:null,add_to_checklist:!1,add_to_map:!1,marker_color:"#f59e0b",completed:!1,...a});return e.unshift(i),sa(e),i}function U(a,e){const i=_(),t=i.findIndex(o=>o.id===a);return t===-1?null:(i[t]={...i[t],...e},sa(i),i[t])}function za(a){sa(_().filter(e=>e.id!==a))}function Pe(a){return _().filter(e=>e.day_date===a)}function Me(){return _().filter(a=>a.add_to_checklist)}function ca(){return _().filter(a=>{var e;return a.add_to_map&&((e=a.coordinates)==null?void 0:e.lat)!=null})}function je(){return JSON.stringify(_(),null,2)}function De(a){const e=JSON.parse(a);if(!Array.isArray(e))throw new Error("JSON non valido: deve essere un array");const i=_(),t=new Set(i.map(s=>s.id));let o=0;const n=[...i];return e.forEach(s=>{t.has(s.id)||(n.push($a(s)),o++)}),sa(n),o}function _a(a,e){if(!a||!e)return[];const i=e.toLowerCase();return a.filter(t=>i.includes(t.area.toLowerCase()))}function La(a){return _().filter(e=>e.day_date===a&&e.stato!=="scartata")}function Sa(a){return/sesto/i.test(a.location||"")}function Ya(a,e){var n;const i=((n=a.activities)==null?void 0:n.length)||0,t=Sa(a)?0:_a(e,a.location).length,o=La(a.date).length;return i+t+o}function h(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Te=a=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`;function Qa(a,e,i=[]){var v,k,L;const t=_a(e,a.location),o=La(a.date),n=((v=a.tips)==null?void 0:v.do)||[],s=((k=a.tips)==null?void 0:k.eat)||[],r=Sa(a),l=(L=a.activities)!=null&&L.length?`<div class="sugg-section">
       ...
       </div>`:"";let u="";if(r){const g=o.map(y=>i.find(m=>m.id===y.hike_id)).filter(y=>y&&Array.isArray(y.tips)&&y.tips.length);g.length&&(u=`<div class="sugg-section">
      ...
      </div>`)}let p="";if(r){const g=o.map(y=>i.find(m=>m.id===y.hike_id)).filter(y=>y&&y.eat);g.length&&(p=`<div class="sugg-section">
      ...
      </div>`)}else(t.length||s.length)&&(p=`<div class="sugg-section">
  ...
  `:""}async function Ge(){var y;const a=document.getElementById("page-content");let e;try{e=await E()}catch(m){a.innerHTML=Ke(m.message);return}const{meta:i,days:t,hotels:o}=e,n=qa(i.start_date),s=qa(i.end_date),r=new Date().toISOString().slice(0,10),l=t.find(m=>m.date===r),c=t.find(m=>m.date>r),u=l||c,p=[],d=new Set;for(const m of t)d.has(m.location)||(d.add(m.location),p.push({location:m.location,day:m.day,date:m.date}));const v=o.filter(m=>m.status==="confermata"),k=v.length,L=v.reduce((m,Q)=>m+Q.nights,0),g=u?Ya(u,e.dining):0;a.innerHTML=`
    ...
    <div class="dashboard-grid">
      <div class="card card-body">
        ...
        <div class="route-stops">
          ${p.map(m=>`
            <a class="route-stop route-stop--link" href="#itinerary/${m.date}"
               title="Apri il ${m.location} nell'itinerario — puoi controllarlo e modificarlo">
  ...
  `,(y=document.getElementById("suggestions-card"))==null||y.addEventListener("click",()=>{u&&Ze(u,e.dining,e.hikes)})}function Ze(a,e,i){var s,r,l;(s=document.getElementById("suggestions-modal"))==null||s.remove();const t=Qa(a,e,i),o=document.createElement("div");o.id="suggestions-modal",o.className="day-link-modal-overlay",o.innerHTML=`
  ...
  `}const Xa="viaggio_croazia_bookings_v1";function Je(){return"book_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function ae(a){return{id:a.id||Je(),date:a.date??null,time:(a.time??"").trim(),place:(a.place??"").trim(),address:(a.address??"").trim(),maps_url:(a.maps_url??"").trim(),note:(a.note??"").trim(),created_at:a.created_at||new Date().toISOString()}}function ee(a){if(a.maps_url)return Pa(a.maps_url);const e=[a.place,a.address].filter(Boolean).join(", ");return e?Pa(e):""}function da(){try{const a=localStorage.getItem(Xa);return a?JSON.parse(a).map(ae):[]}catch{return[]}}function ie(a){try{localStorage.setItem(Xa,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("bookings:updated",{detail:{bookings:a}}))}catch(e){console.warn("[bookings] localStorage non disponibile:",e)}}function We(a){const e=da(),i=ae(a);return e.unshift(i),ie(e),i}function Ye(a){ie(da().filter(e=>e.id!==a))}function Qe(a){return da().filter(e=>e.date===a).sort((e,i)=>Z(e.time)-Z(i.time))}const te="viaggio_croazia_attachments_v1",Xe="viaggio_croazia_files",A="attachments";function Ea(){try{const a=localStorage.getItem(te);return a?JSON.parse(a):{}}catch{return{}}}function R(a){return Ea()[a]||null}function oe(a){try{localStorage.setItem(te,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("attachments:updated",{detail:{meta:a}}))}catch(e){console.warn("[attachments] localStorage non disponibile:",e)}}function Ia(){return new Promise((a,e)=>{if(!("indexedDB"in window))return e(new Error("IndexedDB non disponibile"));const i=indexedDB.open(Xe,1);i.onupgradeneeded=()=>{i.result.objectStoreNames.contains(A)||i.result.createObjectStore(A)},i.onsuccess=()=>a(i.result),i.onerror=()=>e(i.error)})}function ai(a,e){return Ia().then(i=>new Promise((t,o)=>{const n=i.transaction(A,"readwrite");n.objectStore(A).put(e,a),n.oncomplete=()=>{i.close(),t()},n.onerror=()=>{i.close(),o(n.error)}}))}function ei(a){return Ia().then(e=>new Promise((i,t)=>{const n=e.transaction(A,"readonly").objectStore(A).get(a);n.onsuccess=()=>{e.close(),i(n.result||null)},n.onerror=()=>{e.close(),t(n.error)}}))}function ii(a){return Ia().then(e=>new Promise((i,t)=>{const o=e.transaction(A,"readwrite");o.objectStore(A).delete(a),o.oncomplete=()=>{e.close(),i()},o.onerror=()=>{e.close(),t(o.error)}}))}async function ia(a,e){await ai(a,e);const i=Ea();if(i[a]={name:e.name||"allegato",type:e.type||"",size:e.size||0,added_at:new Date().toISOString()},oe(i),!R(a))throw new Error("Metadati non salvati: spazio del browser esaurito o localStorage non disponibile.");return i[a]}async function ti(a){const e=await ei(a);return e?URL.createObjectURL(e):null}async function ta(a){try{await ii(a)}catch{}const e=Ea();delete e[a],oe(e)}async function wa(a){const e=R(a),t=/^(image\/|application\/pdf)/.test((e==null?void 0:e.type)||"")?window.open("","_blank"):null;t&&(t.opener=null);try{const o=await ti(a);if(!o){t==null||t.close(),alert("File non trovato su questo dispositivo.");return}t?t.location=o:oi(o,e==null?void 0:e.name),setTimeout(()=>URL.revokeObjectURL(o),6e4)}catch(o){console.error("[attachments]",o),t==null||t.close(),alert("Impossibile aprire il file.")}}function oi(a,e){const i=document.createElement("a");i.href=a,i.download=e||"allegato",document.body.appendChild(i),i.click(),i.remove()}function ne(a){if(!a)return"📎";const e=(a.type||"").toLowerCase(),i=(a.name||"").toLowerCase();return e.startsWith("image/")||/\.(png|jpe?g|gif|webp|heic)$/.test(i)?"🖼️":e==="application/pdf"||i.endsWith(".pdf")?"📄":e==="message/rfc822"||i.endsWith(".eml")?"✉️":"📎"}const re="viaggio_croazia_program_v1";function ni(){return"act_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function q(){try{const a=localStorage.getItem(re);return a?JSON.parse(a):{}}catch{return{}}}function N(a){try{localStorage.setItem(re,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("program:updated",{detail:{data:a}}))}catch(e){console.warn("[program] localStorage non disponibile:",e)}}function J(a,e){a[e]||(a[e]={edits:{},hidden:{},added:[]});const i=a[e];return i.edits=i.edits||{},i.hidden=i.hidden||{},i.added=i.added||[],i}function ri(a,e=[]){const i=q()[a]||{},t=i.edits||{},o=i.hidden||{},n=i.added||[],s=[];return e.forEach((r,l)=>{if(o[l])return;const c=t[l]||{};s.push({key:"base:"+l,base:!0,index:l,time:c.time??r.time??"",text:c.text??r.text??"",maps:r.maps??null})}),n.forEach(r=>{s.push({key:"add:"+r.id,base:!1,id:r.id,time:r.time||"",text:r.text||"",maps:r.maps||null})}),s.sort((r,l)=>Z(r.time)-Z(l.time)),s}function si(a){const e=q()[a];return e?!!(e.added&&e.added.length||e.hidden&&Object.keys(e.hidden).length||e.edits&&Object.keys(e.edits).length):!1}function li(a,e,i){const t=q(),o=J(t,a);o.edits[e]={...o.edits[e]||{},...i},N(t)}function ci(a,e){const i=q(),t=J(i,a);t.hidden[e]=!0,delete t.edits[e],N(i)}function di(a,{time:e="",text:i="",maps:t=""}={}){const o=q(),n=J(o,a),s={id:ni(),time:e.trim(),text:i.trim(),maps:(t||"").trim()};return n.added.push(s),N(o),s}function ui(a,e,i){const t=q(),o=J(t,a),n=o.added.findIndex(s=>s.id===e);n!==-1&&(o.added[n]={...o.added[n],...i},N(t))}function pi(a,e){const i=q(),t=J(i,a);t.added=t.added.filter(o=>o.id!==e),N(i)}function gi(a){const e=q();e[a]&&(delete e[a],N(e))}const G=new Set;let se={};async function mi(a){var u,p;const e=document.getElementById("page-content");let i;try{i=await E()}catch(d){e.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${d.message}</p></div>`;return}const{days:t,hotels:o,meta:n}=i,s=i.ferries||[],r=Object.fromEntries(o.map(d=>[d.id,d]));se=Object.fromEntries(t.map(d=>[d.date,d])),e.innerHTML=`
    ...
    <div class="timeline">
      ${t.map(d=>fi(d,r,s)).join("")}
    </div>
  `,document.querySelectorAll(".timeline-card-header").forEach(d=>{d.addEventListener("click",()=>{const v=d.nextElementSibling,k=d.querySelector(".timeline-toggle");v==null||v.classList.toggle("hidden"),k==null||k.classList.toggle("open")})}),(u=document.getElementById("expand-all"))==null||u.addEventListener("click",()=>{document.querySelectorAll(".timeline-card-body").forEach(d=>d.classList.remove("hidden")),document.querySelectorAll(".timeline-toggle").forEach(d=>d.classList.add("open"))}),(p=document.getElementById("collapse-all"))==null||p.addEventListener("click",()=>{document.querySelectorAll(".timeline-card-body").forEach(d=>d.classList.add("hidden")),document.querySelectorAll(".timeline-toggle").forEach(d=>d.classList.remove("open"))}),a&&vi(a),$i(t),zi();const l=()=>{document.querySelectorAll(".day-ideas-section").forEach(d=>{const v=d.dataset.date;v&&(d.innerHTML=le(v))})},c=()=>{document.querySelectorAll(".activities[data-date]").forEach(d=>{j(d.dataset.date)})};window.addEventListener("ideas:updated",l),window.addEventListener("bookings:updated",c),window.__currentPageCleanup=()=>{window.removeEventListener("ideas:updated",l),window.removeEventListener("bookings:updated",c)}}function vi(a){var t,o;const e=document.querySelector(`.timeline-item[data-date="${a}"]`);if(!e)return;(t=e.querySelector(".timeline-card-body"))==null||t.classList.remove("hidden"),(o=e.querySelector(".timeline-toggle"))==null||o.classList.add("open");const i=e.querySelector(".timeline-card");i==null||i.classList.add("timeline-card--evidenza"),setTimeout(()=>i==null?void 0:i.classList.remove("timeline-card--evidenza"),2e3),e.scrollIntoView({behavior:"smooth",block:"start"})}function bi(a){const e=`🎫 Traghetto ${$(a.from)} → ${$(a.to)} · 🕐 ${$(a.time)}`;return R(a.id)?`
  ...
  `}function fi(a,e,i=[]){const t=a.hotel_ref?e[a.hotel_ref]:null,o=i.filter(c=>c.day===a.day||c.date===a.date),n=new Date().toISOString().slice(0,10),s=a.date===n,r=a.date<n,l=a.coordinates?JSON.stringify(a.coordinates):"null";return`
  ...
  `}function hi(a){if(!a)return"";const e=a.do||[],i=a.eat||[];return!e.length&&!i.length?"":`
    <div class="day-tips">
  ...
  `}function yi(a){const e=a.base?`data-index="${a.index}"`:`data-id="${$(a.id)}"`;return`
  ...
  `}function ki(a){const e=Qe(a);return e.length?e.map(i=>{const t=ee(i);return`
    ...
    `}).join(""):""}function j(a){const e=document.querySelector(`.activities[data-date="${a}"]`),i=se[a];e&&i&&(e.innerHTML=ce(i,G.has(a)))}function $i(a){const e=document.querySelector(".timeline");e&&(e.addEventListener("click",i=>{var r,l;const t=i.target.closest(".day-add-idea-btn");if(t){const c=t.dataset.date,u=document.getElementById(`quick-form-${c}`);if(!u)return;const p=u.classList.contains("hidden");document.querySelectorAll(".day-quick-form").forEach(d=>d.classList.add("hidden")),p&&(u.classList.remove("hidden"),(r=u.querySelector(".quick-idea-text"))==null||r.focus())}const o=i.target.closest(".quick-cancel");o&&((l=o.closest(".day-quick-form"))==null||l.classList.add("hidden"));const n=i.target.closest(".day-idea-del");if(n){const c=n.dataset.id;confirm("Eliminare questa idea?")&&za(c)}const s=i.target.closest("[data-ferry]");s&&wa(s.dataset.ferry)}),e.addEventListener("submit",i=>{var c,u,p,d;const t=i.target.closest(".day-quick-form");if(!t)return;i.preventDefault();const o=(c=t.querySelector(".quick-idea-text"))==null?void 0:c.value.trim();if(!o){(u=t.querySelector(".quick-idea-text"))==null||u.focus();return}const n=t.dataset.date,s=a.find(v=>v.date===n),r=(p=t.querySelector(".quick-map"))==null?void 0:p.checked,l=(d=t.querySelector(".quick-checklist"))==null?void 0:d.checked;la({text:o,day_date:n,location_name:(s==null?void 0:s.location)??null,coordinates:r&&(s!=null&&s.coordinates)?s.coordinates:null,add_to_checklist:!!l,add_to_map:!!(r&&(s!=null&&s.coordinates))}),t.querySelector(".quick-idea-text").value="",t.querySelector(".quick-map").checked=!1,t.querySelector(".quick-checklist").checked=!1,t.classList.add("hidden")}))}function zi(){const a=document.querySelector(".timeline");a&&(a.addEventListener("click",e=>{var r,l,c,u,p;const i=e.target.closest(".program-edit-toggle");if(i){G.add(i.dataset.date),j(i.dataset.date);return}const t=e.target.closest(".program-edit-done");if(t){G.delete(t.dataset.date),j(t.dataset.date);return}const o=e.target.closest(".program-reset");if(o){const d=o.dataset.date;confirm("Ripristinare il programma di questo giorno come nell’itinerario originale? Le modifiche fatte a questo giorno andranno perse.")&&(gi(d),G.delete(d),j(d));return}const n=e.target.closest(".prog-del");if(n){const d=n.closest(".program-edit-row"),v=(r=n.closest(".activities"))==null?void 0:r.dataset.date;if(!d||!v)return;d.dataset.base==="true"?ci(v,Number(d.dataset.index)):pi(v,d.dataset.id),j(v);return}const s=e.target.closest(".prog-add-btn");if(s){const d=s.dataset.date,v=s.closest(".program-add-row"),k=((l=v.querySelector(".prog-add-time"))==null?void 0:l.value.trim())||"",L=((c=v.querySelector(".prog-add-text"))==null?void 0:c.value.trim())||"";if(!L){(u=v.querySelector(".prog-add-text"))==null||u.focus();return}di(d,{time:k,text:L}),j(d),(p=document.querySelector(`.activities[data-date="${d}"] .prog-add-text`))==null||p.focus();return}}),a.addEventListener("keydown",e=>{var i,t;e.key==="Enter"&&e.target.classList.contains("prog-add-text")&&(e.preventDefault(),(t=(i=e.target.closest(".program-add-row"))==null?void 0:i.querySelector(".prog-add-btn"))==null||t.click())}),a.addEventListener("change",e=>{var l,c,u;const i=e.target,t=(l=i.classList)==null?void 0:l.contains("prog-time"),o=(c=i.classList)==null?void 0:c.contains("prog-text");if(!t&&!o)return;const n=i.closest(".program-edit-row"),s=(u=i.closest(".activities"))==null?void 0:u.dataset.date;if(!n||!s)return;const r={[t?"time":"text"]:i.value.trim()};n.dataset.base==="true"?li(s,Number(n.dataset.index),r):ui(s,n.dataset.id,r)}))}function $(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}async function _i(){const a=document.getElementById("page-content");let e;try{e=await E()}catch(r){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${r.message}</p></div>`;return}const{hotels:i}=e,t={},o=[];for(const r of i){const l=r.location_group||r.location;t[l]||(t[l]=[],o.push(l)),t[l].push(r)}const n=i.filter(r=>r.status==="confermata"),s=n.reduce((r,l)=>r+l.nights,0);a.innerHTML=`
    <div class="page-header">
      <h1>🏨 Hotel &amp; Alloggi</h1>
  ...
  `}const Ba="viaggio_croazia_checklist_v1",de="viaggio_croazia_custom_items_v1";function Si(){try{const a=localStorage.getItem(Ba);return a?JSON.parse(a):{}}catch{return{}}}function ma(a){try{localStorage.setItem(Ba,JSON.stringify(a))}catch(e){console.warn("[storage] Impossibile salvare checklist:",e)}}function Ei(){try{localStorage.removeItem(Ba)}catch{}}function Ii(){return"ci_"+Date.now().toString(36)+"_"+Math.random().toString(36).slice(2,5)}function V(){try{const a=localStorage.getItem(de);return a?JSON.parse(a):[]}catch{return[]}}function W(a){try{localStorage.setItem(de,JSON.stringify(a)),window.dispatchEvent(new CustomEvent("customitems:updated"))}catch(e){console.warn("[storage] Impossibile salvare custom items:",e)}}function wi(a,e="Varie"){const i=V(),t={id:Ii(),text:a.trim(),category:e,checked:!1,created_at:new Date().toISOString()};return i.unshift(t),W(i),t}function Bi(a,e){W(V().map(i=>i.id===a?{...i,checked:e}:i))}function Ai(a,e){const i=e.trim();i&&W(V().map(t=>t.id===a?{...t,text:i}:t))}function qi(a){W(V().filter(e=>e.id!==a))}function Ci(){W([])}async function xi(){const a=document.getElementById("page-content");let e;try{e=await E()}catch(s){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${s.message}</p></div>`;return}const{categories:i}=e.checklist,t=Si();a.innerHTML=`
    <div class="page-header">
  ...
  `,H(i,t),Di(i,t),Da(),ha();const o=()=>{const s=document.getElementById("checklist-ideas-section");s&&(s.innerHTML=ja(),Da())},n=()=>{const s=document.getElementById("custom-items-section");s&&(s.innerHTML=fa(),ha())};window.addEventListener("ideas:updated",o),window.addEventListener("customitems:updated",n),window.__currentPageCleanup=()=>{window.removeEventListener("ideas:updated",o),window.removeEventListener("customitems:updated",n)}}function ja(){const a=Me();if(a.length===0)return"";const e=a.filter(o=>o.completed).length,i=a.length,t=i?e/i*100:0;return`
  ...
  `}function ha(){var e,i,t;const a=document.getElementById("custom-items-header");a==null||a.addEventListener("click",o=>{var n,s;o.target.closest(".custom-add-form")||o.target.closest("button")||((n=document.getElementById("custom-items-list"))==null||n.classList.toggle("hidden"),(s=document.getElementById("custom-chev"))==null||s.classList.toggle("open"))}),(e=document.getElementById("custom-items-list"))==null||e.addEventListener("change",o=>{const n=o.target;n.classList.contains("custom-item-cb")&&Bi(n.dataset.cid,n.checked)}),(i=document.getElementById("custom-items-list"))==null||i.addEventListener("click",o=>{const n=o.target.closest(".custom-item-del");if(n){qi(n.dataset.cid);return}const s=o.target.closest(".custom-item-edit");if(s){Pi(s.dataset.cid);return}if(o.target.closest("#custom-add-btn")){Ta();return}o.target.closest("#clear-custom-btn")&&confirm("Eliminare tutte le voci personalizzate?")&&Ci()}),(t=document.getElementById("custom-item-text"))==null||t.addEventListener("keydown",o=>{o.key==="Enter"&&(o.preventDefault(),Ta())})}function Ta(){var t;const a=document.getElementById("custom-item-text"),e=((t=document.getElementById("custom-item-cat"))==null?void 0:t.value)??"Varie",i=a==null?void 0:a.value.trim();if(!i){a==null||a.focus();return}wi(i,e),a&&(a.value="")}function Pi(a){const e=V().find(d=>d.id===a);if(!e)return;const i=document.querySelector(`.custom-item[data-cid="${a}"]`);if(!i)return;const t=i.querySelector(".checklist-item-text"),o=i.querySelector(".custom-item-edit"),n=i.querySelector(".custom-item-del"),s=i.querySelector(".priority-badge");if(!t)return;const r=document.createElement("input");r.type="text",r.value=e.text,r.className="custom-edit-input";const l=document.createElement("button");l.textContent="✓",l.className="custom-item-save-edit",l.title="Salva";const c=document.createElement("button");c.textContent="✕",c.className="custom-item-cancel-edit",c.title="Annulla",t.replaceWith(r),s&&(s.style.display="none"),o&&o.replaceWith(l),n&&(n.style.display="none"),l.after(c),r.focus(),r.select();function u(){const d=r.value.trim();if(!d){r.focus();return}Ai(a,d)}function p(){const d=document.getElementById("custom-items-section");d&&(d.innerHTML=fa(),ha())}r.addEventListener("keydown",d=>{d.key==="Enter"&&(d.preventDefault(),u()),d.key==="Escape"&&p()}),l.addEventListener("click",u),c.addEventListener("click",p)}function Mi(a,e){const i=a.items.length,t=a.items.filter(o=>e[o.id]).length;return`
  ...
  `}function Di(a,e){var i,t,o,n;(i=document.getElementById("checklist-categories"))==null||i.addEventListener("change",s=>{var c;const r=s.target;if(r.type!=="checkbox")return;const l=r.dataset.id;e[l]=r.checked,(c=r.closest(".checklist-item"))==null||c.classList.toggle("checked",r.checked),ma(e),Ti(a,e,l),H(a,e)}),document.querySelectorAll(".category-header").forEach(s=>{s.addEventListener("click",r=>{var c,u,p;if(r.target.tagName==="INPUT")return;const l=(c=s.closest(".category-card"))==null?void 0:c.dataset.cat;l&&((u=document.getElementById(`items-${l}`))==null||u.classList.toggle("hidden"),(p=document.getElementById(`chev-${l}`))==null||p.classList.toggle("open"))})}),(t=document.getElementById("check-all"))==null||t.addEventListener("click",()=>{a.forEach(s=>s.items.forEach(r=>{e[r.id]=!0})),ma(e),va(a,e),H(a,e)}),(o=document.getElementById("uncheck-all"))==null||o.addEventListener("click",()=>{a.forEach(s=>s.items.forEach(r=>{e[r.id]=!1})),ma(e),va(a,e),H(a,e)}),(n=document.getElementById("reset-btn"))==null||n.addEventListener("click",()=>{confirm("Vuoi resettare l'intera checklist?")&&(Ei(),a.forEach(s=>s.items.forEach(r=>{e[r.id]=!1})),va(a,e),H(a,e))})}function Ti(a,e,i){const t=a.find(c=>c.items.some(u=>u.id===i));if(!t)return;const o=t.items.length,n=t.items.filter(c=>e[c.id]).length,s=o?n/o*100:0,r=document.getElementById(`count-${t.id}`),l=document.getElementById(`prog-${t.id}`);r&&(r.textContent=`${n}/${o}`),l&&(l.style.width=`${s}%`)}function H(a,e){const i=a.reduce((r,l)=>r+l.items.length,0),t=a.reduce((r,l)=>r+l.items.filter(c=>e[c.id]).length,0),o=i?t/i*100:0,n=document.getElementById("global-fill"),s=document.getElementById("global-text");n&&(n.style.width=`${o}%`),s&&(s.textContent=`${t} / ${i}`)}function va(a,e){a.forEach(i=>{const t=i.items.length,o=i.items.filter(l=>e[l.id]).length,n=t?o/t*100:0,s=document.getElementById(`count-${i.id}`),r=document.getElementById(`prog-${i.id}`);s&&(s.textContent=`${o}/${t}`),r&&(r.style.width=`${n}%`),i.items.forEach(l=>{const c=document.querySelector(`.checklist-item[data-id="${l.id}"]`),u=c==null?void 0:c.querySelector('input[type="checkbox"]');!c||!u||(u.checked=e[l.id]||!1,c.classList.toggle("checked",u.checked))})})}function oa(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Oi="AIzaSyALcv3GTbsSIz1M6sIVyOUImjLvn1WruVE";let z=null,F=[],K=[],P=[],M=[],na="all",aa=null,ra=0;async function Ri(){const a=++ra;na="all";const e=document.getElementById("page-content");e.innerHTML=`
    <div class="page-header">
  ...
  `,aa=await E(),Wi(aa);try{await Hi(Oi)}catch{Vi(aa);return}Gi(aa,a),Qi(),Oa();const i=()=>{if(!z)return;P.forEach(o=>o.setMap(null)),P=[],ue(),Oa();const t=document.querySelector('.map-btn[data-layer="ideas"]');if(t){const o=ca().length;t.textContent=`💡 Idee${o>0?` (${o})`:""}`}};window.addEventListener("ideas:updated",i),window.__currentPageCleanup=()=>{window.removeEventListener("ideas:updated",i),Ni()}}function Ni(){[K,F,P,M].flat().forEach(a=>{try{a.setMap(null)}catch{}}),K=[],F=[],P=[],M=[],z=null}function Vi(a){const e=document.getElementById("map-outer");if(!e)return;const i=[...new Set(a.days.map(t=>t.location))];e.innerHTML=`
  ...
  `}function Hi(a){return new Promise((e,i)=>{var n;if((n=window.google)!=null&&n.maps){e();return}const t="__gmapsReady_"+Date.now();window[t]=()=>{delete window[t],e()};const o=document.createElement("script");o.src=`https://maps.googleapis.com/maps/api/js?key=${a}&callback=${t}&loading=async`,o.async=!0,o.onerror=()=>i(new Error("Impossibile caricare Google Maps")),document.head.appendChild(o)})}function Gi(a,e){const i=document.getElementById("google-map");i&&(z=new google.maps.Map(i,{center:{lat:44,lng:15.5},zoom:7,mapTypeId:"roadmap",styles:[{featureType:"water",elementType:"geometry",stylers:[{color:"#a2daf5"}]},{featureType:"landscape",stylers:[{color:"#f5f5f0"}]}]}),Zi(a),Ui(a),Fi(a,e),ue(),Yi(a))}function Zi(a){K=[];const e=new Map;a.days.filter(i=>i.coordinates).forEach(i=>{const t=`${i.coordinates.lat},${i.coordinates.lng}`;e.has(t)||e.set(t,[]),e.get(t).push(i)}),e.forEach(i=>{const t=i[0],o=i[i.length-1],n=i.length>1?`Giorni ${t.day}–${o.day} — ${t.location}`:`Giorno ${t.day} — ${t.location}`,s=new google.maps.Marker({position:t.coordinates,map:z,title:t.location,label:{text:String(t.day),color:"#fff",fontWeight:"bold",fontSize:"11px"},icon:{path:google.maps.SymbolPath.CIRCLE,scale:16,fillColor:"#1e40af",fillOpacity:1,strokeColor:"#ffffff",strokeWeight:2},zIndex:10}),r=i.map(c=>`<div style="margin-top:5px;font-size:12px;border-top:1px solid #e2e8f0;padding-top:4px;">
        ...
        <div style="font-family:system-ui,sans-serif;max-width:240px;">
          ...
          ${r}
        </div>`});s.addListener("click",()=>l.open(z,s)),K.push(s)})}function Ui(a){F=[],a.hotels.filter(e=>e.recommended).forEach(e=>{const i=new google.maps.Marker({position:e.coordinates,map:z,title:e.name,icon:{path:google.maps.SymbolPath.BACKWARD_CLOSED_ARROW,scale:7,fillColor:"#059669",fillOpacity:1,strokeColor:"#ffffff",strokeWeight:1.5},zIndex:5}),t=new google.maps.InfoWindow({content:`
        <div style="font-family:system-ui,sans-serif;max-width:240px;">
        ...
        </div>`});e.addListener("click",()=>i.open(z,e)),P.push(e)})}function Fi(a,e){M.forEach(o=>o.setMap(null)),M=[];const i=[];if(a.days.filter(o=>o.coordinates).forEach(o=>{const n=i[i.length-1];(!n||n.lat!==o.coordinates.lat||n.lng!==o.coordinates.lng)&&i.push(o.coordinates)}),i.length<2)return;const t=new google.maps.DirectionsService;(async()=>{for(let o=0;o<i.length-1;o++){if(e!==ra||!z)return;await Ji(t,i[o],i[o+1],e),await pe(120)}})()}const pe=a=>new Promise(e=>setTimeout(e,a));function Ki(a,e,i){return new Promise(t=>{a.route({origin:e,destination:i,travelMode:google.maps.TravelMode.DRIVING},(o,n)=>t({result:o,status:n}))})}async function Ji(a,e,i,t,o=4){let n=300;for(let s=0;s<o;s++){const{result:r,status:l}=await Ki(a,e,i);if(t!==ra||!z)return;if(l==="OK"&&r){M.push(new google.maps.DirectionsRenderer({map:z,directions:r,suppressMarkers:!0,suppressInfoWindows:!0,preserveViewport:!0,polylineOptions:{strokeColor:"#2563eb",strokeOpacity:.9,strokeWeight:5}})),ya();return}if(l!==google.maps.DirectionsStatus.OVER_QUERY_LIMIT)break;if(await pe(n),n*=2,t!==ra||!z)return}M.push(new google.maps.Polyline({path:[e,i],map:z,geodesic:!0,strokeOpacity:0,icons:[{icon:{path:"M 0,-1 0,1",strokeColor:"#f59e0b",strokeOpacity:.9,scale:3},offset:"0",repeat:"14px"}]})),ya()}function ya(){const a=na==="all"||na==="route";M.forEach(e=>e.setMap(a?z:null))}function Wi(a){const e=document.getElementById("route-nav");if(!e)return;const i=a.hotels.filter(t=>t.recommended);i.length&&(e.innerHTML=`
  ...
  `}let D=null,T="tutte",Y=[],I=!1;async function Xi(){const a=document.getElementById("page-content");let e;try{e=await E()}catch(t){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${t.message}</p></div>`;return}Y=e.days,D=null,T="tutte",a.innerHTML=`
    <div class="page-header">
      <h1>💡 Idee Rapide</h1>
  ...
  `,pa(),be(),me(),tt();const i=()=>{B(),O()};window.addEventListener("ideas:updated",i),window.__currentPageCleanup=()=>window.removeEventListener("ideas:updated",i)}function ua(a){var s,r;const e=!!a,i=Y.map(l=>`<option value="${l.date}" ${(a==null?void 0:a.day_date)===l.date?"selected":""}>
  ...
  `}function pa(){var e,i,t;const a=document.getElementById("ideas-form-wrap");a&&((e=document.getElementById("ideas-toggle-advanced"))==null||e.addEventListener("click",()=>{I=!I;const o=document.getElementById("ideas-advanced"),n=document.getElementById("ideas-toggle-advanced");o==null||o.classList.toggle("hidden",!I),n&&(n.textContent=I?"▲ Meno dettagli":"▼ Più dettagli")}),a.addEventListener("change",o=>{var n;if(o.target.id==="idea-day"){const s=Y.find(r=>r.date===o.target.value);s!=null&&s.coordinates&&(document.getElementById("idea-lat").value=s.coordinates.lat,document.getElementById("idea-lng").value=s.coordinates.lng,document.getElementById("idea-coords-hint").textContent=`Auto-riempito da "${s.location}"`)}o.target.id==="idea-add-map"&&((n=document.getElementById("idea-color-row"))==null||n.classList.toggle("hidden",!o.target.checked))}),(i=document.getElementById("idea-form"))==null||i.addEventListener("submit",o=>{o.preventDefault(),at()}),(t=document.getElementById("idea-cancel-btn"))==null||t.addEventListener("click",()=>{D=null,document.getElementById("ideas-form-wrap").innerHTML=ua(null),pa()}))}function at(){var s,r,l,c,u,p,d,v,k,L,g,y,m,Q;const a=(s=document.getElementById("idea-text"))==null?void 0:s.value.trim();if(!a){(r=document.getElementById("idea-text"))==null||r.focus();return}const e=parseFloat((l=document.getElementById("idea-lat"))==null?void 0:l.value),i=parseFloat((c=document.getElementById("idea-lng"))==null?void 0:c.value),t=!isNaN(e)&&!isNaN(i)?{lat:e,lng:i}:null,o=(u=document.getElementById("idea-add-map"))==null?void 0:u.checked,n={text:a,note:((p=document.getElementById("idea-note"))==null?void 0:p.value.trim())??"",categoria:((d=document.getElementById("idea-categoria"))==null?void 0:d.value)??"varia",stato:((v=document.getElementById("idea-stato"))==null?void 0:v.value)??"idea",priorita:((k=document.getElementById("idea-priorita"))==null?void 0:k.value)??"media",day_date:((L=document.getElementById("idea-day"))==null?void 0:L.value)||null,location_name:((g=document.getElementById("idea-location"))==null?void 0:g.value.trim())||null,link:((y=document.getElementById("idea-link"))==null?void 0:y.value.trim())||"",coordinates:t,add_to_checklist:((m=document.getElementById("idea-add-checklist"))==null?void 0:m.checked)??!1,add_to_map:o&&t!==null,marker_color:((Q=document.querySelector('input[name="idea-color"]:checked'))==null?void 0:Q.value)??"#f59e0b"};D?(U(D,n),D=null):la(n),I=!1,document.getElementById("ideas-form-wrap").innerHTML=ua(null),pa(),B(),O()}function ge(){const a=_();return[{key:"tutte",label:`Tutte (${a.length})`},{key:"idea",label:`Idea (${a.filter(i=>i.stato==="idea").length})`},{key:"da-verificare",label:`Da verificare (${a.filter(i=>i.stato==="da-verificare").length})`},{key:"prenotare",label:`Prenotare (${a.filter(i=>i.stato==="prenotare").length})`},{key:"approvata",label:`Approvate (${a.filter(i=>i.stato==="approvata").length})`},{key:"scartata",label:`Scartate (${a.filter(i=>i.stato==="scartata").length})`}].map(i=>`
    <button class="idea-filter-btn ${T===i.key?"active":""}" data-f="${i.key}">
      ${i.label}
    </button>
  `).join("")}function me(){var a;(a=document.getElementById("ideas-filters-row"))==null||a.querySelectorAll(".idea-filter-btn").forEach(e=>{e.addEventListener("click",()=>{T=e.dataset.f,O(),B()})})}function O(){const a=document.getElementById("ideas-filters-row");a&&(a.innerHTML=ge(),me())}function ve(){let a=_();return T!=="tutte"&&(a=a.filter(e=>e.stato===T)),a.length===0?`<div class="ideas-empty">${T==="tutte"?"Nessuna idea salvata. Aggiungine una qui sopra.":"Nessuna idea per questo filtro."}</div>`:a.map(et).join("")}function et(a){const e=ba.find(n=>n.value===a.stato),i=Ja.find(n=>n.value===a.categoria),t=Wa.find(n=>n.value===a.priorita),o=a.day_date?Y.find(n=>n.date===a.day_date):null;return`
      ...
      <div class="idea-card-main">
        <div class="idea-card-header-row">
          ...
          <div class="idea-card-badges-inline">
            ...
            ${t?`<span class="idea-pri-dot" title="${t.label}" style="background:${ot(a.priorita)}"></span>`:""}
          </div>
        </div>
  ...
  `}function it(a){var o,n,s;const e=_().find(r=>r.id===a);if(!e)return;(o=document.getElementById("day-link-modal"))==null||o.remove();const i=Y.map(r=>`<option value="${r.date}" ${e.day_date===r.date?"selected":""}>
  ...
  `;function o(){const r=document.getElementById("natura-pillole-area");r&&(r.innerHTML=Ra(i));const l=document.getElementById("natura-grid");if(!l)return;const c=C.filter(u=>(i==="tutte"||u.area===i)&&(t==="tutti"||u.tipo===t));l.innerHTML=c.length?c.map(Na).join(""):'<p style="color:var(--color-text-muted);padding:1rem;">Nessun suggerimento per questa combinazione di filtri.</p>',Va()}(n=document.getElementById("natura-tipo-filters"))==null||n.addEventListener("click",r=>{const l=r.target.closest(".natura-filter-btn");l&&(t=l.dataset.tipo,document.querySelectorAll("#natura-tipo-filters .natura-filter-btn").forEach(c=>c.classList.remove("active")),l.classList.add("active"),o())}),(s=document.getElementById("natura-filters"))==null||s.addEventListener("click",r=>{const l=r.target.closest(".natura-filter-btn");l&&(i=l.dataset.area,document.querySelectorAll("#natura-filters .natura-filter-btn").forEach(c=>c.classList.remove("active")),l.classList.add("active"),o())}),Va()}function Ra(a){const e=rt[a];return e!=null&&e.length?`
  ...
  `:""}function Na(a){const e=lt[a.impegno]||{label:a.impegno,icon:"🕐",cls:""},i=ct[a.nota_tipo]||{label:a.nota_tipo,cls:""},t=dt[a.tipo]||null,o=st[a.id]||a.nome,n=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(o)}`,s=nt[a.id];return`
  ...
  `}function Va(){document.querySelectorAll(".natura-add-idea-btn").forEach(a=>{a.addEventListener("click",()=>{const e=a.dataset.nome,i=a.dataset.area,t=parseFloat(a.dataset.lat),o=parseFloat(a.dataset.lng);la({text:e,location_name:i,categoria:"escursione",stato:"da-verificare",add_to_map:!0,coordinates:{lat:t,lng:o},marker_color:"#10b981"}),a.textContent="✅ Aggiunta!",a.disabled=!0,setTimeout(()=>{a.textContent="💡 Aggiungi alle Idee",a.disabled=!1},2e3)})})}function ka(a){return String(a??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}const Ha={high:{label:"Da non dimenticare",cls:"logi-prio-high"},medium:{label:"Importante",cls:"logi-prio-medium"},low:{label:"Promemoria",cls:"logi-prio-low"}},ea="guida-viaggio";async function pt(){const a=document.getElementById("page-content");let e;try{e=await E()}catch(n){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${n.message}</p></div>`;return}const i=e.logistics||[],t=e.bookings||[],o=e.days||[];a.innerHTML=`
    ...
    ${i.length===0?'<p style="color:var(--color-text-muted);">Nessuna nota logistica.</p>':`<div class="logi-list">${i.map($t).join("")}</div>`}
  `,ht(t),gt(e.guide),kt(e.ferries)}function fe(a){const e=R(ea),i='<input type="file" id="guide-file" accept="application/pdf,.pdf,.epub" hidden />',t=a!=null&&a.url?`
  ...
  `:"",o=e?`
    <div class="guide-card">
      <div class="guide-card-main">
        ...
        <span class="guide-size">${mt(e.size)} · su questo dispositivo, anche offline</span>
      </div>
  ...
  `;return`
    ...
    ${i}
  `}function gt(a){const e=document.getElementById("guide-section");if(!e)return;e.addEventListener("click",o=>{var n;if(o.target.closest("#guide-add")){(n=document.getElementById("guide-file"))==null||n.click();return}if(o.target.closest("#guide-open")){ye(ea);return}o.target.closest("#guide-del")&&confirm("Rimuovere la guida da questo dispositivo?")&&ta(ea)}),e.addEventListener("change",o=>{var r;const n=o.target.closest("#guide-file");if(!((r=n==null?void 0:n.files)!=null&&r.length))return;const s=n.files[0];ia(ea,s).catch(l=>{console.error("[guida]",l),alert("Impossibile salvare la guida su questo dispositivo: il file è grande e lo spazio del browser potrebbe non bastare.")}),n.value=""});const i=()=>{e.innerHTML=fe(a)};window.addEventListener("attachments:updated",i);const t=window.__currentPageCleanup;window.__currentPageCleanup=()=>{t==null||t(),window.removeEventListener("attachments:updated",i)}}function mt(a){if(a==null)return"";if(a===0)return"file vuoto (0 byte)";const e=a/(1024*1024);return e>=1?`${e.toFixed(1)} MB`:`${Math.round(a/1024)} kB`}function vt(a,e){const i=a.map(t=>`<option value="${t.date}">${f(t.date)} · ${b(t.location||t.title||"")}</option>`).join("");return`
  ...
  `}function he(a){const e=[...a.map(i=>({...i,_fixed:!0})),...da().map(i=>({...i,_fixed:!1}))].sort((i,t)=>Ga(i).localeCompare(Ga(t)));return e.length===0?'<p class="booking-empty">Nessuna prenotazione ancora. Aggiungi la prima qui sotto.</p>':`<div class="booking-list">${e.map(bt).join("")}</div>`}function bt(a){const e=ee(a),i=[a.date?f(a.date):"",a.time].filter(Boolean).join(" · ");return`
  ...
  `}function ft(a){const e=R(a),i=`<input type="file" class="booking-attach-input" data-id="${b(a)}"
    ...
    ${i}
  `}function Ga(a){const e=a.date||"9999-12-31",i=String(Z(a.time)).padStart(5,"0");return`${e} ${i}`}function ht(a){var n,s;const e=document.querySelector(".booking-section");if(!e)return;const i=e.querySelector("#booking-form"),t=e.querySelector("#bookings-list");(n=e.querySelector("#booking-add-toggle"))==null||n.addEventListener("click",()=>{var r;i.classList.toggle("hidden"),i.classList.contains("hidden")||(r=i.querySelector(".booking-place"))==null||r.focus()}),(s=e.querySelector("#booking-cancel"))==null||s.addEventListener("click",()=>{i.classList.add("hidden")}),t==null||t.addEventListener("click",r=>{var d;const l=r.target.closest(".booking-card-del");if(l){confirm("Eliminare questa prenotazione?")&&ta(l.dataset.id).finally(()=>Ye(l.dataset.id));return}const c=r.target.closest(".booking-attach-add, .booking-attach");if(c&&r.target.closest(".booking-attach-add")){(d=c.parentElement.querySelector(".booking-attach-input"))==null||d.click();return}const u=r.target.closest(".booking-attach-open");if(u){ye(u.dataset.id);return}const p=r.target.closest(".booking-attach-del");if(p){confirm("Rimuovere questo allegato?")&&ta(p.dataset.id);return}}),t==null||t.addEventListener("change",r=>{var u;const l=r.target.closest(".booking-attach-input");if(!l||!((u=l.files)!=null&&u.length))return;const c=l.dataset.id;ia(c,l.files[0]).catch(p=>{console.error("[attachments]",p),alert("Impossibile salvare l’allegato su questo dispositivo.")}),l.value=""}),i==null||i.addEventListener("submit",r=>{var v,k;r.preventDefault();const l=i.querySelector(".booking-place").value.trim();if(!l){i.querySelector(".booking-place").focus();return}const c=i.querySelector(".booking-loc").value.trim(),u=/^https?:\/\//i.test(c),p=We({place:l,date:i.querySelector(".booking-date").value||null,time:i.querySelector(".booking-time").value.trim(),address:u?"":c,maps_url:u?c:"",note:i.querySelector(".booking-note").value.trim()}),d=(k=(v=i.querySelector(".booking-file"))==null?void 0:v.files)==null?void 0:k[0];d&&ia(p.id,d).catch(L=>{console.error("[attachments]",L),alert("Prenotazione salvata, ma non è stato possibile allegare il file su questo dispositivo.")}),i.reset(),i.classList.add("hidden")});const o=()=>{t&&(t.innerHTML=he(a))};window.addEventListener("bookings:updated",o),window.addEventListener("attachments:updated",o),window.__currentPageCleanup=()=>{window.removeEventListener("bookings:updated",o),window.removeEventListener("attachments:updated",o)}}const ye=wa;function ke(a){return!a||!a.length?"":`
  ...
  `}function yt(a){const e=R(a.id),i=`
  ...
  `}function kt(a){const e=document.getElementById("ferry-box");if(!e)return;e.addEventListener("click",o=>{var r;const n=o.target.closest("[data-act]");if(!n)return;const s=n.dataset.id;n.dataset.act==="add"?(r=e.querySelector(`.ferry-file[data-id="${CSS.escape(s)}"]`))==null||r.click():n.dataset.act==="open"?wa(s):n.dataset.act==="del"&&confirm("Rimuovere il biglietto da questo dispositivo?")&&ta(s)}),e.addEventListener("change",o=>{var s;const n=o.target.closest(".ferry-file");(s=n==null?void 0:n.files)!=null&&s.length&&(ia(n.dataset.id,n.files[0]).catch(r=>{console.error("[biglietti]",r),alert("Impossibile salvare il biglietto su questo dispositivo: "+((r==null?void 0:r.message)||""))}),n.value="")});const i=()=>{e.innerHTML=ke(a)};window.addEventListener("attachments:updated",i);const t=window.__currentPageCleanup;window.__currentPageCleanup=()=>{t==null||t(),window.removeEventListener("attachments:updated",i)}}function $t(a){const e=Ha[a.priority]||Ha.low;return`
  ...
  `}function Ua(){document.querySelectorAll(".attivita-card .attivita-head").forEach(a=>{a.addEventListener("click",()=>{const i=a.closest(".attivita-card").classList.toggle("open");a.setAttribute("aria-expanded",i?"true":"false")})})}let S=[],Aa=[],ga="tutte";const $e=a=>`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(a)}`;async function _t(){const a=document.getElementById("page-content");let e;try{e=await E()}catch(t){a.innerHTML=`<div class="error-state"><div class="error-icon">⚠️</div><h2>Errore</h2><p>${t.message}</p></div>`;return}S=e.hikes||[],Aa=e.days.filter(t=>t.location.toLowerCase().includes("sesto")),ga="tutte",a.innerHTML=`
    <div class="page-header">
  ...
  `,_e(),Et();const i=()=>Ee();window.addEventListener("ideas:updated",i),window.__currentPageCleanup=()=>window.removeEventListener("ideas:updated",i)}function ze(){return[{key:"tutte",label:`Tutte (${S.length})`},{key:"family",label:`👶 Adatte ai bimbi (${S.filter(e=>e.family).length})`},{key:"facili",label:`🟢 Facili (${S.filter(e=>/facile/i.test(e.difficulty)).length})`},{key:"auto",label:`🚗 In auto (${S.filter(e=>e.car).length})`},{key:"rifugi",label:`🏔️ Rifugi (${S.filter(e=>/rifugio/i.test(e.type)).length})`}].map(e=>`
    <button class="hike-filter-btn ${ga===e.key?"active":""}" data-f="${e.key}">${e.label}</button>
  `).join("")}function Lt(){switch(ga){case"family":return S.filter(a=>a.family);case"facili":return S.filter(a=>/facile/i.test(a.difficulty));case"auto":return S.filter(a=>a.car);case"rifugi":return S.filter(a=>/rifugio/i.test(a.type));default:return S}}function _e(){var a;(a=document.getElementById("hike-filters"))==null||a.querySelectorAll(".hike-filter-btn").forEach(e=>{e.addEventListener("click",()=>{ga=e.dataset.f,document.getElementById("hike-filters").innerHTML=ze(),_e(),Ee()})})}function Le(a){return _().filter(e=>e.hike_id===a&&e.day_date).map(e=>({id:e.id,day:Aa.find(i=>i.date===e.day_date)})).filter(e=>e.day)}function St(a){return/impegnativ/i.test(a)?"diff-hard":/media/i.test(a)?"diff-med":"diff-easy"}function Se(){const a=Lt();return a.length?a.map(e=>{const i=Le(e.id);return`
      <div class="hike-card" data-id="${e.id}">
        <div class="hike-card-top">
          ...
          <div class="hike-badges">
            ...
            <span class="hike-diff ${St(e.difficulty)}">${h(e.difficulty)}</span>
    ...
    `}).join(""):'<div class="ideas-empty">Nessuna meta per questo filtro.</div>'}function Ee(){const a=document.getElementById("hike-grid");a&&(a.innerHTML=Se())}function Et(){const a=document.getElementById("hike-grid");a&&a.addEventListener("click",e=>{const i=e.target.closest(".hike-assigned-chip");if(i){za(i.dataset.idea);return}const t=e.target.closest('[data-action="add"]');t&&It(t.dataset.id)})}function It(a){var s,r,l;const e=S.find(c=>c.id===a);if(!e)return;(s=document.getElementById("hike-day-modal"))==null||s.remove();const i=new Set(Le(a).map(c=>c.day.date)),t=Aa.map(c=>`
  ...
  `,document.body.appendChild(o);const n=()=>o.remove();(r=document.getElementById("hike-day-cancel"))==null||r.addEventListener("click",n),o.addEventListener("click",c=>{c.target===o&&n()}),(l=document.getElementById("hike-day-confirm"))==null||l.addEventListener("click",()=>{var u;const c=(u=document.getElementById("hike-day-select"))==null?void 0:u.value;c&&(la({text:e.name,note:`${e.type} · ${e.difficulty} · ${e.duration} — ${e.description}`,categoria:"escursione",stato:"idea",day_date:c,location_name:e.start,link:$e(e.name),coordinates:e.coordinates||null,add_to_map:!!e.coordinates,marker_color:"#10b981",hike_id:e.id}),n())})}const Fa={"#dashboard":Ge,"#itinerary":mi,"#attivita":zt,"#passeggiate":_t,"#hotels":_i,"#checklist":xi,"#map":Ri,"#ideas":Xi,"#natura":ut,"#logistics":pt};async function Ie(){typeof window.__currentPageCleanup=="function"&&(window.__currentPageCleanup(),window.__currentPageCleanup=null);const[a,e]=(window.location.hash||"#dashboard").split("/"),i=Fa[a]??Fa["#dashboard"],t=document.getElementById("page-content");t.innerHTML=`
    <div class="loading">
